...
if SERVER then
	...
	registerprivilege("player.setArmor", "SetArmor", "Allows changing a player's armor", { entities = {} })
	registerprivilege("player.setMaxArmor", "SetMaxArmor", "Allows changing a player's max armor", { entities = {} })
