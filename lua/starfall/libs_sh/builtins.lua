...
--- Like Lua 5.2 or LuaJIT's load/loadstring, except it has no mode parameter and, of course,
-- the resulting function is in your instance's environment by default.
