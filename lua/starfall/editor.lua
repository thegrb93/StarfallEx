...
--[[
	...
	function SF.Editor.createEditor ()
		...
		function editor:OnKeyCodePressed ( keyCode )
			if keyCode == KEY_S and ( input.IsKeyDown( KEY_LCONTROL ) or input.IsKeyDown( KEY_RCONTROL ) ) and not input.IsKeyDown( KEY_RALT ) then
				SF.Editor.saveTab( SF.Editor.getActiveTab() )
			elseif keyCode == KEY_Q and ( input.IsKeyDown( KEY_LCONTROL ) or input.IsKeyDown( KEY_RCONTROL ) ) and not input.IsKeyDown( KEY_RALT ) then
				SF.Editor.close()
			end
		end
		...
		function html:OnKeyCodePressed ( key, notfirst )
			...
			if ( input.IsKeyDown( KEY_LSHIFT ) or input.IsKeyDown( KEY_RSHIFT ) ) and 
				( input.IsKeyDown( KEY_LCONTROL ) or input.IsKeyDown( KEY_RCONTROL ) ) and not input.IsKeyDown( KEY_RALT ) then
			...
			elseif (input.IsKeyDown( KEY_LCONTROL ) or input.IsKeyDown( KEY_RCONTROL )) and not input.IsKeyDown( KEY_RALT ) then
				if key == KEY_LEFT and input.IsKeyDown( key ) then
