...
if SERVER then
	...
	SF.RamCap = CreateConVar("sf_ramcap", 500000, "If ram exceeds this limit (in kB), starfalls will be terminated")
else
	...
	SF.RamCap = CreateConVar("sf_ramcap_cl", 500000, "If ram exceeds this limit (in kB), starfalls will be terminated")
end
