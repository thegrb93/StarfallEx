...
-- @param boolean? useSimpleFading Whether to use simple fading for this sound (default: true)
...
-- This feature requires the channel to be initially created in 3D mode, i.e.
-- Bass:is3D() should return true or this function will do nothing.
