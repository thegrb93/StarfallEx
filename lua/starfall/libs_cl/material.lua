...
function material_library.createFromImage(path, params)
	...
	if not (file.Exists("materials/" .. path, "GAME") or (string.sub(path,1,12)=="data_static/" and file.Exists(path, "GAME")) or (string.sub(path,1,5)=="data/" and file.Exists(path,"GAME"))) then
