...
{
	x = isnumber, y = isnumber, w = isnumber, h = isnumber, type = isstring,
	fov = isnumber, aspect = isnumber, zfar = isnumber, znear = isnumber, subrect = isbool,
	bloomtone = isbool, offcenter = istable, ortho = istable
}
