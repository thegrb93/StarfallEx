...
--- Sets the current render material to the given material or the RenderTarget,
-- applying a color modification shader to the texture. Alias: render.setMaterialEffectColourModify
-- @param Material mat The material object to use the texture of, or the name of a RenderTarget to use instead.
-- @param table cmStructure A table where each key must be one of "addr", "addg", "addb", "brightness",
-- "color" or "colour", "contrast", "mulr", "mulg", and "mulb". All keys are optional.
