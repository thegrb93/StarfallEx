...
Mesh library.";["fields"]={};["functions"]={[1]="parseObj";["parseObj"]={["class"]="function";["description"]="\
Parses obj data into a table of vertices, normals, texture coordinates, colors, and tangents";["fname"]="parseObj";["library"]="mesh";["name"]="mesh_library.parseObj";["param"]={[1]="obj";[2]="thread";[3]="triangulate";["obj"]="The obj data";["thread"]="An optional thread object to gradually parse the data to prevent exceeding cpu";["triangulate"]="Whether to triangulate the faces";};["private"]=false;["realm"]="sh";["ret"]="The table of vertices that can be passed to mesh.buildFromTriangles";["summary"]="\
Parses obj data into a table of vertices, normals, texture coordinates, colors, and tangents ";};};["libtbl"]="mesh_library";["name"]="mesh";["server"]=true;["summary"]="\
