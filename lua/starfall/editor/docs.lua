...
Called when an entity is being dropped by a gravity gun ";["server"] = true;["param"] = {[1] = "ply";[2] = "ent";["ply"] = "Player dropping the object";["ent"] = "Entity being dropped";};};["writecell"] = {["classForced"] = true;["description"] = "\
Called when a high speed device writes to a wired SF chip";["realm"] = "sv";["name"] = "writecell";["class"] = "hook";["summary"] = "\
Called when a high speed device writes to a wired SF chip ";["param"] = {[1] = "address";[2] = "data";["data"] = "The data being written";["address"] = "The address written to";};};["PlayerHurt"] = {["description"] = "\
Called when a player gets hurt";["class"] = "hook";["classForced"] = true;["realm"] = "sh";["name"] = "PlayerHurt";["summary"] = "\
Called when a player gets hurt ";["server"] = true;["client"] = true;["param"] = {[1] = "ply";[2] = "attacker";[3] = "newHealth";[4] = "damageTaken";["newHealth"] = "New health of the player";["damageTaken"] = "Amount of damage the player has taken";["ply"] = "Player being hurt";["attacker"] = "Entity causing damage to the player";};};["readcell"] = {["ret"] = "The value read";["description"] = "\
Called when a high speed device reads from a wired SF chip";["class"] = "hook";["classForced"] = true;["name"] = "readcell";["realm"] = "sv";["summary"] = "\
Called when a high speed device reads from a wired SF chip ";["server"] = true;["param"] = {[1] = "address";["address"] = "The address requested";};};["PlayerUse"] = {["description"] = "\
...
Called when a player holds their use key and looks at an entity.";["param"] = {[1] = "ply";[2] = "ent";["ply"] = "Player using the entity";["ent"] = "Entity being used";};["server"] = true;};["net"] = {["classForced"] = true;["description"] = "\
...
Called when a button is pressed ";["param"] = {[1] = "button";["button"] = "Number of the button";};};["Initialize"] = {["description"] = "\
...
Called after the starfall chip is placed/reloaded with the toolgun or duplicated and the duplication is finished.";["server"] = true;["param"] = {};};["PropBreak"] = {["description"] = "\
...
Called when a player toggles noclip ";["server"] = true;["client"] = true;["param"] = {[1] = "ply";[2] = "newState";["newState"] = "New noclip state. True if on.";["ply"] = "Player toggling noclip";};};["Removed"] = {["description"] = "\
Called when the starfall chip is removed";["class"] = "hook";["classForced"] = true;["name"] = "Removed";["realm"] = "sh";["summary"] = "\
Called when the starfall chip is removed ";["server"] = true;["param"] = {};};["predrawopaquerenderables"] = {["description"] = "\
...
Called when a frame is requested to be drawn.";["client"] = true;["param"] = {};};["think"] = {["description"] = "\
...
Called when an entity is removed ";["server"] = true;["client"] = true;["param"] = {[1] = "ent";["ent"] = "Entity being removed";};};["PlayerEnteredVehicle"] = {["description"] = "\
...
Called after opaque entities are drawn.";["client"] = true;["param"] = {[1] = "boolean";["boolean"] = "isDrawSkybox  Whether the current draw is drawing the skybox.";};};["PlayerSay"] = {["ret"] = "New text. \"\" to stop from displaying. Nil to keep original.";["description"] = "\
Called when a player sends a chat message";["class"] = "hook";["classForced"] = true;["name"] = "PlayerSay";["realm"] = "sh";["summary"] = "\
Called when a player sends a chat message ";["server"] = true;["param"] = {[1] = "ply";[2] = "text";[3] = "teamChat";["text"] = "Content of the message";["ply"] = "Player that sent the message";["teamChat"] = "True if team chat";};};["PhysgunDrop"] = {["description"] = "\
