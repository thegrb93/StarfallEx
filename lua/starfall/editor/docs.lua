...
Called when a wants to pick up a weapon ";["server"] = true;["param"] = {[1] = "ply";[2] = "wep";["ply"] = "Player";["wep"] = "Weapon";};};["PlayerEnteredVehicle"] = {["description"] = "\
Called when a players enters a vehicle";["class"] = "hook";["classForced"] = true;["name"] = "PlayerEnteredVehicle";["realm"] = "sh";["summary"] = "\
Called when a players enters a vehicle ";["server"] = true;["param"] = {[1] = "ply";[2] = "vehicle";[3] = "num";["vehicle"] = "Vehicle that was entered";["ply"] = "Player who entered a vehicle";["num"] = "Role";};};["PlayerSpray"] = {["description"] = "\
...
Called when a player switches their weapon ";["server"] = true;["client"] = true;["param"] = {[1] = "ply";[2] = "oldwep";[3] = "newweapon";["oldwep"] = "Old weapon";["ply"] = "Player droppig the entity";["newweapon"] = "New weapon";};};["PlayerLeaveVehicle"] = {["description"] = "\
Called when a players leaves a vehicle";["class"] = "hook";["classForced"] = true;["name"] = "PlayerLeaveVehicle";["realm"] = "sh";["summary"] = "\
Called when a players leaves a vehicle ";["server"] = true;["param"] = {[1] = "ply";[2] = "vehicle";["vehicle"] = "Vehicle that was left";["ply"] = "Player who left a vehicle";};};["PlayerSwitchFlashlight"] = {["description"] = "\
...
Called when a player punts with the gravity gun ";["server"] = true;["client"] = true;["param"] = {[1] = "ply";[2] = "ent";["ply"] = "Player punting the gravgun";["ent"] = "Entity being punted";};};["calcview"] = {["ret"] = "table Table containing information for the camera. {origin=camera origin, angles=camera angles, fov=camera fov, znear=znear, zfar=zfar, drawviewer=drawviewer}";["description"] = "\
Called when the engine wants to calculate the player's view";["class"] = "hook";["classForced"] = true;["name"] = "calcview";["realm"] = "cl";["summary"] = "\
Called when the engine wants to calculate the player's view ";["client"] = true;["param"] = {[1] = "pos";[2] = "ang";[3] = "fov";[4] = "znear";[5] = "zfar";["fov"] = "Current fov of the camera";["ang"] = "Current angles of the camera";["zfar"] = "Current far plane of the camera";["znear"] = "Current near plane of the camera";["pos"] = "Current position of the camera";};};["EndEntityDriving"] = {["description"] = "\
...
Called when an entity gets created ";["server"] = true;["client"] = true;["param"] = {[1] = "ent";["ent"] = "New entity";};};["OnPhysgunReload"] = {["description"] = "\
Called when a player reloads his physgun";["class"] = "hook";["classForced"] = true;["name"] = "OnPhysgunReload";["realm"] = "sh";["summary"] = "\
Called when a player reloads his physgun ";["server"] = true;["param"] = {[1] = "physgun";[2] = "ply";["physgun"] = "Entity of the physgun";["ply"] = "Player reloading the physgun";};};["StartChat"] = {["description"] = "\
...
Called when an entity is being dropped by a gravity gun ";["server"] = true;["param"] = {[1] = "ply";[2] = "ent";["ply"] = "Player dropping the object";["ent"] = "Entity being dropped";};};["postdrawopaquerenderables"] = {["description"] = "\
...
Called after opaque entities are drawn.";["client"] = true;["param"] = {[1] = "boolean";["boolean"] = "isDrawSkybox  Whether the current draw is drawing the skybox.";};};["PlayerHurt"] = {["description"] = "\
Called when a player gets hurt";["class"] = "hook";["classForced"] = true;["realm"] = "sh";["name"] = "PlayerHurt";["summary"] = "\
Called when a player gets hurt ";["server"] = true;["client"] = true;["param"] = {[1] = "ply";[2] = "attacker";[3] = "newHealth";[4] = "damageTaken";["newHealth"] = "New health of the player";["damageTaken"] = "Amount of damage the player has taken";["ply"] = "Player being hurt";["attacker"] = "Entity causing damage to the player";};};["writecell"] = {["classForced"] = true;["description"] = "\
Called when a high speed device writes to a wired SF chip";["realm"] = "sv";["name"] = "writecell";["class"] = "hook";["summary"] = "\
Called when a high speed device writes to a wired SF chip ";["param"] = {[1] = "address";[2] = "data";["data"] = "The data being written";["address"] = "The address written to";};};["huddisconnected"] = {["description"] = "\
...
Called when the player disconnects from a HUD component linked to the Starfall Chip ";["client"] = true;["param"] = {};};["renderoffscreen"] = {["description"] = "\
...
Called when a frame is requested to be drawn.";["client"] = true;["param"] = {};};["Initialize"] = {["description"] = "\
...
Called after the starfall chip is placed/reloaded with the toolgun or duplicated and the duplication is finished.";["server"] = true;["param"] = {};};["tick"] = {["description"] = "\
Tick hook. Called each game tick on both the server and client.";["class"] = "hook";["classForced"] = true;["realm"] = "sh";["name"] = "tick";["summary"] = "\
Tick hook.";["server"] = true;["client"] = true;["param"] = {};};["drawhud"] = {["description"] = "\
Called when a frame is requested to be drawn on hud. (2D Context)";["class"] = "hook";["classForced"] = true;["name"] = "drawhud";["realm"] = "cl";["summary"] = "\
Called when a frame is requested to be drawn on hud.";["client"] = true;["param"] = {};};["PropBreak"] = {["description"] = "\
...
Called when a frame is requested to be drawn on screen.";["client"] = true;["param"] = {};};["predrawopaquerenderables"] = {["description"] = "\
...
Called before opaque entities are drawn.";["client"] = true;["param"] = {[1] = "boolean";["boolean"] = "isDrawSkybox  Whether the current draw is drawing the skybox.";};};["readcell"] = {["ret"] = "The value read";["description"] = "\
Called when a high speed device reads from a wired SF chip";["class"] = "hook";["classForced"] = true;["name"] = "readcell";["realm"] = "sv";["summary"] = "\
Called when a high speed device reads from a wired SF chip ";["server"] = true;["param"] = {[1] = "address";["address"] = "The address requested";};};["EntityRemoved"] = {["description"] = "\
...
Called before drawing HUD (2D Context) ";["client"] = true;["param"] = {};};["think"] = {["description"] = "\
...
Called when a player starts driving an entity ";["server"] = true;["client"] = true;["param"] = {[1] = "ent";[2] = "ply";["ent"] = "Entity being driven";["ply"] = "Player that is driving the entity";};};["PlayerSay"] = {["ret"] = "New text. \"\" to stop from displaying. Nil to keep original.";["description"] = "\
Called when a player sends a chat message";["class"] = "hook";["classForced"] = true;["name"] = "PlayerSay";["realm"] = "sh";["summary"] = "\
Called when a player sends a chat message ";["server"] = true;["param"] = {[1] = "ply";[2] = "text";[3] = "teamChat";["text"] = "Content of the message";["ply"] = "Player that sent the message";["teamChat"] = "True if team chat";};};["inputReleased"] = {["classForced"] = true;["name"] = "inputReleased";["realm"] = "sh";["description"] = "\
...
Called when a button is pressed ";["param"] = {[1] = "button";["button"] = "Number of the button";};};["PhysgunDrop"] = {["description"] = "\
...
The dimensions will always be 1024x1024";["param"] = {[1] = "name";["name"] = "The name of the render target";};};["drawRect"] = {["class"] = "function";["fname"] = "drawRect";["realm"] = "cl";["name"] = "render_library.drawRect";["summary"] = "\
Draws a rectangle using the current color.";["private"] = false;["library"] = "render";["description"] = "\
Draws a rectangle using the current color.";["param"] = {[1] = "x";[2] = "y";[3] = "w";[4] = "h";["y"] = "Top left corner y coordinate";["h"] = "Height";["w"] = "Width";["x"] = "Top left corner x coordinate";};};["disableScissorRect"] = {["class"] = "function";["fname"] = "disableScissorRect";["realm"] = "cl";["name"] = "render_library.disableScissorRect";["summary"] = "\
Disables a scissoring rect which limits the drawing area.";["private"] = false;["library"] = "render";["description"] = "\
Disables a scissoring rect which limits the drawing area.";["param"] = {};};["isHUDActive"] = {["class"] = "function";["fname"] = "isHUDActive";["realm"] = "cl";["name"] = "render_library.isHUDActive";["summary"] = "\
Checks if a hud component is connected to the Starfall Chip ";["private"] = false;["library"] = "render";["description"] = "\
Checks if a hud component is connected to the Starfall Chip";["param"] = {};};["setTexture"] = {["class"] = "function";["fname"] = "setTexture";["realm"] = "cl";["name"] = "render_library.setTexture";["summary"] = "\
Sets the texture ";["private"] = false;["library"] = "render";["description"] = "\
Sets the texture";["param"] = {[1] = "id";["id"] = "Texture table. Aquired with render.getTextureID";};};["traceSurfaceColor"] = {["ret"] = "The color vector. use vector:toColor to convert it to a color.";["class"] = "function";["fname"] = "traceSurfaceColor";["realm"] = "cl";["name"] = "render_library.traceSurfaceColor";["summary"] = "\
...
Reads the color of the specified pixel.";["param"] = {[1] = "x";[2] = "y";["y"] = "Pixel y-coordinate.";["x"] = "Pixel x-coordinate.";};};["drawTexturedRectRotated"] = {["class"] = "function";["fname"] = "drawTexturedRectRotated";["realm"] = "cl";["name"] = "render_library.drawTexturedRectRotated";["summary"] = "\
...
Constructs a markup object for quick styled text drawing.";["param"] = {[1] = "str";[2] = "maxsize";["str"] = "The markup string to parse";["maxsize"] = "The max width of the markup";};};["drawRectOutline"] = {["class"] = "function";["fname"] = "drawRectOutline";["realm"] = "cl";["name"] = "render_library.drawRectOutline";["summary"] = "\
Draws a rectangle outline using the current color.";["private"] = false;["library"] = "render";["description"] = "\
Draws a rectangle outline using the current color.";["param"] = {[1] = "x";[2] = "y";[3] = "w";[4] = "h";["y"] = "Top left corner y coordinate";["h"] = "Height";["w"] = "Width";["x"] = "Top left corner x coordinate";};};["getTextSize"] = {["ret"] = {[1] = "width of the text";[2] = "height of the text";};["class"] = "function";["fname"] = "getTextSize";["realm"] = "cl";["name"] = "render_library.getTextSize";["summary"] = "\
Gets the size of the specified text.";["private"] = false;["library"] = "render";["description"] = "\
Gets the size of the specified text. Don't forget to use setFont before calling this function";["param"] = {[1] = "text";["text"] = "Text to get the size of";};};["enableDepth"] = {["class"] = "function";["fname"] = "enableDepth";["realm"] = "cl";["name"] = "render_library.enableDepth";["summary"] = "\
Enables or disables Depth Buffer ";["private"] = false;["library"] = "render";["description"] = "\
Enables or disables Depth Buffer";["param"] = {[1] = "enable";["enable"] = "true to enable";};};["setRGBA"] = {["class"] = "function";["fname"] = "setRGBA";["realm"] = "cl";["name"] = "render_library.setRGBA";["summary"] = "\
Sets the draw color by RGBA values ";["private"] = false;["library"] = "render";["description"] = "\
Sets the draw color by RGBA values";["param"] = {[1] = "r";[2] = "g";[3] = "b";[4] = "a";};};["drawTexturedRect"] = {["class"] = "function";["fname"] = "drawTexturedRect";["realm"] = "cl";["name"] = "render_library.drawTexturedRect";["summary"] = "\
Draws a textured rectangle.";["private"] = false;["library"] = "render";["description"] = "\
Draws a textured rectangle.";["param"] = {[1] = "x";[2] = "y";[3] = "w";[4] = "h";["y"] = "Top left corner y coordinate";["h"] = "Height";["w"] = "Width";["x"] = "Top left corner x coordinate";};};["drawText"] = {["class"] = "function";["fname"] = "drawText";["realm"] = "cl";["name"] = "render_library.drawText";["summary"] = "\
...
Gets the default font";["param"] = {};};["cursorPos"] = {["ret"] = {[1] = "x position";[2] = "y position";};["class"] = "function";["fname"] = "cursorPos";["realm"] = "cl";["name"] = "render_library.cursorPos";["summary"] = "\
Gets a 2D cursor position where ply is aiming.";["private"] = false;["library"] = "render";["description"] = "\
Gets a 2D cursor position where ply is aiming.";["param"] = {[1] = "ply";["ply"] = "player to get cursor position from(optional)";};};["drawSimpleText"] = {["class"] = "function";["fname"] = "drawSimpleText";["realm"] = "cl";["name"] = "render_library.drawSimpleText";["summary"] = "\
...
Draws a 3D Line";["param"] = {[1] = "startPos";[2] = "endPos";["endPos"] = "Ending position";["startPos"] = "Starting position";};};["draw3DWireframeSphere"] = {["class"] = "function";["fname"] = "draw3DWireframeSphere";["realm"] = "cl";["name"] = "render_library.draw3DWireframeSphere";["summary"] = "\
...
Returns the model material name that uses the render target.";["param"] = {[1] = "name";["name"] = "Render target name";};};["draw3DSprite"] = {["class"] = "function";["fname"] = "draw3DSprite";["realm"] = "cl";["name"] = "render_library.draw3DSprite";["summary"] = "\
Draws a sprite in 3d space.";["private"] = false;["library"] = "render";["description"] = "\
Draws a sprite in 3d space.";["param"] = {[1] = "pos";[2] = "width";[3] = "height";["height"] = "Height of the sprite.";["width"] = "Width of the sprite.";["pos"] = "Position of the sprite.";};};["clear"] = {["class"] = "function";["fname"] = "clear";["realm"] = "cl";["name"] = "render_library.clear";["summary"] = "\
Clears the active render target ";["private"] = false;["library"] = "render";["description"] = "\
Clears the active render target";["param"] = {[1] = "clr";[2] = "depth";["depth"] = "Boolean if should clear depth";["clr"] = "Color type to clear with";};};["clearDepth"] = {["class"] = "function";["fname"] = "clearDepth";["realm"] = "cl";["name"] = "render_library.clearDepth";["summary"] = "\
Resets the depth buffer ";["private"] = false;["library"] = "render";["description"] = "\
Resets the depth buffer";["param"] = {};};["drawLine"] = {["class"] = "function";["fname"] = "drawLine";["realm"] = "cl";["name"] = "render_library.drawLine";["summary"] = "\
...
Sets the font";["param"] = {[1] = "font";["font"] = "The font to use";};};["drawPoly"] = {["class"] = "function";["fname"] = "drawPoly";["realm"] = "cl";["name"] = "render_library.drawPoly";["summary"] = "\
Draws a polygon.";["private"] = false;["library"] = "render";["description"] = "\
Draws a polygon.";["param"] = {[1] = "poly";["poly"] = "Table of polygon vertices. Texture coordinates are optional. {{x=x1, y=y1, u=u1, v=v1}, ... }";};};["getScreenInfo"] = {["ret"] = "A table describing the screen.";["class"] = "function";["fname"] = "getScreenInfo";["realm"] = "cl";["name"] = "render_library.getScreenInfo";["summary"] = "\
...
Releases the texture. Required if you reach the maximum url textures.";["param"] = {[1] = "id";["id"] = "Texture table. Aquired with render.getTextureID";};};["destroyRenderTarget"] = {["class"] = "function";["fname"] = "destroyRenderTarget";["realm"] = "cl";["name"] = "render_library.destroyRenderTarget";["summary"] = "\
Releases the rendertarget.";["private"] = false;["library"] = "render";["description"] = "\
Releases the rendertarget. Required if you reach the maximum rendertargets.";["param"] = {[1] = "name";["name"] = "Rendertarget name";};};["pushViewMatrix"] = {["class"] = "function";["fname"] = "pushViewMatrix";["realm"] = "cl";["name"] = "render_library.pushViewMatrix";["summary"] = "\
...
Pops a matrix from the matrix stack.";["param"] = {};};["setRenderTargetTexture"] = {["class"] = "function";["fname"] = "setRenderTargetTexture";["realm"] = "cl";["name"] = "render_library.setRenderTargetTexture";["summary"] = "\
...
Nil to reset.";["param"] = {[1] = "name";["name"] = "Name of the render target to use";};};["capturePixels"] = {["class"] = "function";["fname"] = "capturePixels";["realm"] = "cl";["name"] = "render_library.capturePixels";["summary"] = "\
...
Dumps the current render target and allows the pixels to be accessed by render.readPixel.";["param"] = {};};["setTextureFromScreen"] = {["class"] = "function";["fname"] = "setTextureFromScreen";["realm"] = "cl";["name"] = "render_library.setTextureFromScreen";["summary"] = "\
...
Coroutine library";["libtbl"] = "coroutine_library";["tables"] = {};["server"] = true;};["file"] = {["functions"] = {[1] = "append";[2] = "createDir";[3] = "delete";[4] = "exists";[5] = "find";[6] = "open";[7] = "read";[8] = "write";["delete"] = {["ret"] = "True if successful, nil if error";["class"] = "function";["fname"] = "delete";["realm"] = "cl";["name"] = "file_library.delete";["summary"] = "\
...
File functions. Allows modification of files.";["libtbl"] = "file_library";["tables"] = {};};["joystick"] = {["functions"] = {[1] = "getAxis";[2] = "getButton";[3] = "getName";[4] = "getPov";[5] = "numAxes";[6] = "numButtons";[7] = "numJoysticks";[8] = "numPovs";["numJoysticks"] = {["ret"] = "Number of joysticks";["class"] = "function";["fname"] = "numJoysticks";["realm"] = "cl";["name"] = "joystick_library.numJoysticks";["summary"] = "\
...
FastLZ library";["libtbl"] = "fastlz_library";["tables"] = {};["server"] = true;};["mesh"] = {["functions"] = {[1] = "createFromObj";[2] = "createFromTable";[3] = "trianglesLeft";["trianglesLeft"] = {["ret"] = "Number of triangles that can be created";["class"] = "function";["fname"] = "trianglesLeft";["realm"] = "cl";["name"] = "mesh_library.trianglesLeft";["summary"] = "\
...
Mesh library.";["libtbl"] = "mesh_library";["tables"] = {};};["game"] = {["functions"] = {[1] = "getGamemode";[2] = "getHostname";[3] = "getMap";[4] = "getMaxPlayers";[5] = "isDedicated";[6] = "isLan";[7] = "isSinglePlayer";["getMaxPlayers"] = {["class"] = "function";["fname"] = "getMaxPlayers";["realm"] = "sh";["name"] = "game_lib.getMaxPlayers";["summary"] = "\
...
Net message library. Used for sending data from the server to the client and back";["libtbl"] = "net_library";["tables"] = {};};["holograms"] = {["functions"] = {[1] = "canSpawn";[2] = "create";[3] = "hologramsLeft";["canSpawn"] = {["ret"] = "True if user can spawn holograms, False if not.";["class"] = "function";["realm"] = "sv";["fname"] = "canSpawn";["summary"] = "\
...
Library for creating and manipulating physics-less models AKA \"Holograms\".";["libtbl"] = "holograms_library";["tables"] = {};["server"] = true;};["find"] = {["functions"] = {[1] = "all";[2] = "allPlayers";[3] = "byClass";[4] = "byModel";[5] = "inBox";[6] = "inCone";[7] = "inSphere";["inBox"] = {["ret"] = "An array of found entities";["class"] = "function";["fname"] = "inBox";["realm"] = "sh";["name"] = "find_library.inBox";["summary"] = "\
...
Find library. Finds entities in various shapes.";["libtbl"] = "find_library";["tables"] = {};["server"] = true;};["wire"] = {["functions"] = {[1] = "adjustInputs";[2] = "adjustOutputs";[3] = "create";[4] = "delete";[5] = "getInputs";[6] = "getOutputs";[7] = "getWirelink";[8] = "self";[9] = "serverUUID";["self"] = {["class"] = "function";["fname"] = "self";["realm"] = "sv";["name"] = "wire_library.self";["summary"] = "\
...
Ports table.";["library"] = "wire";["param"] = {};};};};["hook"] = {["functions"] = {[1] = "add";[2] = "remove";[3] = "run";[4] = "runRemote";["remove"] = {["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Deals with hooks";["libtbl"] = "hook_library";["tables"] = {};["server"] = true;};["von"] = {["functions"] = {[1] = "deserialize";[2] = "serialize";["serialize"] = {["ret"] = "String";["description"] = "\
...
Same as Lua's tonumber ";["fname"] = "tonumber";["library"] = "builtin";["param"] = {[1] = "obj";["obj"] = "";};};["requiredir"] = {["ret"] = "Table of return values of the scripts";["class"] = "function";["fname"] = "requiredir";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.requiredir";["summary"] = "\
Runs an included script and caches the result.";["private"] = false;["library"] = "builtin";["description"] = "\
Runs an included script and caches the result. \
Works pretty much like standard Lua require()";["param"] = {[1] = "dir";[2] = "loadpriority";["loadpriority"] = "Table of files that should be loaded before any others in the directory";["dir"] = "The directory to include. Make sure to --@includedir it";};};["setfenv"] = {["ret"] = "func with environment set to tbl";["class"] = "function";["fname"] = "setfenv";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.setfenv";["summary"] = "\
Lua's setfenv \
...
Returns the entity with index 'num' ";["fname"] = "entity";["library"] = "builtin";["param"] = {[1] = "num";["num"] = "Entity index";};};["getfenv"] = {["ret"] = "Current environment";["class"] = "function";["fname"] = "getfenv";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.getfenv";["summary"] = "\
...
Lua's pcall with SF throw implementation \
Calls a function and catches an error that can be thrown while the execution of the call.";["param"] = {[1] = "func";[2] = "...";[3] = "arguments";["arguments"] = "Arguments to call the function with.";["func"] = "Function to be executed and of which the errors should be caught of";};};["rawget"] = {["ret"] = "The value of the index";["class"] = "function";["fname"] = "rawget";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.rawget";["summary"] = "\
...
Generates the CRC checksum of the specified string.";["fname"] = "crc";["library"] = "builtin";["param"] = {[1] = "stringToHash";["stringToHash"] = "The string to calculate the checksum of";};};["type"] = {["ret"] = "The name of the object's type.";["class"] = "function";["realm"] = "sh";["classForced"] = true;["summary"] = "\
...
Try to execute a function and catch possible exceptions \
Similar to xpcall, but a bit more in-depth";["param"] = {[1] = "func";[2] = "catch";["catch"] = "Optional function to execute in case func fails";["func"] = "Function to execute";};};["require"] = {["ret"] = "Return value of the script";["class"] = "function";["fname"] = "require";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.require";["summary"] = "\
Runs an included script and caches the result.";["private"] = false;["library"] = "builtin";["description"] = "\
Runs an included script and caches the result. \
Works pretty much like standard Lua require()";["param"] = {[1] = "file";["file"] = "The file to include. Make sure to --@include it";};};["getUserdata"] = {["ret"] = "String data";["class"] = "function";["realm"] = "sh";["fname"] = "getUserdata";["summary"] = "\
...
Returns whoever created the chip ";["fname"] = "owner";["library"] = "builtin";["param"] = {};};["printTable"] = {["class"] = "function";["fname"] = "printTable";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.printTable";["summary"] = "\
Prints a table to player's chat ";["private"] = false;["library"] = "builtin";["description"] = "\
Prints a table to player's chat";["param"] = {[1] = "tbl";["tbl"] = "Table to print";};};["quotaAverage"] = {["ret"] = "Average CPU Time of the buffer.";["class"] = "function";["fname"] = "quotaAverage";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.quotaAverage";["summary"] = "\
...
GLua's loadstring \
Works like loadstring, except that it executes by default in the main environment";["param"] = {[1] = "str";[2] = "name";["str"] = "String to execute";};};["setUserdata"] = {["class"] = "function";["realm"] = "sh";["fname"] = "setUserdata";["summary"] = "\
...
Sets the chip's userdata that the duplicator tool saves. max 1MiB";["param"] = {[1] = "str";["str"] = "String data";};};["setName"] = {["class"] = "function";["realm"] = "sh";["fname"] = "setName";["summary"] = "\
...
Input library.";["libtbl"] = "input_methods";["tables"] = {};};["physenv"] = {["functions"] = {[1] = "getAirDensity";[2] = "getGravity";[3] = "getPerformanceSettings";["getGravity"] = {["ret"] = "Vector Gravity Vector ( eg Vector(0,0,-600) )";["class"] = "function";["fname"] = "getGravity";["realm"] = "sh";["name"] = "physenv_lib.getGravity";["summary"] = "\
...
Physenv functions";["libtbl"] = "physenv_lib";["tables"] = {};["server"] = true;};["constraint"] = {["functions"] = {[1] = "axis";[2] = "ballsocket";[3] = "ballsocketadv";[4] = "breakAll";[5] = "breakType";[6] = "elastic";[7] = "getTable";[8] = "nocollide";[9] = "rope";[10] = "setElasticLength";[11] = "setRopeLength";[12] = "slider";[13] = "weld";["ballsocketadv"] = {["class"] = "function";["realm"] = "sv";["fname"] = "ballsocketadv";["summary"] = "\
...
PhysObj Type";["client"] = true;["class"] = "class";["methods"] = {[1] = "applyForceCenter";[2] = "applyForceOffset";[3] = "applyTorque";[4] = "getAngleVelocity";[5] = "getAngles";[6] = "getEntity";[7] = "getInertia";[8] = "getMass";[9] = "getMassCenter";[10] = "getMaterial";[11] = "getMesh";[12] = "getMeshConvexes";[13] = "getPos";[14] = "getVelocity";[15] = "isValid";[16] = "localToWorldVector";[17] = "setInertia";[18] = "setMass";[19] = "setMaterial";[20] = "setPos";[21] = "setVelocity";[22] = "worldToLocal";[23] = "worldToLocal";[24] = "worldToLocalVector";["applyTorque"] = {["class"] = "function";["realm"] = "sh";["fname"] = "applyTorque";["summary"] = "\
...
Applys a torque to a physics object";["param"] = {[1] = "torque";["torque"] = "The local torque vector to apply";};};["setMaterial"] = {["class"] = "function";["realm"] = "sh";["fname"] = "setMaterial";["summary"] = "\
...
Gets the inertia of the physics object";["param"] = {};};["setInertia"] = {["class"] = "function";["realm"] = "sh";["fname"] = "setInertia";["summary"] = "\
...
Sets the velocity of the physics object";["param"] = {[1] = "vel";["vel"] = "The velocity vector to set it to";};};["getEntity"] = {["ret"] = "The entity attached to the physics object";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the entity attached to the physics object";["param"] = {};};["setMass"] = {["class"] = "function";["realm"] = "sh";["fname"] = "setMass";["summary"] = "\
Sets the mass of a physics object ";["name"] = "physobj_methods:setMass";["classlib"] = "PhysObj";["private"] = false;["server"] = true;["description"] = "\
Sets the mass of a physics object";["param"] = {[1] = "mass";["mass"] = "The mass to set it to";};};["worldToLocal"] = {["ret"] = "The transformed vector";["class"] = "function";["fname"] = "worldToLocal";["realm"] = "sh";["name"] = "physobj_methods:worldToLocal";["summary"] = "\
...
Returns a vector in the reference frame of the world from the local frame of the physicsobject";["param"] = {[1] = "vec";["vec"] = "The vector to transform";};};["getVelocity"] = {["ret"] = "Vector velocity of the physics object";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the velocity of the physics object";["param"] = {};};["getMesh"] = {["ret"] = "table of MeshVertex structures";["class"] = "function";["fname"] = "getMesh";["realm"] = "sh";["name"] = "physobj_methods:getMesh";["summary"] = "\
...
Returns a table of MeshVertex structures where each 3 vertices represent a triangle. See: http://wiki.garrysmod.com/page/Structures/MeshVertex";["param"] = {};};["getAngles"] = {["ret"] = "Angle angles of the physics object";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the angles of the physics object";["param"] = {};};};};["Hologram"] = {["typtbl"] = "hologram_methods";["fields"] = {};["name"] = "Hologram";["summary"] = "\
...
Returns the x, y, z size of the entity's outer bounding box (local to the entity)";["param"] = {};};["getAngleVelocityAngle"] = {["ret"] = "The angular velocity as an angle";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Returns the angular velocity of the entity";["param"] = {};};["breakEnt"] = {["class"] = "function";["fname"] = "breakEnt";["realm"] = "sv";["name"] = "ents_methods:breakEnt";["summary"] = "\
Invokes the entity's breaking animation and removes it.";["private"] = false;["classlib"] = "Entity";["description"] = "\
Invokes the entity's breaking animation and removes it.";["param"] = {};};["ignite"] = {["class"] = "function";["fname"] = "ignite";["realm"] = "sv";["name"] = "ents_methods:ignite";["summary"] = "\
Ignites an entity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Ignites an entity";["param"] = {[1] = "length";[2] = "radius";["radius"] = "(optional) How large the fire hitbox is (entity obb is the max)";["length"] = "How long the fire lasts";};};["getBoneParent"] = {["ret"] = "Parent index of the bone";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Returns the parent index of an entity's bone";["param"] = {[1] = "bone";["bone"] = "Bone index. (def 0)";};};["getHealth"] = {["ret"] = "Health of the entity";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the health of an entity";["param"] = {};};["emitSound"] = {["class"] = "function";["fname"] = "emitSound";["realm"] = "sv";["name"] = "ents_methods:emitSound";["summary"] = "\
Plays a sound on the entity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Plays a sound on the entity";["param"] = {[1] = "snd";[2] = "lvl";[3] = "pitch";[4] = "volume";[5] = "channel";["pitch"] = "pitchPercent=100";["snd"] = "string Sound path";["lvl"] = "number soundLevel=75";["channel"] = "channel=CHAN_AUTO";["volume"] = "volume=1";};};["getUp"] = {["ret"] = "Vector up";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the entity's up vector";["param"] = {};};["applyDamage"] = {["class"] = "function";["fname"] = "applyDamage";["realm"] = "sv";["name"] = "ents_methods:applyDamage";["summary"] = "\
Applies damage to an entity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Applies damage to an entity";["param"] = {[1] = "amt";[2] = "attacker";[3] = "inflictor";["inflictor"] = "damage inflictor";["attacker"] = "damage attacker";["amt"] = "damage amount";};};["unparent"] = {["class"] = "function";["fname"] = "unparent";["realm"] = "sv";["name"] = "ents_methods:unparent";["summary"] = "\
Unparents the entity from another entity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Unparents the entity from another entity";["param"] = {};};["localToWorldAngles"] = {["ret"] = "data as world space angle";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Removes an entity";["param"] = {};};["getAttachment"] = {["ret"] = "vector position, and angle orientation";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the position and angle of an attachment";["param"] = {[1] = "index";["index"] = "The index of the attachment";};};["isValidPhys"] = {["ret"] = "True if entity has physics";["class"] = "function";["fname"] = "isValidPhys";["realm"] = "sv";["name"] = "ents_methods:isValidPhys";["summary"] = "\
...
Sets entity gravity";["param"] = {[1] = "grav";["grav"] = "Bool should the entity respect gravity?";};};["lookupAttachment"] = {["ret"] = "number of the attachment index, or 0 if it doesn't exist";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Ejects the driver of the vehicle";["param"] = {};};};};["Sound"] = {["typtbl"] = "sound_methods";["summary"] = "\
...
VMatrix type";["class"] = "class";["methods"] = {[1] = "getAngles";[2] = "getForward";[3] = "getInverse";[4] = "getInverseTR";[5] = "getRight";[6] = "getScale";[7] = "getTranslation";[8] = "getUp";[9] = "rotate";[10] = "scale";[11] = "scaleTranslation";[12] = "setAngles";[13] = "setScale";[14] = "setTranslation";[15] = "translate";["getRight"] = {["ret"] = "Translation";["class"] = "function";["fname"] = "getRight";["realm"] = "sh";["name"] = "vmatrix_methods:getRight";["summary"] = "\
Returns right vector of matrix ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Returns right vector of matrix";["param"] = {};};["setScale"] = {["class"] = "function";["fname"] = "setScale";["realm"] = "sh";["name"] = "vmatrix_methods:setScale";["summary"] = "\
Sets the scale ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Sets the scale";["param"] = {[1] = "vec";["vec"] = "New scale";};};["getUp"] = {["ret"] = "Translation";["class"] = "function";["fname"] = "getUp";["realm"] = "sh";["name"] = "vmatrix_methods:getUp";["summary"] = "\
...
Returns scale";["param"] = {};};["translate"] = {["class"] = "function";["fname"] = "translate";["realm"] = "sh";["name"] = "vmatrix_methods:translate";["summary"] = "\
Translate the matrix ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Translate the matrix";["param"] = {[1] = "vec";["vec"] = "Vector to translate by";};};["getAngles"] = {["ret"] = "Angles";["class"] = "function";["fname"] = "getAngles";["realm"] = "sh";["name"] = "vmatrix_methods:getAngles";["summary"] = "\
Returns angles ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Returns angles";["param"] = {};};["setTranslation"] = {["class"] = "function";["fname"] = "setTranslation";["realm"] = "sh";["name"] = "vmatrix_methods:setTranslation";["summary"] = "\
Sets the translation ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Sets the translation";["param"] = {[1] = "vec";["vec"] = "New translation";};};["getTranslation"] = {["ret"] = "Translation";["class"] = "function";["fname"] = "getTranslation";["realm"] = "sh";["name"] = "vmatrix_methods:getTranslation";["summary"] = "\
Returns translation ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Returns translation";["param"] = {};};["setAngles"] = {["class"] = "function";["fname"] = "setAngles";["realm"] = "sh";["name"] = "vmatrix_methods:setAngles";["summary"] = "\
Sets the angles ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Sets the angles";["param"] = {[1] = "ang";["ang"] = "New angles";};};["getInverse"] = {["ret"] = "inverted matrix";["class"] = "function";["fname"] = "getInverse";["realm"] = "sh";["name"] = "vmatrix_methods:getInverse";["summary"] = "\
Inverts the matrix ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Inverts the matrix";["param"] = {};};["getForward"] = {["ret"] = "Translation";["class"] = "function";["fname"] = "getForward";["realm"] = "sh";["name"] = "vmatrix_methods:getForward";["summary"] = "\
Returns forward vector of matrix ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Returns forward vector of matrix";["param"] = {};};["rotate"] = {["class"] = "function";["fname"] = "rotate";["realm"] = "sh";["name"] = "vmatrix_methods:rotate";["summary"] = "\
...
Inverts the matrix efficiently for translations and rotations";["param"] = {};};["scaleTranslation"] = {["class"] = "function";["fname"] = "scaleTranslation";["realm"] = "sh";["name"] = "vmatrix_methods:scaleTranslation";["summary"] = "\
Scales the absolute translation ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Scales the absolute translation";["param"] = {[1] = "num";["num"] = "Amount to scale by";};};};};["Mesh"] = {["typtbl"] = "mesh_methods";["fields"] = {};["name"] = "Mesh";["summary"] = "\
...
Draws the mesh. Must be in a 3D rendering context.";["param"] = {};};};};["Bass"] = {["typtbl"] = "bass_methods";["fields"] = {};["name"] = "Bass";["summary"] = "\
...
Flushes and closes the file. The file must be opened again to use a new file object.";["param"] = {};};};};["Angle"] = {["typtbl"] = "ang_methods";["summary"] = "\
...
Return Rotated angle around the specified axis.";["param"] = {[1] = "v";[2] = "deg";[3] = "rad";["rad"] = "Number of radians or nil if degrees.";["deg"] = "Number of degrees or nil if radians.";["v"] = "Vector axis";};};};};["Weapon"] = {["typtbl"] = "weapon_methods";["fields"] = {};["name"] = "Weapon";["summary"] = "\
