...
GLua's loadstring \
Works like loadstring, except that it executes by default in the main environment";["fname"]="loadstring";["library"]="builtin";["name"]="SF.DefaultEnvironment.loadstring";["param"]={[1]="str";[2]="name";[3]="env";["env"]="Custom environment for the loaded code";["str"]="String to execute";};["private"]=false;["realm"]="sh";["ret"]="Function of str";["summary"]="\
GLua's loadstring \
