...
Sets whether an entity's shadow should be drawn ";};["setFilterMag"]={["class"]="function";["classlib"]="Entity";["client"]=true;["description"]="\
Sets the texture filtering function when viewing a close texture";["fname"]="setFilterMag";["name"]="ents_methods:setFilterMag";["param"]={[1]="val";["val"]="The filter function to use http://wiki.garrysmod.com/page/Enums/TEXFILTER";};["private"]=false;["realm"]="cl";["summary"]="\
Sets the texture filtering function when viewing a close texture ";};["setFilterMin"]={["class"]="function";["classlib"]="Entity";["client"]=true;["description"]="\
Sets the texture filtering function when viewing a far texture";["fname"]="setFilterMin";["name"]="ents_methods:setFilterMin";["param"]={[1]="val";["val"]="The filter function to use http://wiki.garrysmod.com/page/Enums/TEXFILTER";};["private"]=false;["realm"]="cl";["summary"]="\
Sets the texture filtering function when viewing a far texture ";};["setFrozen"]={["class"]="function";["classlib"]="Entity";["description"]="\
...
Called when a controller button has been released. Client must have XInput Lua binary installed.";["name"]="xinputReleased";["param"]={[1]="id";[2]="when";["id"]="The button that was released. See https://github.com/mitterdoo/garrysmod-xinput#xinput_gamepad_";["when"]="The timer.realtime() at which this event occurred.";};["realm"]="cl";["summary"]="\
