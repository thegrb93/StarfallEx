...
Returns a color pixel value of the $basetexture of a material";["fname"]="getColor";["library"]="material";["name"]="material_library.getColor";["param"]={[1]="path";[2]="x";[3]="y";["path"]="The path of the material (don't include .vmt in the path)";["x"]="The x coordinate of the pixel";["y"]="The y coordinate of the pixel";};["private"]=false;["realm"]="cl";["ret"]="The color value";["summary"]="\
Returns a color pixel value of the $basetexture of a material ";};["getFloat"]={["class"]="function";["description"]="\
