...
Input library.";["fields"]={};["functions"]={[1]="enableCursor";[10]="lookupBinding";[11]="screenToVector";[2]="getCursorPos";[3]="getCursorVisible";[4]="getKeyName";[5]="isControlDown";[6]="isControlLocked";[7]="isKeyDown";[8]="isShiftDown";[9]="lockControls";["enableCursor"]={["class"]="function";["client"]=true;["description"]="\
