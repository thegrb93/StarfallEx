...
Called when the mouse is moved ";["class"] = "hook";["param"] = {[1] = "x";[2] = "y";["y"] = "Y coordinate moved";["x"] = "X coordinate moved";};};["renderoffscreen"] = {["description"] = "\
...
Called when a frame is requested to be drawn.";["classForced"] = true;["name"] = "renderoffscreen";["realm"] = "cl";["client"] = true;["param"] = {};};["EntityTakeDamage"] = {["description"] = "\
...
Called when a player reloads his physgun ";["classForced"] = true;["name"] = "OnPhysgunReload";["realm"] = "sh";["server"] = true;["param"] = {[1] = "physgun";[2] = "ply";["ply"] = "Player reloading the physgun";["physgun"] = "Entity of the physgun";};};["PlayerSwitchFlashlight"] = {["description"] = "\
...
Called when a player punts with the gravity gun ";["client"] = true;["param"] = {[1] = "ply";[2] = "ent";["ent"] = "Entity being punted";["ply"] = "Player punting the gravgun";};};["writecell"] = {["classForced"] = true;["description"] = "\
Called when a high speed device writes to a wired SF chip";["name"] = "writecell";["realm"] = "sv";["summary"] = "\
Called when a high speed device writes to a wired SF chip ";["class"] = "hook";["param"] = {[1] = "address";[2] = "data";["data"] = "The data being written";["address"] = "The address written to";};};["EndEntityDriving"] = {["description"] = "\
...
Called when an entity gets created ";["client"] = true;["param"] = {[1] = "ent";["ent"] = "New entity";};};["readcell"] = {["ret"] = "The value read";["description"] = "\
Called when a high speed device reads from a wired SF chip";["class"] = "hook";["classForced"] = true;["summary"] = "\
Called when a high speed device reads from a wired SF chip ";["name"] = "readcell";["realm"] = "sv";["server"] = true;["param"] = {[1] = "address";["address"] = "The address requested";};};["StartChat"] = {["description"] = "\
...
Called when an entity is being dropped by a gravity gun ";["classForced"] = true;["name"] = "GravGunOnDropped";["realm"] = "sh";["server"] = true;["param"] = {[1] = "ply";[2] = "ent";["ent"] = "Entity being dropped";["ply"] = "Player dropping the object";};};["net"] = {["classForced"] = true;["description"] = "\
Called when a net message arrives";["name"] = "net";["realm"] = "sh";["summary"] = "\
Called when a net message arrives ";["class"] = "hook";["param"] = {[1] = "name";[2] = "len";[3] = "ply";["len"] = "Length of the arriving net message in bytes";["name"] = "Name of the arriving net message";["ply"] = "On server, the player that sent the message. Nil on client.";};};["PlayerHurt"] = {["description"] = "\
Called when a player gets hurt";["class"] = "hook";["server"] = true;["classForced"] = true;["realm"] = "sh";["name"] = "PlayerHurt";["summary"] = "\
Called when a player gets hurt ";["client"] = true;["param"] = {[1] = "ply";[2] = "attacker";[3] = "newHealth";[4] = "damageTaken";["newHealth"] = "New health of the player";["damageTaken"] = "Amount of damage the player has taken";["ply"] = "Player being hurt";["attacker"] = "Entity causing damage to the player";};};["inputReleased"] = {["classForced"] = true;["description"] = "\
Called when a button is released";["name"] = "inputReleased";["realm"] = "sh";["summary"] = "\
Called when a button is released ";["class"] = "hook";["param"] = {[1] = "button";["button"] = "Number of the button";};};["inputPressed"] = {["classForced"] = true;["description"] = "\
...
Tick hook.";["client"] = true;["param"] = {};};["PropBreak"] = {["description"] = "\
...
Called when a player toggles noclip ";["client"] = true;["param"] = {[1] = "ply";[2] = "newState";["newState"] = "New noclip state. True if on.";["ply"] = "Player toggling noclip";};};["think"] = {["description"] = "\
...
Think hook.";["client"] = true;["param"] = {};};["predrawopaquerenderables"] = {["description"] = "\
Called before opaque entities are drawn. (Only works with HUD) (3D context)";["class"] = "hook";["summary"] = "\
Called before opaque entities are drawn.";["classForced"] = true;["name"] = "predrawopaquerenderables";["realm"] = "cl";["client"] = true;["param"] = {[1] = "boolean";["boolean"] = "isDrawSkybox  Whether the current draw is drawing the skybox.";};};["StartEntityDriving"] = {["description"] = "\
...
Called when a player starts driving an entity ";["client"] = true;["param"] = {[1] = "ent";[2] = "ply";["ply"] = "Player that is driving the entity";["ent"] = "Entity being driven";};};["EntityRemoved"] = {["description"] = "\
Called when an entity is removed";["class"] = "hook";["server"] = true;["classForced"] = true;["realm"] = "sh";["name"] = "EntityRemoved";["summary"] = "\
Called when an entity is removed ";["client"] = true;["param"] = {[1] = "ent";["ent"] = "Entity being removed";};};["postdrawhud"] = {["description"] = "\
...
Called before drawing HUD (2D Context) ";["classForced"] = true;["name"] = "predrawhud";["realm"] = "cl";["client"] = true;["param"] = {};};["PlayerLeaveVehicle"] = {["description"] = "\
Called when a players leaves a vehicle";["class"] = "hook";["summary"] = "\
Called when a players leaves a vehicle ";["classForced"] = true;["name"] = "PlayerLeaveVehicle";["realm"] = "sh";["server"] = true;["param"] = {[1] = "ply";[2] = "vehicle";["vehicle"] = "Vehicle that was left";["ply"] = "Player who left a vehicle";};};["PlayerSay"] = {["ret"] = "New text. \"\" to stop from displaying. Nil to keep original.";["description"] = "\
Called when a player sends a chat message";["class"] = "hook";["summary"] = "\
Called when a player sends a chat message ";["classForced"] = true;["name"] = "PlayerSay";["realm"] = "sh";["server"] = true;["param"] = {[1] = "ply";[2] = "text";[3] = "teamChat";["text"] = "Content of the message";["ply"] = "Player that sent the message";["teamChat"] = "True if team chat";};};["PlayerEnteredVehicle"] = {["description"] = "\
Called when a players enters a vehicle";["class"] = "hook";["summary"] = "\
Called when a players enters a vehicle ";["classForced"] = true;["name"] = "PlayerEnteredVehicle";["realm"] = "sh";["server"] = true;["param"] = {[1] = "ply";[2] = "vehicle";[3] = "num";["num"] = "Role";["ply"] = "Player who entered a vehicle";["vehicle"] = "Vehicle that was entered";};};["postdrawopaquerenderables"] = {["description"] = "\
Called after opaque entities are drawn. (Only works with HUD) (3D context)";["class"] = "hook";["summary"] = "\
Called after opaque entities are drawn.";["classForced"] = true;["name"] = "postdrawopaquerenderables";["realm"] = "cl";["client"] = true;["param"] = {[1] = "boolean";["boolean"] = "isDrawSkybox  Whether the current draw is drawing the skybox.";};};["drawhud"] = {["description"] = "\
Called when a frame is requested to be drawn on hud. (2D Context)";["class"] = "hook";["summary"] = "\
Called when a frame is requested to be drawn on hud.";["classForced"] = true;["name"] = "drawhud";["realm"] = "cl";["client"] = true;["param"] = {};};["PhysgunDrop"] = {["description"] = "\
...
Sets the draw color ";["private"] = false;["library"] = "render";["param"] = {[1] = "clr";["clr"] = "Color type";};};["getResolution"] = {["ret"] = {[1] = "the X size of the current render context";[2] = "the Y size of the current render context";};["description"] = "\
...
Selects the render target to draw on.";["private"] = false;["library"] = "render";["param"] = {[1] = "name";["name"] = "Name of the render target to use";};};["getRenderTargetMaterial"] = {["ret"] = "Model material name. Send this to the server to set the entity's material.";["class"] = "function";["description"] = "\
...
Convert JSON string to table ";["private"] = false;["library"] = "json";["param"] = {[1] = "s";["s"] = "String to decode";};};};["tables"] = {};["class"] = "library";["description"] = "\
JSON library";["summary"] = "\
JSON library ";["fields"] = {};["name"] = "json";["client"] = true;["libtbl"] = "json_library";["server"] = true;};["prop"] = {["functions"] = {[1] = "canSpawn";[2] = "create";[3] = "createComponent";[4] = "createSent";[5] = "propsLeft";[6] = "setPropClean";[7] = "setPropUndo";[8] = "spawnRate";["spawnRate"] = {["ret"] = "Number of props per second the user can spawn";["description"] = "\
...
Checks how many props can be spawned ";["name"] = "props_library.propsLeft";["library"] = "prop";["private"] = false;["server"] = true;["param"] = {};};};["tables"] = {};["class"] = "library";["description"] = "\
Library for creating and manipulating physics-less models AKA \"Props\".";["summary"] = "\
Library for creating and manipulating physics-less models AKA \"Props\".";["fields"] = {};["name"] = "prop";["client"] = true;["libtbl"] = "props_library";["server"] = true;};["sounds"] = {["functions"] = {[1] = "canCreate";[2] = "create";["canCreate"] = {["ret"] = "If it is possible to make a sound";["class"] = "function";["description"] = "\
...
Creates a sound and attaches it to an entity ";["private"] = false;["library"] = "sounds";["param"] = {[1] = "ent";[2] = "path";["path"] = "Filepath to the sound file.";["ent"] = "Entity to attach sound to.";};};};["tables"] = {};["class"] = "library";["description"] = "\
...
Wire library.";["libtbl"] = "wire_library";};["team"] = {["functions"] = {[1] = "bestAutoJoinTeam";[2] = "exists";[3] = "getAllTeams";[4] = "getColor";[5] = "getJoinable";[6] = "getName";[7] = "getNumDeaths";[8] = "getNumFrags";[9] = "getNumPlayers";[10] = "getPlayers";[11] = "getScore";["bestAutoJoinTeam"] = {["ret"] = "index of the best team to join";["description"] = "\
...
Returns the name of a team ";["library"] = "team";["param"] = {[1] = "ind";["ind"] = "Index of the team";};};};["tables"] = {};["class"] = "library";["description"] = "\
Library for retreiving information about teams";["summary"] = "\
Library for retreiving information about teams ";["fields"] = {};["name"] = "team";["client"] = true;["libtbl"] = "team_library";["server"] = true;};["trace"] = {["tables"] = {};["functions"] = {[1] = "trace";[2] = "traceHull";["trace"] = {["ret"] = "Result of the trace https://wiki.garrysmod.com/page/Structures/TraceResult";["class"] = "function";["description"] = "\
...
Does a swept-AABB trace ";["private"] = false;["library"] = "trace";["param"] = {[1] = "start";[2] = "endpos";[3] = "minbox";[4] = "maxbox";[5] = "filter";[6] = "mask";[7] = "colgroup";[8] = "ignworld";["colgroup"] = "The collision group of the trace";["mask"] = "Trace mask";["endpos"] = "End position";["filter"] = "Entity/array of entities to filter, or a function callback with an entity arguement that returns whether the trace should hit";["ignworld"] = "Whether the trace should ignore world";["maxbox"] = "Upper box corner";["start"] = "Start position";["minbox"] = "Lower box corner";};};};["description"] = "\
Provides functions for doing line/AABB traces";["class"] = "library";["summary"] = "\
...
Checks how many holograms can be spawned ";["name"] = "holograms_library.hologramsLeft";["library"] = "holograms";["private"] = false;["server"] = true;["param"] = {};};};["class"] = "library";["tables"] = {};["description"] = "\
...
Game functions ";["fields"] = {};["name"] = "game";["client"] = true;["libtbl"] = "game_lib";["server"] = true;};["von"] = {["functions"] = {[1] = "deserialize";[2] = "serialize";["serialize"] = {["ret"] = "String";["description"] = "\
Serialize a table";["server"] = true;["class"] = "function";["realm"] = "sh";["summary"] = "\
Serialize a table ";["classForced"] = true;["fname"] = "serialize";["name"] = "von.serialize";["library"] = "von";["client"] = true;["param"] = {[1] = "tbl";["tbl"] = "Table to serialize";};};["deserialize"] = {["ret"] = "Table";["description"] = "\
...
Starts a timer ";["private"] = false;["library"] = "timer";["param"] = {[1] = "name";["name"] = "The timer name";};};};["tables"] = {};["class"] = "library";["description"] = "\
...
Returns an iterator function for a for loop, to return ordered key-value pairs from a table.";["library"] = "builtin";["param"] = {[1] = "tbl";["tbl"] = "Table to iterate over";};};["player"] = {["ret"] = "Returns player with given UserID or if none specified then returns either the owner (server) or the local player (client)";["description"] = "\
...
Throws an exception ";["private"] = false;["library"] = "builtin";["param"] = {[1] = "msg";[2] = "level";[3] = "uncatchable";["level"] = "Which level in the stacktrace to blame. Defaults to 1";["uncatchable"] = "Makes this exception uncatchable";["msg"] = "Message string";};};["quotaMax"] = {["ret"] = "Max SysTime allowed to take for execution of the chip in a Think.";["class"] = "function";["description"] = "\
...
Sets, changes or removes a table's metatable.";["library"] = "builtin";["param"] = {[1] = "tbl";[2] = "meta";["tbl"] = "The table to set the metatable of";["meta"] = "The metatable to use";};};["crc"] = {["ret"] = "The unsigned 32 bit checksum as a string";["description"] = "\
...
Generates the CRC checksum of the specified string.";["library"] = "builtin";["param"] = {[1] = "stringToHash";["stringToHash"] = "The string to calculate the checksum of";};};["rawset"] = {["class"] = "function";["description"] = "\
...
Runs an included script and caches the result.";["private"] = false;["library"] = "builtin";["param"] = {[1] = "dir";[2] = "loadpriority";["loadpriority"] = "Table of files that should be loaded before any others in the directory";["dir"] = "The directory to include. Make sure to --@includedir it";};};["getfenv"] = {["ret"] = "Current environment";["class"] = "function";["description"] = "\
...
Prints a table to player's chat ";["private"] = false;["library"] = "builtin";["param"] = {[1] = "tbl";["tbl"] = "Table to print";};};["entity"] = {["ret"] = "entity";["description"] = "\
...
Returns the entity with index 'num' ";["library"] = "builtin";["param"] = {[1] = "num";["num"] = "Entity index";};};["tonumber"] = {["ret"] = "obj as number";["description"] = "\
...
Attempts to convert the value to a number.";["library"] = "builtin";["param"] = {[1] = "obj";["obj"] = "";};};["pcall"] = {["ret"] = {[1] = "If the function had no errors occur within it.";[2] = "If an error occurred, this will be a string containing the error message. Otherwise, this will be the return values of the function passed in.";};["class"] = "function";["description"] = "\
...
Try to execute a function and catch possible exceptions \
Similar to xpcall, but a bit more in-depth ";["private"] = false;["library"] = "builtin";["param"] = {[1] = "func";[2] = "catch";["catch"] = "Optional function to execute in case func fails";["func"] = "Function to execute";};};["getUserdata"] = {["ret"] = "String data";["description"] = "\
Gets the chip's userdata that the duplicator tool loads";["class"] = "function";["realm"] = "sh";["fname"] = "getUserdata";["summary"] = "\
Gets the chip's userdata that the duplicator tool loads ";["name"] = "SF.DefaultEnvironment.getUserdata";["library"] = "builtin";["private"] = false;["server"] = true;["param"] = {};};["select"] = {["ret"] = "Returns a number or vararg, depending on the select method.";["description"] = "\
...
Returns whoever created the chip ";["library"] = "builtin";["param"] = {};};["setUserdata"] = {["description"] = "\
Sets the chip's userdata that the duplicator tool saves. max 1MiB";["class"] = "function";["realm"] = "sh";["fname"] = "setUserdata";["summary"] = "\
Sets the chip's userdata that the duplicator tool saves.";["name"] = "SF.DefaultEnvironment.setUserdata";["library"] = "builtin";["private"] = false;["server"] = true;["param"] = {[1] = "str";["str"] = "String data";};};["quotaAverage"] = {["ret"] = "Average CPU Time of the buffer.";["class"] = "function";["description"] = "\
...
Runs a new http GET request ";["private"] = false;["library"] = "http";["param"] = {[1] = "url";[2] = "callbackSuccess";[3] = "callbackFail";["callbackSuccess"] = "the function to be called on request success, taking the arguments body (string), length (number), headers (table) and code (number)";["url"] = "http target url";["callbackFail"] = "the function to be called on request fail, taking the failing reason as an argument";};};};["description"] = "\
...
Gets the angles of the physics object ";["fname"] = "getAngles";["classlib"] = "PhysObj";["name"] = "physobj_methods:getAngles";["server"] = true;["private"] = false;["client"] = true;["param"] = {};};["applyTorque"] = {["description"] = "\
Applys a torque to a physics object";["class"] = "function";["realm"] = "sh";["fname"] = "applyTorque";["summary"] = "\
Applys a torque to a physics object ";["name"] = "physobj_methods:applyTorque";["classlib"] = "PhysObj";["private"] = false;["server"] = true;["param"] = {[1] = "torque";["torque"] = "The local torque vector to apply";};};["getMesh"] = {["ret"] = "table of MeshVertex structures";["class"] = "function";["description"] = "\
...
Returns a table of MeshVertex structures where each 3 vertices represent a triangle.";["private"] = false;["classlib"] = "PhysObj";["param"] = {};};["localToWorld"] = {["ret"] = "The transformed vector";["class"] = "function";["description"] = "\
