...
For playing music there is `Bass` type. You can pause and set current playback time in it. If you're looking to apply DSP effects on present game sounds, use `Sound` instead.";["fields"]={};["methods"]={[1]="destroy";[10]="setLooping";[11]="setPitch";[12]="setPos";[13]="setTime";[14]="setVolume";[15]="stop";[2]="getFFT";[3]="getLength";[4]="getTime";[5]="isOnline";[6]="isValid";[7]="pause";[8]="play";[9]="setFade";["destroy"]={["class"]="function";["classlib"]="Bass";["description"]="\
