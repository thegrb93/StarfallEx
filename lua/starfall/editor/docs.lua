...
Attaches a particle to an entity.";["param"] = {[1] = "entity";[2] = "particle";[3] = "pattach";[4] = "options";[5] = "PATTACH_";["options"] = "(table)";["PATTACH_"] = "enum";["particle"] = "name";["entity"] = "to attach to";};};};["class"] = "library";["summary"] = "\
