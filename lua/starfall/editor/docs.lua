...
Mesh library.";["fields"]={};["functions"]={[1]="createFromObj";[2]="createFromTable";[3]="getModelMeshes";[4]="trianglesLeft";[5]="trianglesLeftRender";["createFromObj"]={["class"]="function";["description"]="\
