...
Attaches a particle to an entity.";["param"] = {[1] = "entity";[2] = "particle";[3] = "pattach";[4] = "options";[5] = "string";[6] = "number";[7] = "table";["number"] = "PATTACH_ enum";["string"] = "particle name";["table"] = "options";["entity"] = "to attach to";};};};["class"] = "library";["summary"] = "\
