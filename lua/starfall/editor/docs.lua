...
Returns an iterator function for a for loop, to return ordered key-value pairs from a table.";};["isFirstTimePredicted"]={["class"]="function";["description"]="\
Returns if this is the first time this hook was predicted.";["fname"]="isFirstTimePredicted";["library"]="builtin";["name"]="SF.DefaultEnvironment.isFirstTimePredicted";["param"]={};["private"]=false;["realm"]="sh";["ret"]="Boolean";["summary"]="\
