SF.Docs = {
   ["hooks"] = {
      ...
      [14] = "PhysgunDrop";
      [15] = "PhysgunPickup";
      [16] = "PlayerCanPickupWeapon";
      [17] = "PlayerDeath";
      [18] = "PlayerDisconnected";
      [19] = "PlayerEnteredVehicle";
      [20] = "PlayerHurt";
      [21] = "PlayerInitialSpawn";
      [22] = "PlayerLeaveVehicle";
      [23] = "PlayerNoClip";
      [24] = "PlayerSay";
      [25] = "PlayerSpawn";
      [26] = "PlayerSpray";
      [27] = "PlayerSwitchFlashlight";
      [28] = "PlayerSwitchWeapon";
      [29] = "PlayerUse";
      [30] = "PropBreak";
      [31] = "Removed";
      [32] = "StartChat";
      [33] = "StartEntityDriving";
      [34] = "calcview";
      [35] = "hudconnect";
      [36] = "huddisconnect";
      [37] = "input";
      ...
      [39] = "inputReleased";
      [40] = "net";
      [41] = "postdrawopaquerenderables";
      [42] = "predrawopaquerenderables";
      [43] = "readcell";
      [44] = "remote";
      [45] = "render";
      [46] = "starfallUsed";
...
Called when an entity is damaged ";
         ...
         ["param"] = {
            ...
            [6] = "position";
            [7] = "force";
            ["inflictor"] = "Entity that inflicted the damage";
            ["type"] = "Type of the damage";
            ["amount"] = "How much damage";
            ["target"] = "Entity that is hurt";
            ["force"] = "Force of the damage";
            ["attacker"] = "Entity that attacked";
            ["position"] = "Position of the damage";
         };
      };
      ["PlayerInitialSpawn"] = {
         ["description"] = "\
...
Called when a net message arrives";
      ...
      ["calcview"] = {
         ["ret"] = "table Table containing information for the camera. {origin=camera origin, angles=camera angles, fov=camera fov, znear=znear, zfar=zfar, drawviewer=drawviewer}";
         ["description"] = "\
...
Called when the engine wants to calculate the player's view ";
         ...
         ["param"] = {
            ...
            [4] = "znear";
            [5] = "zfar";
            ["fov"] = "Current fov of the camera";
            ["ang"] = "Current angles of the camera";
            ["zfar"] = "Current far plane of the camera";
            ["znear"] = "Current near plane of the camera";
...
Called after opaque entities are drawn. (Only works with HUD)";
         ...
         ["summary"] = "\
Called after opaque entities are drawn.";
         ["client"] = true;
         ["param"] = {
            [1] = "boolean";
            ["boolean"] = "isDrawSkybox  Whether the current draw is drawing the skybox.";
         };
      };
      ["Initialize"] = {
         ["description"] = "\
...
Called before opaque entities are drawn. (Only works with HUD)";
         ...
         ["summary"] = "\
Called before opaque entities are drawn.";
         ["client"] = true;
         ["param"] = {
            [1] = "boolean";
            ["boolean"] = "isDrawSkybox  Whether the current draw is drawing the skybox.";
...
Called when a player starts driving an entity ";
         ...
         ["param"] = {
            ...
            ["ply"] = "Player that is driving the entity";
         };
      };
      ["EntityRemoved"] = {
         ["description"] = "\
...
Called when an entity is removed ";
      ...
      ["PlayerSay"] = {
         ["ret"] = "New text. \"\" to stop from displaying. Nil to keep original.";
         ["description"] = "\
...
Called when a players enters a vehicle ";
         ...
         ["param"] = {
            ...
            [2] = "vehicle";
            [3] = "num";
            ["vehicle"] = "Vehicle that was entered";
            ["ply"] = "Player who entered a vehicle";
            ["num"] = "Role";
         };
      };
      ["readcell"] = {
   ...
   ["libraries"] = {
      ...
      ["render"] = {
         ["functions"] = {
            ...
            [6] = "cursorPos";
            [7] = "destroyRenderTarget";
            [8] = "destroyTexture";
            [9] = "disableScissorRect";
            [10] = "draw3DBeam";
            [11] = "draw3DBox";
            [12] = "draw3DLine";
            [13] = "draw3DQuad";
            [14] = "draw3DSphere";
            [15] = "draw3DWireframeBox";
            [16] = "draw3DWireframeSphere";
            [17] = "drawCircle";
            [18] = "drawLine";
            [19] = "drawPoly";
            [20] = "drawRect";
            ...
            [28] = "drawTexturedRectUV";
            [29] = "enableDepth";
            [30] = "enableScissorRect";
            [31] = "getDefaultFont";
            [32] = "getRenderTargetMaterial";
            [33] = "getResolution";
            [34] = "getScreenEntity";
            [35] = "getScreenInfo";
            [36] = "getTextSize";
            ...
            [43] = "pushViewMatrix";
            [44] = "readPixel";
            [45] = "selectRenderTarget";
            [46] = "setColor";
            [47] = "setFont";
            [48] = "setRGBA";
            [49] = "setRenderTargetTexture";
            [50] = "setTexture";
            [51] = "setTextureFromScreen";
            [52] = "traceSurfaceColor";
            ["drawTexturedRectUV"] = {
               ["class"] = "function";
               ["name"] = "render_library.drawTexturedRectUV";
               ["summary"] = "\
...
Draws a textured rectangle with UV coordinates";
            ...
            ["popViewMatrix"] = {
               ["class"] = "function";
               ["name"] = "render_library.popViewMatrix";
               ["summary"] = "\
...
Pops a view matrix from the matrix stack.";
            ...
            ["pushMatrix"] = {
               ["class"] = "function";
               ["name"] = "render_library.pushMatrix";
               ["summary"] = "\
...
Pushes a matrix onto the matrix stack.";
               ["param"] = {
                  ...
                  [2] = "world";
                  ["m"] = "The matrix";
                  ["world"] = "Should the transformation be relative to the screen or world?";
               };
            };
            ["drawRoundedBoxEx"] = {
               ["class"] = "function";
               ["name"] = "render_library.drawRoundedBoxEx";
               ["summary"] = "\
...
Draws a rounded rectangle using the current color";
               ["param"] = {
                  ...
                  [8] = "bl";
                  [9] = "br";
                  ["tr"] = "Boolean Top right corner";
                  ["tl"] = "Boolean Top left corner";
                  ["r"] = "The corner radius";
                  ["w"] = "Width";
                  ["y"] = "Top left corner y coordinate";
                  ["h"] = "Height";
                  ["x"] = "Top left corner x coordinate";
                  ["br"] = "Boolean Bottom right corner";
                  ["bl"] = "Boolean Bottom left corner";
               };
            };
            ["createFont"] = {
               ["class"] = "function";
               ["summary"] = "\
Creates a font.";
               ["name"] = "render_library.createFont";
               ["library"] = "render";
               ["private"] = false;
               ["usage"] = "\
...
Creates a font. Does not require rendering hook";
            ...
            ["createRenderTarget"] = {
               ["class"] = "function";
               ["name"] = "render_library.createRenderTarget";
               ["summary"] = "\
...
The dimensions will always be 1024x1024";
            ...
            ["disableScissorRect"] = {
               ["class"] = "function";
               ["name"] = "render_library.disableScissorRect";
               ["summary"] = "\
...
Gets a 2D cursor position where ply is aiming.";
            ...
            ["setTexture"] = {
               ["class"] = "function";
               ["name"] = "render_library.setTexture";
               ["summary"] = "\
Sets the texture ";
               ["private"] = false;
               ["library"] = "render";
...
Sets the texture";
               ["param"] = {
                  [1] = "id";
                  ["id"] = "Texture table. Aquired with render.getTextureID";
               };
            };
            ["isHUDActive"] = {
               ["class"] = "function";
               ["name"] = "render_library.isHUDActive";
               ["summary"] = "\
...
Checks if a hud component is connected to the Starfall Chip";
            ...
            ["traceSurfaceColor"] = {
               ["ret"] = "The color vector. use vector:toColor to convert it to a color.";
               ["class"] = "function";
               ["name"] = "render_library.traceSurfaceColor";
               ["summary"] = "\
...
Does a trace and returns the color of the textel the trace hits.";
               ["param"] = {
                  [1] = "vec1";
                  [2] = "vec2";
                  ["vec1"] = "The starting vector";
                  ["vec2"] = "The ending vector";
               };
            };
            ["getResolution"] = {
               ["ret"] = {
                  [1] = "the X size of the current render context";
                  [2] = "the Y size of the current render context";
               };
               ["class"] = "function";
               ["classForced"] = true;
               ["name"] = "render_library.getResolution";
               ["summary"] = "\
...
Returns the render context's width and height";
            ...
            ["drawTexturedRectRotated"] = {
               ["class"] = "function";
               ["name"] = "render_library.drawTexturedRectRotated";
               ["summary"] = "\
...
Draws a rotated, textured rectangle.";
            ...
            ["parseMarkup"] = {
               ["ret"] = "The markup object. See https://wiki.garrysmod.com/page/Category:MarkupObject";
               ["class"] = "function";
               ["name"] = "render_library.parseMarkup";
               ["summary"] = "\
...
Constructs a markup object for quick styled text drawing.";
               ["param"] = {
                  [1] = "str";
                  [2] = "maxsize";
                  ["str"] = "The markup string to parse";
                  ["maxsize"] = "The max width of the markup";
               };
            };
            ["readPixel"] = {
               ["ret"] = "Color object with ( r, g, b, 255 ) from the specified pixel.";
               ["class"] = "function";
               ["name"] = "render_library.readPixel";
               ["summary"] = "\
...
Reads the color of the specified pixel.";
            ...
            ["getTextSize"] = {
               ...
               ["class"] = "function";
               ["name"] = "render_library.getTextSize";
               ["summary"] = "\
...
Gets the size of the specified text. Don't forget to use setFont before calling this function";
            ...
            ["drawRectOutline"] = {
               ["class"] = "function";
               ["name"] = "render_library.drawRectOutline";
               ["summary"] = "\
...
Sets the draw color by RGBA values";
            ...
            ["enableDepth"] = {
               ["class"] = "function";
               ["name"] = "render_library.enableDepth";
               ["summary"] = "\
...
Sets the draw color";
            ...
            ["getDefaultFont"] = {
               ["ret"] = "Default font";
               ["class"] = "function";
               ["name"] = "render_library.getDefaultFont";
               ["summary"] = "\
...
Gets the default font";
            ...
            ["drawTexturedRect"] = {
               ["class"] = "function";
               ["name"] = "render_library.drawTexturedRect";
               ["summary"] = "\
...
Draws a textured rectangle.";
            ...
            ["drawSimpleText"] = {
               ["class"] = "function";
               ["name"] = "render_library.drawSimpleText";
               ["summary"] = "\
...
Draws text more easily and quickly but no new lines or tabs.";
               ["param"] = {
                  ...
                  ["x"] = "X coordinate";
                  ["text"] = "Text to draw";
                  ["yalign"] = "Text y alignment";
                  ["xalign"] = "Text x alignment";
               };
            };
            ["drawRoundedBox"] = {
               ["class"] = "function";
               ["name"] = "render_library.drawRoundedBox";
               ["summary"] = "\
Draws a rounded rectangle using the current color ";
               ["private"] = false;
               ["library"] = "render";
...
Draws a rounded rectangle using the current color";
            ...
            ["drawCircle"] = {
               ["class"] = "function";
               ["name"] = "render_library.drawCircle";
               ["summary"] = "\
...
Draws a circle outline";
            ...
            ["draw3DWireframeBox"] = {
               ["class"] = "function";
               ["name"] = "render_library.draw3DWireframeBox";
               ["summary"] = "\
...
Draws a wireframe box in 3D space";
               ["param"] = {
                  ...
                  ["angle"] = "Orientation  of the box";
                  ["mins"] = "Start position of the box, relative to origin.";
               };
            };
            ["drawRect"] = {
               ["class"] = "function";
               ["name"] = "render_library.drawRect";
               ["summary"] = "\
...
Draws a rectangle using the current color.";
            ...
            ["draw3DBeam"] = {
               ["class"] = "function";
               ["name"] = "render_library.draw3DBeam";
               ["summary"] = "\
Draws textured beam.";
               ["private"] = false;
               ["library"] = "render";
...
Draws a box in 3D space";
            ...
            ["draw3DLine"] = {
               ["class"] = "function";
               ["name"] = "render_library.draw3DLine";
               ["summary"] = "\
Draws a 3D Line ";
               ["private"] = false;
               ["library"] = "render";
...
Draws a 3D Line";
            ...
            ["selectRenderTarget"] = {
               ["class"] = "function";
               ["name"] = "render_library.selectRenderTarget";
               ["summary"] = "\
...
Nil for the visible RT.";
            ...
            ["enableScissorRect"] = {
               ["class"] = "function";
               ["name"] = "render_library.enableScissorRect";
               ["summary"] = "\
...
Enables a scissoring rect which limits the drawing area. Only works 2D contexts such as HUD or render targets.";
               ["param"] = {
                  ...
                  [3] = "endX";
                  [4] = "endY";
                  ["endX"] = "Y end coordinate of the scissor rect.";
                  ["startY"] = "Y start coordinate of the scissor rect.";
                  ["startX"] = "X start coordinate of the scissor rect.";
               };
            };
            ["draw3DWireframeSphere"] = {
               ["class"] = "function";
               ["name"] = "render_library.draw3DWireframeSphere";
               ["summary"] = "\
...
Draws a wireframe sphere";
            ...
            ["getRenderTargetMaterial"] = {
               ["ret"] = "Model material name. Send this to the server to set the entity's material.";
               ["class"] = "function";
               ["name"] = "render_library.getRenderTargetMaterial";
               ["summary"] = "\
...
Returns the model material name that uses the render target.";
            ...
            ["draw3DSphere"] = {
               ["class"] = "function";
               ["name"] = "render_library.draw3DSphere";
               ["summary"] = "\
Draws a sphere ";
               ["private"] = false;
               ["library"] = "render";
...
Clears the surface";
               ["param"] = {
                  [1] = "clr";
                  [2] = "depth";
                  ["depth"] = "Boolean if should clear depth";
...
Draws a line";
            ...
            ["getTextureID"] = {
               ["ret"] = "Texture table. Use it with render.setTexture. Returns nil if max url textures is reached.";
               ["class"] = "function";
               ["name"] = "render_library.getTextureID";
               ["summary"] = "\
Looks up a texture by file name.";
               ["private"] = false;
               ["library"] = "render";
               ["description"] = "\
...
Make sure to store the texture to use it rather than calling this slow function repeatedly.";
               ["param"] = {
                  ...
                  [2] = "cb";
                  [3] = "alignment";
                  ["tx"] = "Texture file path, or a http url";
                  ["alignment"] = "Optional alignment for the url texture. Default: \"center\", See http://www.w3schools.com/cssref/pr_background-position.asp";
                  ["cb"] = "Optional callback for when a url texture finishes loading. param1 - The texture url, param2 - The texture table";
               };
            };
            ["getScreenEntity"] = {
               ["ret"] = "Entity of the screen or hud being rendered";
               ["class"] = "function";
               ["name"] = "render_library.getScreenEntity";
               ["summary"] = "\
...
Draws a polygon.";
               ["param"] = {
                  [1] = "poly";
                  ["poly"] = "Table of polygon vertices. Texture coordinates are optional. {{x=x1, y=y1, u=u1, v=v1}, ... }";
               };
            };
            ["getScreenInfo"] = {
               ["ret"] = "A table describing the screen.";
               ["class"] = "function";
               ["name"] = "render_library.getScreenInfo";
               ["summary"] = "\
...
Note: this does a table copy so move it out of your draw hook";
               ["param"] = {
                  [1] = "e";
                  ["e"] = "The screen to get info from.";
               };
            };
            ["draw3DQuad"] = {
               ["class"] = "function";
               ["name"] = "render_library.draw3DQuad";
               ["summary"] = "\
...
Draws 2 connected triangles.";
            ...
            ["destroyTexture"] = {
               ["class"] = "function";
               ["name"] = "render_library.destroyTexture";
               ["summary"] = "\
...
Releases the texture. Required if you reach the maximum url textures.";
            ...
            ["destroyRenderTarget"] = {
               ["class"] = "function";
               ["name"] = "render_library.destroyRenderTarget";
               ["summary"] = "\
Releases the rendertarget.";
               ["private"] = false;
               ["library"] = "render";
               ["description"] = "\
Releases the rendertarget. Required if you reach the maximum rendertargets.";
            ...
            ["pushViewMatrix"] = {
               ["class"] = "function";
               ["name"] = "render_library.pushViewMatrix";
               ["summary"] = "\
...
Pushes a perspective matrix onto the view matrix stack.";
               ["param"] = {
                  [1] = "tbl";
                  ["tbl"] = "The view matrix data. See http://wiki.garrysmod.com/page/Structures/RenderCamData";
               };
            };
            ["popMatrix"] = {
               ["class"] = "function";
               ["name"] = "render_library.popMatrix";
               ["summary"] = "\
...
Pops a matrix from the matrix stack.";
            ...
            ["setRenderTargetTexture"] = {
               ["class"] = "function";
               ["name"] = "render_library.setRenderTargetTexture";
               ["summary"] = "\
...
Nil to reset.";
            ...
            ["capturePixels"] = {
               ["class"] = "function";
               ["name"] = "render_library.capturePixels";
               ["summary"] = "\
...
Dumps the current render target and allows the pixels to be accessed by render.readPixel.";
            ...
            ["setTextureFromScreen"] = {
               ["class"] = "function";
               ["name"] = "render_library.setTextureFromScreen";
               ["summary"] = "\
...
Performs spherical linear interpolation between <q0> and <q1>. Returns <q0> for <t>=0, <q1> for <t>=1";
            ...
            ["qRotation"] = {
               ["class"] = "function";
               ["name"] = "quat_lib.qRotation";
               ["summary"] = "\
Construct a quaternion from the rotation vector <rv1>.";
               ["private"] = false;
               ["library"] = "quaternion";
               ["description"] = "\
...
Changes quaternion <q> so that the represented rotation is by an angle between 0 and 180 degrees (by coder0xff)";
            ...
            ["rotationEulerAngle"] = {
               ["class"] = "function";
               ["name"] = "quat_lib.rotationEulerAngle";
               ["summary"] = "\
...
Loads a sound object from a file";
               ["param"] = {
                  ...
                  [2] = "flags";
                  [3] = "callback";
                  ["flags"] = "that will control the sound";
                  ["path"] = "Filepath to the sound file.";
                  ["callback"] = "to run when the sound is loaded";
               };
            };
            ["loadURL"] = {
               ["class"] = "function";
               ["name"] = "bass_library.loadURL";
               ["summary"] = "\
...
Bass library.";
      ...
      ["json"] = {
         ["functions"] = {
            ...
            [2] = "encode";
            ["encode"] = {
               ["ret"] = "JSON encoded string representation of the table";
               ["class"] = "function";
               ["name"] = "json_library.encode";
               ["summary"] = "\
...
Convert table to JSON string";
            ...
            ["decode"] = {
               ["ret"] = "Table representing the JSON object";
               ["class"] = "function";
               ["name"] = "json_library.decode";
               ["summary"] = "\
...
JSON library";
      ...
      ["prop"] = {
         ["functions"] = {
            ...
            [6] = "spawnRate";
            ["canSpawn"] = {
               ["ret"] = "True if user can spawn props, False if not.";
               ["class"] = "function";
               ["summary"] = "\
Checks if a user can spawn anymore props.";
               ["name"] = "props_library.canSpawn";
               ["library"] = "prop";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Creates a sent.";
            ...
            ["propsLeft"] = {
               ["ret"] = "number of props able to be spawned";
               ["class"] = "function";
               ["summary"] = "\
Checks how many props can be spawned ";
               ["name"] = "props_library.propsLeft";
               ["library"] = "prop";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Checks how many props can be spawned";
            ...
            ["setPropClean"] = {
               ["class"] = "function";
               ["name"] = "props_library.setPropClean";
               ["summary"] = "\
...
Sets whether the chip should remove created props when the chip is removed";
               ["param"] = {
                  [1] = "on";
                  ["on"] = "Boolean whether the props should be cleaned or not";
               };
            };
            ["create"] = {
               ["ret"] = "The prop object";
...
Creates a prop.";
            ...
            ["spawnRate"] = {
               ["ret"] = "Number of props per second the user can spawn";
               ["class"] = "function";
               ["summary"] = "\
Returns how many props per second the user can spawn ";
               ["name"] = "props_library.spawnRate";
               ["library"] = "prop";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Sounds library.";
      ...
      ["mesh"] = {
         ["functions"] = {
            ...
            [3] = "trianglesLeft";
            ["trianglesLeft"] = {
               ["ret"] = "Number of triangles that can be created";
               ["class"] = "function";
               ["name"] = "mesh_library.trianglesLeft";
               ["summary"] = "\
...
Returns how many triangles can be created";
            ...
            ["createFromObj"] = {
               ["ret"] = "Mesh object";
               ["class"] = "function";
               ["name"] = "mesh_library.createFromObj";
               ["summary"] = "\
...
Creates a mesh from an obj file. Only supports triangular meshes with normals and texture coordinates.";
               ["param"] = {
                  [1] = "obj";
                  ["obj"] = "The obj file data";
               };
            };
            ["createFromTable"] = {
               ["ret"] = "Mesh object";
               ["class"] = "function";
               ["name"] = "mesh_library.createFromTable";
               ["summary"] = "\
...
Creates a mesh from vertex data.";
               ["param"] = {
                  [1] = "verteces";
                  ["verteces"] = "Table containing vertex data. http://wiki.garrysmod.com/page/Structures/MeshVertex";
               };
            };
         };
         ["class"] = "library";
...
Returns the server's UUID.";
            ...
            ["getOutputs"] = {
               ["ret"] = "Table of entity's outputs";
               ["class"] = "function";
               ["name"] = "wire_library.getOutputs";
               ["summary"] = "\
...
Wires two entities together";
            ...
            ["getWirelink"] = {
               ["ret"] = "Wirelink of the entity";
               ["class"] = "function";
               ["name"] = "wire_library.getWirelink";
               ["summary"] = "\
...
Returns a wirelink to a wire entity";
            ...
            ["adjustOutputs"] = {
               ["class"] = "function";
               ["name"] = "wire_library.adjustOutputs";
               ["summary"] = "\
Creates/Modifies wire outputs.";
               ["private"] = false;
               ["library"] = "wire";
               ["description"] = "\
...
letter and contain only alphabetical characters.";
               ["param"] = {
                  [1] = "names";
                  [2] = "types";
                  ["types"] = "An array of output types. Can be shortcuts. May be modified by the function.";
                  ["names"] = "An array of output names. May be modified by the function.";
               };
            };
            ["delete"] = {
               ["class"] = "function";
               ["name"] = "wire_library.delete";
               ["summary"] = "\
...
Unwires an entity's input";
            ...
            ["getInputs"] = {
               ["ret"] = "Table of entity's inputs";
               ["class"] = "function";
               ["name"] = "wire_library.getInputs";
               ["summary"] = "\
...
Returns a table of entity's inputs";
            ...
            ["adjustInputs"] = {
               ["class"] = "function";
               ["name"] = "wire_library.adjustInputs";
               ["summary"] = "\
Creates/Modifies wire inputs.";
               ["private"] = false;
               ["library"] = "wire";
               ["description"] = "\
...
letter and contain only alphabetical characters.";
               ["param"] = {
                  [1] = "names";
                  [2] = "types";
                  ["types"] = "An array of input types. Can be shortcuts. May be modified by the function.";
...
Ports table.";
      ...
      ["trace"] = {
         ["functions"] = {
            ...
            [2] = "traceHull";
            ["traceHull"] = {
               ["ret"] = "Result of the trace";
               ["class"] = "function";
               ["name"] = "trace_library.traceHull";
               ["summary"] = "\
...
Does a swept-AABB trace";
               ["param"] = {
                  ...
                  [5] = "filter";
                  [6] = "mask";
                  ["filter"] = "Entity/array of entities to filter, or a function callback with an entity arguement";
                  ["maxbox"] = "Upper box corner";
                  ["start"] = "Start position";
                  ["mask"] = "Trace mask";
                  ["minbox"] = "Lower box corner";
                  ["endpos"] = "End position";
               };
            };
            ["trace"] = {
...
Provides functions for doing line/AABB traces ";
         ["field"] = {
            ...
            [25] = "HITGROUP_LEFTLEG";
            [26] = "HITGROUP_RIGHTLEG";
            [27] = "HITGROUP_GEAR";
            [28] = "MASK_SPLITAREAPORTAL";
            [29] = "MASK_SOLID_BRUSHONLY";
            [30] = "MASK_WATER";
            [31] = "MASK_BLOCKLOS";
            [32] = "MASK_OPAQUE";
            [33] = "MASK_VISIBLE";
            [34] = "MASK_DEADSOLID";
            [35] = "MASK_PLAYERSOLID_BRUSHONLY";
            [36] = "MASK_NPCWORLDSTATIC";
            [37] = "MASK_NPCSOLID_BRUSHONLY";
            [38] = "MASK_CURRENT";
            [39] = "MASK_SHOT_PORTAL";
            [40] = "MASK_SOLID";
            [41] = "MASK_BLOCKLOS_AND_NPCS";
            [42] = "MASK_OPAQUE_AND_NPCS";
            [43] = "MASK_VISIBLE_AND_NPCS";
            [44] = "MASK_PLAYERSOLID";
            [45] = "MASK_NPCSOLID";
            [46] = "MASK_SHOT_HULL";
            [47] = "MASK_SHOT";
            ...
            [54] = "CONTENTS_SLIME";
            [55] = "CONTENTS_WATER";
            [56] = "CONTENTS_BLOCKLOS";
            [57] = "CONTENTS_OPAQUE";
            [58] = "CONTENTS_TESTFOGVOLUME";
            [59] = "CONTENTS_TEAM4";
            [60] = "CONTENTS_TEAM3";
            [61] = "CONTENTS_TEAM1";
            [62] = "CONTENTS_TEAM2";
            [63] = "CONTENTS_IGNORE_NODRAW_OPAQUE";
            [64] = "CONTENTS_MOVEABLE";
            [65] = "CONTENTS_AREAPORTAL";
            [66] = "CONTENTS_PLAYERCLIP";
            [67] = "CONTENTS_MONSTERCLIP";
            [68] = "CONTENTS_CURRENT_0";
            [69] = "CONTENTS_CURRENT_90";
            [70] = "CONTENTS_CURRENT_180";
            [71] = "CONTENTS_CURRENT_270";
            [72] = "CONTENTS_CURRENT_UP";
            [73] = "CONTENTS_CURRENT_DOWN";
            [74] = "CONTENTS_ORIGIN";
            [75] = "CONTENTS_MONSTER";
            [76] = "CONTENTS_DEBRIS";
            [77] = "CONTENTS_DETAIL";
            [78] = "CONTENTS_TRANSLUCENT";
            [79] = "CONTENTS_LADDER";
            [80] = "CONTENTS_HITBOX";
            ["MASK_DEADSOLID"] = "";
            ["MASK_BLOCKLOS"] = "";
...
Provides functions for doing line/AABB traces";
      ...
      ["coroutine"] = {
         ["functions"] = {
            ...
            [7] = "yield";
            ["resume"] = {
               ["ret"] = "Any values the coroutine is returning to the main thread";
               ["class"] = "function";
               ["name"] = "coroutine_library.resume";
               ["summary"] = "\
...
Resumes a suspended coroutine. Note that, in contrast to Lua's native coroutine.resume function, it will not run in protected mode and can throw an error.";
            ...
            ["yield"] = {
               ["ret"] = "Any values passed to the coroutine";
               ["class"] = "function";
               ["name"] = "coroutine_library.yield";
               ["summary"] = "\
...
Suspends the currently running coroutine. May not be called outside a coroutine.";
            ...
            ["running"] = {
               ["ret"] = "Currently running coroutine";
               ["class"] = "function";
               ["name"] = "coroutine_library.running";
               ["summary"] = "\
...
Returns the coroutine that is currently running.";
            ...
            ["status"] = {
               ["ret"] = "Either \"suspended\", \"running\", \"normal\" or \"dead\"";
               ["class"] = "function";
               ["name"] = "coroutine_library.status";
               ["summary"] = "\
...
Returns the status of the coroutine.";
            ...
            ["wrap"] = {
               ["ret"] = "A function that, when called, resumes the created coroutine. Any parameters to that function will be passed to the coroutine.";
               ["class"] = "function";
               ["name"] = "coroutine_library.wrap";
               ["summary"] = "\
...
Creates a new coroutine.";
            ...
            ["wait"] = {
               ["class"] = "function";
               ["name"] = "coroutine_library.wait";
               ["summary"] = "\
Suspends the coroutine for a number of seconds.";
               ["private"] = false;
               ["library"] = "coroutine";
               ["description"] = "\
...
Coroutine library";
      ...
      ["file"] = {
         ["functions"] = {
            ...
            [8] = "write";
            ["delete"] = {
               ["ret"] = "True if successful, nil if error";
               ["class"] = "function";
               ["name"] = "file_library.delete";
               ["summary"] = "\
Deletes a file ";
               ["private"] = false;
               ["library"] = "file";
...
Creates a directory";
            ...
            ["open"] = {
               ["ret"] = "File object or nil if it failed";
               ["class"] = "function";
               ["name"] = "file_library.open";
               ["summary"] = "\
...
Opens and returns a file";
               ["param"] = {
                  [1] = "path";
                  [2] = "mode";
                  ["mode"] = "The file mode to use. See lua manual for explaination";
                  ["path"] = "Filepath relative to data/sf_filedata/. Cannot contain '..'";
               };
            };
            ["read"] = {
               ["ret"] = "Contents, or nil if error";
               ["class"] = "function";
               ["name"] = "file_library.read";
               ["summary"] = "\
...
Reads a file from path";
            ...
            ["exists"] = {
               ["ret"] = "True if exists, false if not, nil if error";
               ["class"] = "function";
               ["name"] = "file_library.exists";
               ["summary"] = "\
...
Appends a string to the end of a file";
            ...
            ["find"] = {
               ["ret"] = {
                  [1] = "Table of file names";
                  [2] = "Table of directory names";
               };
               ["class"] = "function";
               ["name"] = "file_library.find";
               ["summary"] = "\
...
Enumerates a directory";
               ["param"] = {
                  [1] = "path";
                  [2] = "sorting";
                  ["path"] = "The folder to enumerate, relative to data/sf_filedata/. Cannot contain '..'";
                  ["sorting"] = "Optional sorting arguement. Either nameasc, namedesc, dateasc, datedesc";
               };
            };
            ["write"] = {
               ["ret"] = "True if OK, nil if error";
               ["class"] = "function";
               ["name"] = "file_library.write";
               ["summary"] = "\
Writes to a file ";
               ["private"] = false;
               ["library"] = "file";
...
File functions. Allows modification of files.";
      ...
      ["joystick"] = {
         ["functions"] = {
            ...
            [8] = "numPovs";
            ["numJoysticks"] = {
               ["ret"] = "Number of joysticks";
               ["class"] = "function";
               ["name"] = "joystick_library.numJoysticks";
               ["summary"] = "\
...
Gets the number of detected joysticks.";
            ...
            ["getAxis"] = {
               ["ret"] = "0 - 65535 where 32767 is the middle.";
               ["class"] = "function";
               ["name"] = "joystick_library.getAxis";
               ["summary"] = "\
...
Gets the axis data value.";
               ["param"] = {
                  [1] = "enum";
                  [2] = "axis";
                  ["enum"] = "Joystick number. Starts at 0";
                  ["axis"] = "Joystick axis number. Ranges from 0 to 7.";
               };
            };
            ["numAxes"] = {
               ["ret"] = "Number of axes";
               ["class"] = "function";
               ["name"] = "joystick_library.numAxes";
               ["summary"] = "\
...
Gets the number of detected axes on a joystick";
            ...
            ["getName"] = {
               ["ret"] = "Name of the device";
               ["class"] = "function";
               ["name"] = "joystick_library.getName";
               ["summary"] = "\
...
Gets the hardware name of the joystick";
            ...
            ["getButton"] = {
               ["ret"] = "0 or 1";
               ["class"] = "function";
               ["name"] = "joystick_library.getButton";
               ["summary"] = "\
...
Returns if the button is pushed or not";
               ["param"] = {
                  [1] = "enum";
                  [2] = "button";
                  ["button"] = "Joystick button number. Starts at 0";
                  ["enum"] = "Joystick number. Starts at 0";
               };
            };
            ["numPovs"] = {
...
Gets the number of detected povs on a joystick";
            ...
            ["numButtons"] = {
               ...
               ["class"] = "function";
               ["name"] = "joystick_library.numButtons";
               ["summary"] = "\
...
Gets the pov data value.";
               ["param"] = {
                  [1] = "enum";
                  [2] = "pov";
                  ["pov"] = "Joystick pov number. Ranges from 0 to 7.";
                  ["enum"] = "Joystick number. Starts at 0";
               };
            };
         };
...
Remove a hook";
            ...
            ["runRemote"] = {
               ["ret"] = "tbl A list of the resultset of each called hook";
               ["class"] = "function";
               ["summary"] = "\
Run a hook remotely.";
               ["library"] = "hook";
               ["name"] = "hook_library.runRemote";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Deals with hooks";
      ...
      ["fastlz"] = {
         ["functions"] = {
            ...
            [2] = "decompress";
            ["decompress"] = {
               ["ret"] = "Decompressed string";
               ["class"] = "function";
               ["name"] = "fastlz_library.decompress";
               ["summary"] = "\
...
Decompress using FastLZ";
               ["param"] = {
                  [1] = "s";
                  ["s"] = "FastLZ compressed string to decode";
               };
            };
            ["compress"] = {
               ["ret"] = "FastLZ compressed string";
               ["class"] = "function";
               ["name"] = "fastlz_library.compress";
               ["summary"] = "\
...
Writes an vector to the net message";
               ["param"] = {
                  [1] = "t";
                  ["t"] = "The vector to be written";
               };
            };
            ["readColor"] = {
               ["ret"] = "The color that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads a color from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readColor";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Reads a color from the net message";
            ...
            ["readDouble"] = {
               ["ret"] = "The double that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads a double from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readDouble";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Send a net message from client->server, or server->client.";
               ["param"] = {
                  [1] = "target";
                  [2] = "unreliable";
                  ["unreliable"] = "Optional choose whether it's more important for the message to actually reach its destination (false) or reach it as fast as possible (true).";
...
Streams a large 20MB string.";
            ...
            ["readFloat"] = {
               ["ret"] = "The float that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads a float from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readFloat";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Writes an matrix to the net message";
               ["param"] = {
                  [1] = "t";
                  ["t"] = "The matrix to be written";
               };
            };
            ["readUInt"] = {
               ["ret"] = "The unsigned integer that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads an unsigned integer from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readUInt";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Reads an unsigned integer from the net message";
            ...
            ["readBit"] = {
               ["ret"] = "The bit that was read. (0 for false, 1 for true)";
               ["class"] = "function";
               ["summary"] = "\
Reads a bit from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readBit";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Reads a bit from the net message";
            ...
            ["getBytesLeft"] = {
               ["ret"] = "number of bytes that can be sent";
               ["class"] = "function";
               ["name"] = "net_library.getBytesLeft";
               ["summary"] = "\
...
Returns available bandwidth in bytes";
            ...
            ["readEntity"] = {
               ["ret"] = "The entity that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads a entity from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readEntity";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Writes an entity to the net message";
            ...
            ["readString"] = {
               ["ret"] = "The string that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads a string from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readString";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Writes an color to the net message";
               ["param"] = {
                  [1] = "t";
                  ["t"] = "The color to be written";
               };
            };
            ["readInt"] = {
               ["ret"] = "The integer that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads an integer from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readInt";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Writes an integer to the net message";
            ...
            ["readVector"] = {
               ["ret"] = "The vector that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads a vector from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readVector";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Reads a large string stream from the net message";
               ["param"] = {
                  [1] = "cb";
                  ["cb"] = "Callback to run when the stream is finished. The first parameter in the callback is the data.";
               };
            };
            ["writeString"] = {
               ["class"] = "function";
...
Writes a string to the net message. Null characters will terminate the string.";
            ...
            ["readAngle"] = {
               ["ret"] = "The angle that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads an angle from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readAngle";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Writes string containing null characters to the net message";
               ["param"] = {
                  ...
                  [2] = "n";
                  ["t"] = "The string to be written";
                  ["n"] = "How much of the string to write";
               };
            };
            ["readData"] = {
               ["ret"] = "The string that was read";
...
Reads a string from the net message";
               ["param"] = {
                  [1] = "n";
                  ["n"] = "How many characters are in the data";
               };
            };
            ["readMatrix"] = {
               ["ret"] = "The matrix that was read";
               ["class"] = "function";
               ["summary"] = "\
Reads a matrix from the net message ";
               ["library"] = "net";
               ["name"] = "net_library.readMatrix";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Net message library. Used for sending data from the server to the client and back";
      ...
      ["physenv"] = {
         ["functions"] = {
            [1] = "getAirDensity";
            [2] = "getGravity";
            [3] = "getPerformanceSettings";
            ["getGravity"] = {
               ["ret"] = "Vector Gravity Vector ( eg Vector(0,0,-600) )";
               ["class"] = "function";
               ["name"] = "physenv_lib.getGravity";
               ["summary"] = "\
...
Gets the gravity vector";
            ...
            ["getPerformanceSettings"] = {
               ["ret"] = "table Performance Settings Table.";
               ["class"] = "function";
               ["name"] = "physenv_lib.getPerformanceSettings";
               ["summary"] = "\
...
See <a href=\"http://wiki.garrysmod.com/page/Structures/PhysEnvPerformanceSettings\">PhysEnvPerformance Settings Table Structure</a> for table structure.";
            ...
            ["getAirDensity"] = {
               ["ret"] = "number Air Density";
               ["class"] = "function";
               ["name"] = "physenv_lib.getAirDensity";
               ["summary"] = "\
...
Constant that denotes whether the code is executed on the server ";
         ...
         ["functions"] = {
            ...
            ["xpcall"] = {
               ["ret"] = {
                  [1] = "Status of the execution; true for success, false for failure.";
                  [2] = "The returns of the first function if execution succeeded, otherwise the first return value of the error callback.";
               };
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.xpcall";
               ["summary"] = "\
Lua's xpcall with SF throw implementation \
Attempts to call the first function.";
               ["private"] = false;
               ["library"] = "builtin";
               ["description"] = "\
Lua's xpcall with SF throw implementation \
...
If execution fails, this returns false and the second function is called with the error message.";
               ["param"] = {
                  ...
                  [5] = "The";
                  [6] = "arguments";
                  ["funcThe"] = "function to call initially.";
...
Returns the entity representing a processor that this script is running on.";
            ...
            ["hasPermission"] = {
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.hasPermission";
               ["summary"] = "\
...
Checks if the chip is capable of performing an action.";
               ["param"] = {
                  [1] = "perm";
                  ["perm"] = "The permission id to check";
               };
            };
            ["tostring"] = {
               ["ret"] = "obj as string";
...
Same as Lua's tostring ";
            ...
            ["setClipboardText"] = {
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.setClipboardText";
               ["summary"] = "\
Sets clipboard text.";
               ["private"] = false;
               ["library"] = "builtin";
...
Sets clipboard text. Only works on the owner of the chip.";
               ["param"] = {
                  [1] = "txt";
                  ["txt"] = "Text to set to the clipboard";
               };
            };
            ["unpack"] = {
               ["ret"] = "Elements of tbl";
...
Same as Lua's unpack ";
            ...
            ["printMessage"] = {
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.printMessage";
               ["summary"] = "\
...
Prints a message to your chat, console, or the center of your screen.";
               ["param"] = {
                  ...
                  ["mtype"] = "How the message should be displayed. See http://wiki.garrysmod.com/page/Enums/HUD";
               };
            };
            ["quotaUsed"] = {
               ["ret"] = "Current quota used this Think";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.quotaUsed";
               ["summary"] = "\
...
If used on screens, will show 0 if only rendering is done. Operations must be done in the Think loop for them to be counted.";
            ...
            ["isValid"] = {
               ["ret"] = "If it is valid";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.isValid";
               ["summary"] = "\
...
Same as owner() on the server. On the client, returns the local player";
               ...
               ["summary"] = "\
Same as owner() on the server.";
               ["library"] = "builtin";
               ["param"] = {};
            };
            ["quotaTotalAverage"] = {
               ["ret"] = "Total average CPU Time of all your chips.";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.quotaTotalAverage";
               ["summary"] = "\
...
Returns the total average time for all chips by the player.";
            ...
            ["throw"] = {
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.throw";
               ["summary"] = "\
Throws an exception ";
               ["private"] = false;
               ["library"] = "builtin";
...
Throws an exception";
            ...
            ["quotaMax"] = {
               ["ret"] = "Max SysTime allowed to take for execution of the chip in a Think.";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.quotaMax";
               ["summary"] = "\
...
CPU Time is stored in a buffer of N elements, if the average of this exceeds quotaMax, the chip will error.";
            ...
            ["getmetatable"] = {
               ["ret"] = "The metatable of tbl";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.getmetatable";
               ["summary"] = "\
Same as Lua's getmetatable.";
               ["private"] = false;
               ["library"] = "builtin";
               ["description"] = "\
...
Execute a console command ";
               ["library"] = "builtin";
               ["name"] = "SF.DefaultEnvironment.concmd";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Execute a console command";
            ...
            ["getLibraries"] = {
               ["ret"] = "Table containing the names of each available library";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.getLibraries";
               ["summary"] = "\
...
Gets a list of all libraries";
            ...
            ["debugGetInfo"] = {
               ["ret"] = "DebugInfo table";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.debugGetInfo";
               ["summary"] = "\
GLua's getinfo() \
...
Returns a DebugInfo structure containing the passed function's info (https://wiki.garrysmod.com/page/Structures/DebugInfo)";
               ["param"] = {
                  [1] = "funcOrStackLevel";
                  [2] = "fields";
                  ["fields"] = "A string that specifies the information to be retrieved. Defaults to all (flnSu).";
                  ["funcOrStackLevel"] = "Function or stack level to get info about. Defaults to stack level 0.";
               };
            };
            ["rawset"] = {
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.rawset";
               ["summary"] = "\
...
Set the value of a table index without invoking a metamethod";
               ["param"] = {
                  ...
                  [2] = "key";
                  [3] = "value";
                  ["value"] = "The value to set the index equal to";
                  ["key"] = "The index of the table";
                  ["table"] = "The table to modify";
               };
            };
            ["dodir"] = {
               ["ret"] = "Table of return values of the scripts";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.dodir";
               ["summary"] = "\
...
Runs an included directory, but does not cache the result.";
               ["param"] = {
                  [1] = "dir";
                  [2] = "loadpriority";
                  ["loadpriority"] = "Table of files that should be loaded before any others in the directory";
                  ["dir"] = "The directory to include. Make sure to --@includedir it";
               };
            };
            ["tonumber"] = {
               ["ret"] = "obj as number";
...
Returns the entity with index 'num' ";
            ...
            ["printTable"] = {
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.printTable";
               ["summary"] = "\
...
Prints a table to player's chat";
            ...
            ["pcall"] = {
               ["ret"] = {
                  [1] = "If the function had no errors occur within it.";
                  [2] = "If an error occurred, this will be a string containing the error message. Otherwise, this will be the return values of the function passed in.";
               };
               ["class"] = "function";
...
Calls a function and catches an error that can be thrown while the execution of the call.";
            ...
            ["getfenv"] = {
               ["ret"] = "Current environment";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.getfenv";
               ["summary"] = "\
...
Returns the current environment";
            ...
            ["setfenv"] = {
               ["ret"] = "func with environment set to tbl";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.setfenv";
               ["summary"] = "\
Lua's setfenv \
...
Works like setfenv, but is restricted on functions";
            ...
            ["type"] = {
               ["ret"] = "The name of the object's type.";
               ["class"] = "function";
               ["classForced"] = true;
...
Same as Lua's type";
            ...
            ["try"] = {
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.try";
               ["summary"] = "\
...
Similar to xpcall, but a bit more in-depth";
               ["param"] = {
                  [1] = "func";
                  [2] = "catch";
                  ["catch"] = "Optional function to execute in case func fails";
                  ["func"] = "Function to execute";
               };
            };
            ["crc"] = {
               ["ret"] = "The unsigned 32 bit checksum as a string";
               ["description"] = "\
...
Generates the CRC checksum of the specified string.";
            ...
            ["requiredir"] = {
               ["ret"] = "Table of return values of the scripts";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.requiredir";
               ["summary"] = "\
...
Returns whoever created the chip ";
            ...
            ["require"] = {
               ["ret"] = "Return value of the script";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.require";
               ["summary"] = "\
Runs an included script and caches the result.";
               ["private"] = false;
               ["library"] = "builtin";
...
Works pretty much like standard Lua require()";
            ...
            ["quotaAverage"] = {
               ["ret"] = "Average CPU Time of the buffer.";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.quotaAverage";
               ["summary"] = "\
...
Gets the Average CPU Time in the buffer";
            ...
            ["loadstring"] = {
               ["ret"] = "Function of str";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.loadstring";
               ["summary"] = "\
GLua's loadstring \
...
Works like loadstring, except that it executes by default in the main environment";
            ...
            ["rawget"] = {
               ["ret"] = "The value of the index";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.rawget";
               ["summary"] = "\
...
Sets the chip's display name ";
               ["name"] = "SF.DefaultEnvironment.setName";
               ["library"] = "builtin";
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Sets the chip's display name";
            ...
            ["dofile"] = {
               ["ret"] = "Return value of the script";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.dofile";
               ["summary"] = "\
...
Pretty much like standard Lua dofile()";
            ...
            ["quotaTotalUsed"] = {
               ["ret"] = "Total used CPU time of all your chips.";
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.quotaTotalUsed";
               ["summary"] = "\
...
Returns the total used time for all chips by the player.";
            ...
            ["setmetatable"] = {
               ["ret"] = "tbl with metatable set to meta";
               ["description"] = "\
...
Same as Lua's setmetatable.";
            ...
            ["error"] = {
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.error";
               ["summary"] = "\
...
Throws a raw exception.";
            ...
            ["setSoftQuota"] = {
               ["class"] = "function";
               ["name"] = "SF.DefaultEnvironment.setSoftQuota";
               ["summary"] = "\
...
Sets a CPU soft quota which will trigger a catchable error if the cpu goes over a certain amount.";
               ["param"] = {
                  [1] = "quota";
                  ["quota"] = "The threshold where the soft error will be thrown. Ratio of current cpu to the max cpu usage. 0.5 is 50%";
               };
            };
         };
      ...
      ["team"] = {
         ["functions"] = {
            ...
            [11] = "getScore";
            ["bestAutoJoinTeam"] = {
               ["ret"] = "index of the best team to join";
               ["description"] = "\
...
Returns the score of a team ";
               ...
               ["param"] = {
                  [1] = "ind";
                  ["ind"] = "Index of the team";
               };
            };
            ["getNumDeaths"] = {
               ["ret"] = "number of deaths";
               ["description"] = "\
...
Returns number of deaths of all players on a team ";
            ...
            ["getAllTeams"] = {
               ["ret"] = "table containing team information";
               ["class"] = "function";
               ["name"] = "team_library.getAllTeams";
               ["summary"] = "\
...
Returns whether or not the team exists ";
            ...
            ["getColor"] = {
               ["ret"] = "Color of the team";
               ["class"] = "function";
               ["name"] = "team_library.getColor";
               ["summary"] = "\
...
Returns number of players on a team ";
            ...
            ["getPlayers"] = {
               ["ret"] = "Table of players";
               ["class"] = "function";
               ["name"] = "team_library.getPlayers";
               ["summary"] = "\
...
Creates (and starts) a timer";
            ...
            ["getTimersLeft"] = {
               ["ret"] = "Number of available timers";
               ["class"] = "function";
               ["name"] = "timer_library.getTimersLeft";
               ["summary"] = "\
...
Removes a timer";
            ...
            ["exists"] = {
               ["ret"] = "bool if the timer exists";
               ["class"] = "function";
               ["name"] = "timer_library.exists";
               ["summary"] = "\
...
Runs a new http POST request";
               ["param"] = {
                  ...
                  [3] = "callbackSuccess";
                  [4] = "callbackFail";
                  ["callbackFail"] = "the function to be called on request fail, taking the failing reason as an argument";
                  ["callbackSuccess"] = "the function to be called on request success, taking the arguments body (string), length (number), headers (table) and code (number)";
                  ["url"] = "http target url";
                  ["params"] = "POST parameters to be sent";
               };
            };
            ["canRequest"] = {
               ["class"] = "function";
               ["name"] = "http_library.canRequest";
               ["summary"] = "\
...
Http library. Requests content from urls.";
      ...
      ["input"] = {
         ["functions"] = {
            ...
            ["getCursorPos"] = {
               ["ret"] = {
                  [1] = "The x position of the mouse";
                  [2] = "The y position of the mouse";
               };
               ["class"] = "function";
               ["name"] = "input_methods.getCursorPos";
               ["summary"] = "\
...
Gets the position of the mouse";
            ...
            ["lookupBinding"] = {
               ["ret"] = {
                  [1] = "The id of the first key bound";
                  [2] = "The name of the first key bound";
               };
               ["class"] = "function";
               ["name"] = "input_methods.lookupBinding";
               ["summary"] = "\
...
Gets the first key that is bound to the command passed";
               ["param"] = {
                  [1] = "binding";
                  ["binding"] = "The name of the bind";
               };
            };
            ["getKeyName"] = {
               ["ret"] = "The name of the key";
               ["class"] = "function";
               ["name"] = "input_methods.getKeyName";
               ["summary"] = "\
...
Gets the name of a key from the id";
               ["param"] = {
                  [1] = "key";
                  ["key"] = "The key id, see input";
               };
            };
            ["enableCursor"] = {
               ["class"] = "function";
               ["name"] = "input_methods.enableCursor";
               ["summary"] = "\
...
Sets the state of the mouse cursor";
            ...
            ["screenToVector"] = {
               ["ret"] = "Aim vector";
               ["class"] = "function";
               ["name"] = "input_methods.screenToVector";
               ["summary"] = "\
...
Translates position on player's screen to aim vector";
            ...
            ["isShiftDown"] = {
               ...
               ["class"] = "function";
               ["name"] = "input_methods.isShiftDown";
               ["summary"] = "\
...
Gets whether the shift key is down";
            ...
            ["isKeyDown"] = {
               ["ret"] = "True if the key is down";
               ["class"] = "function";
               ["name"] = "input_methods.isKeyDown";
               ["summary"] = "\
...
Gets whether a key is down";
            ...
            ["isControlDown"] = {
               ...
               ["class"] = "function";
               ["name"] = "input_methods.isControlDown";
               ["summary"] = "\
...
Advanced Ballsocket two entities ";
               ["name"] = "constraint_library.ballsocketadv";
               ["library"] = "constraint";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Nocollides two entities ";
               ["name"] = "constraint_library.nocollide";
               ["library"] = "constraint";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Elastic two entities ";
               ["name"] = "constraint_library.elastic";
               ["library"] = "constraint";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Elastic two entities";
            ...
            ["getTable"] = {
               ["ret"] = "Table of entity constraints";
               ["class"] = "function";
               ["name"] = "constraint_library.getTable";
               ["summary"] = "\
...
Sets the length of an elastic attached to the entity ";
               ["name"] = "constraint_library.setElasticLength";
               ["library"] = "constraint";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Breaks all constraints of a certain type on an entity ";
               ["name"] = "constraint_library.breakType";
               ["library"] = "constraint";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Welds two entities";
               ["param"] = {
                  ...
                  ["e1"] = "The first entity";
                  ["bone2"] = "Number bone of the second entity";
                  ["nocollide"] = "Bool whether or not to nocollide the two entities";
                  ["bone1"] = "Number bone of the first entity";
                  ["force_lim"] = "Max force the weld can take before breaking";
               };
            };
            ["rope"] = {
               ["class"] = "function";
...
Breaks all constraints on an entity ";
               ["name"] = "constraint_library.breakAll";
               ["library"] = "constraint";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Sets the length of a rope attached to the entity ";
               ["name"] = "constraint_library.setRopeLength";
               ["library"] = "constraint";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Ballsocket two entities ";
               ["name"] = "constraint_library.ballsocket";
               ["library"] = "constraint";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Sliders two entities ";
               ["name"] = "constraint_library.slider";
               ["library"] = "constraint";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Library for creating and manipulating physics-less models AKA \"Props\".";
      ...
      ["holograms"] = {
         ["functions"] = {
            ...
            [3] = "hologramsLeft";
            ["canSpawn"] = {
               ["ret"] = "True if user can spawn holograms, False if not.";
               ["class"] = "function";
               ["summary"] = "\
Checks if a user can spawn anymore holograms.";
               ["name"] = "holograms_library.canSpawn";
               ["library"] = "holograms";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Checks if a user can spawn anymore holograms.";
            ...
            ["create"] = {
               ["ret"] = "The hologram object";
               ["class"] = "function";
               ["summary"] = "\
Creates a hologram.";
               ["name"] = "holograms_library.create";
               ["library"] = "holograms";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Creates a hologram.";
            ...
            ["hologramsLeft"] = {
               ["ret"] = "number of holograms able to be spawned";
               ["class"] = "function";
               ["summary"] = "\
Checks how many holograms can be spawned ";
               ["name"] = "holograms_library.hologramsLeft";
               ["library"] = "holograms";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Hologram type";
         ["class"] = "class";
         ["methods"] = {
            [1] = "getAnimationLength";
            [2] = "getAnimationNumber";
            [3] = "getFlexes";
            [4] = "getPose";
            [5] = "setAngVel";
            [6] = "setAnimation";
            ...
            [12] = "setScale";
            [13] = "setVel";
            [14] = "suppressEngineLighting";
            ["setScale"] = {
               ["class"] = "function";
               ["name"] = "hologram_methods:setScale";
               ["summary"] = "\
...
Sets the hologram scale";
            ...
            ["getFlexes"] = {
               ["class"] = "function";
               ["name"] = "hologram_methods:getFlexes";
               ["summary"] = "\
...
These IDs become invalid when the hologram's model changes.";
            ...
            ["setFlexWeight"] = {
               ["class"] = "function";
               ["name"] = "hologram_methods:setFlexWeight";
               ["summary"] = "\
...
Get the pose value of an animation";
               ["param"] = {
                  [1] = "pose";
                  ["pose"] = "Pose parameter name";
               };
            };
            ["setAngVel"] = {
               ["class"] = "function";
               ["name"] = "hologram_methods:setAngVel";
               ["summary"] = "\
...
Sets the hologram's angular velocity.";
               ["param"] = {
                  [1] = "angvel";
                  ["angvel"] = "*Vector* angular velocity.";
               };
            };
            ["getAnimationNumber"] = {
               ["ret"] = "Animation index";
...
Convert animation name into animation number ";
               ["name"] = "hologram_methods:getAnimationNumber";
               ["classlib"] = "Hologram";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Convert animation name into animation number";
            ...
            ["setAnimation"] = {
               ...
               ["summary"] = "\
Animates a hologram ";
               ["name"] = "hologram_methods:setAnimation";
               ["classlib"] = "Hologram";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Animates a hologram";
               ["param"] = {
                  ...
                  [2] = "frame";
                  [3] = "rate";
                  ["frame"] = "The starting frame number";
                  ["rate"] = "Frame speed. (1 is normal)";
                  ["animation"] = "number or string name";
               };
            };
            ["setFlexScale"] = {
               ["class"] = "function";
               ["name"] = "hologram_methods:setFlexScale";
               ["summary"] = "\
...
Set the pose value of an animation. Turret/Head angles for example.";
               ["param"] = {
                  ...
                  ["pose"] = "Name of the pose parameter";
               };
            };
            ["setVel"] = {
               ["class"] = "function";
               ["name"] = "hologram_methods:setVel";
               ["summary"] = "\
...
Sets the hologram linear velocity";
            ...
            ["getAnimationLength"] = {
               ["ret"] = "Length of current animation in seconds";
               ["class"] = "function";
               ["classForced"] = true;
               ["summary"] = "\
Get the length of the current animation ";
               ["name"] = "hologram_methods:getAnimationLength";
               ["classlib"] = "Hologram";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Get the length of the current animation";
            ...
            ["suppressEngineLighting"] = {
               ...
               ["classForced"] = true;
               ["summary"] = "\
Suppress Engine Lighting of a hologram.";
               ["name"] = "hologram_methods:suppressEngineLighting";
               ["classlib"] = "Hologram";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Suppress Engine Lighting of a hologram. Disabled by default.";
               ["param"] = {
                  [1] = "suppress";
                  ["suppress"] = "Boolean to represent if shading should be set or not.";
               };
            };
            ["setModel"] = {
               ["class"] = "function";
...
Sets the model of a hologram ";
               ["name"] = "hologram_methods:setModel";
               ["classlib"] = "Hologram";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Color type";
         ...
         ["methods"] = {
            ...
            [6] = "setR";
            ["setA"] = {
               ["ret"] = "The modified color";
               ["class"] = "function";
               ["name"] = "color_methods:setA";
               ["summary"] = "\
...
Set's the color's red channel and returns it.";
            ...
            ["rgbToHSV"] = {
               ["ret"] = "A triplet of numbers representing HSV.";
               ["class"] = "function";
               ["summary"] = "\
Converts the color from RGB to HSV.";
               ["classlib"] = "Color";
               ["name"] = "color_methods:rgbToHSV";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Makes the npc walk to a destination";
               ["param"] = {
                  [1] = "vec";
                  ["vec"] = "The position of the destination";
               };
            };
            ["addEntityRelationship"] = {
               ["class"] = "function";
               ["name"] = "npc_methods:addEntityRelationship";
               ["summary"] = "\
...
Adds a relationship to the npc with an entity";
               ["param"] = {
                  ...
                  [2] = "disp";
                  [3] = "priority";
                  ["priority"] = "number how strong the relationship is. Higher number is stronger";
                  ["disp"] = "String of the relationship. (hate fear like neutral)";
                  ["ent"] = "The target entity";
               };
            };
            ["attackRange"] = {
               ["class"] = "function";
               ["name"] = "npc_methods:attackRange";
               ["summary"] = "\
...
Makes the npc do a ranged attack";
            ...
            ["getRelationship"] = {
               ["ret"] = "string relationship of the npc with the target";
               ["class"] = "function";
               ["name"] = "npc_methods:getRelationship";
               ["summary"] = "\
...
Stops the npc";
            ...
            ["getEnemy"] = {
               ["ret"] = "Entity the npc is fighting";
               ["class"] = "function";
               ["name"] = "npc_methods:getEnemy";
               ["summary"] = "\
...
Makes the npc do a melee attack";
            ...
            ["addRelationship"] = {
               ["class"] = "function";
               ["name"] = "npc_methods:addRelationship";
               ["summary"] = "\
...
Adds a relationship to the npc";
               ["param"] = {
                  [1] = "str";
                  ["str"] = "The relationship string. http://wiki.garrysmod.com/page/NPC/AddRelationship";
               };
            };
            ["setEnemy"] = {
               ["class"] = "function";
               ["name"] = "npc_methods:setEnemy";
               ["summary"] = "\
...
Normalise the vector, same direction, length 1. Self-Modifies.";
            ...
            ["dot"] = {
               ["ret"] = "Number";
               ["class"] = "function";
               ["name"] = "vec_methods:dot";
               ["summary"] = "\
Dot product is the cosine of the angle between both vectors multiplied by their lengths.";
               ["private"] = false;
               ["classlib"] = "Vector";
               ["description"] = "\
...
Set's all vector fields to 0.";
            ...
            ["getLength2DSqr"] = {
               ["ret"] = "number length squared.";
               ["class"] = "function";
               ["name"] = "vec_methods:getLength2DSqr";
               ["summary"] = "\
...
Returns the length squared of the vector in two dimensions, without the Z axis. ( Saves computation by skipping the square root )";
            ...
            ["rotateAroundAxis"] = {
               ["ret"] = "Rotated vector";
               ["class"] = "function";
               ["name"] = "vec_methods:rotateAroundAxis";
               ["summary"] = "\
...
Return rotated vector by an axis";
               ["param"] = {
                  ...
                  [2] = "degrees";
                  [3] = "radians";
                  ["degrees"] = "Angle to rotate by in degrees or nil if radians.";
                  ["radians"] = "Angle to rotate by in radians or nil if degrees.";
                  ["axis"] = "Axis the rotate around";
               };
            };
            ["setZ"] = {
               ["ret"] = "The modified vector";
               ["class"] = "function";
               ["name"] = "vec_methods:setZ";
               ["summary"] = "\
...
Are all fields zero.";
            ...
            ["getNormalized"] = {
               ["ret"] = "Vector Normalised";
               ["class"] = "function";
               ["name"] = "vec_methods:getNormalized";
               ["summary"] = "\
...
\"Scalar Division\" of the vector. Self-Modifies.";
               ["param"] = {
                  [1] = "n";
                  ["n"] = "Scalar to divide by.";
               };
            };
            ["getLengthSqr"] = {
               ["ret"] = "number length squared.";
               ["class"] = "function";
               ["name"] = "vec_methods:getLengthSqr";
               ["summary"] = "\
...
Rotate the vector by Angle b. Self-Modifies.";
               ["param"] = {
                  [1] = "b";
                  ["b"] = "Angle to rotate by.";
               };
            };
            ["getDistanceSqr"] = {
               ["ret"] = "Number";
               ["class"] = "function";
               ["name"] = "vec_methods:getDistanceSqr";
               ["summary"] = "\
...
Entity type ";
         ["methods"] = {
            ...
            [51] = "linkComponent";
            [52] = "localToWorld";
            [53] = "localToWorldAngles";
            [54] = "lookupAttachment";
            [55] = "manipulateBoneAngles";
            [56] = "manipulateBonePosition";
            [57] = "manipulateBoneScale";
            [58] = "obbCenter";
            [59] = "obbCenterW";
            [60] = "obbSize";
            [61] = "remove";
...
Applies torque";
               ["param"] = {
                  [1] = "tq";
                  [2] = "offset";
                  ["offset"] = "Optional offset position";
...
Sets an entities' submaterial ";
               ["name"] = "ents_methods:setSubMaterial";
               ["classlib"] = "Entity";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Sets an entities' submaterial";
               ["param"] = {
                  ...
                  ["index"] = ", number, submaterial index.";
                  ["ply"] = "Optional player arguement to set only for that player. Can also be table of players.";
               };
            };
            ["setNocollideAll"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:setNocollideAll";
               ["summary"] = "\
...
Set's the entity to collide with nothing but the world";
               ["param"] = {
                  [1] = "nocollide";
                  ["nocollide"] = "Whether to collide with nothing except world or not.";
               };
            };
            ["setPos"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:setPos";
               ["summary"] = "\
...
Unparents the entity from another entity";
            ...
            ["applyForceCenter"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:applyForceCenter";
               ["summary"] = "\
...
Applies linear force to the entity";
            ...
            ["enableGravity"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:enableGravity";
               ["summary"] = "\
Sets entity gravity ";
               ["private"] = false;
               ["classlib"] = "Entity";
...
Sets entity gravity";
               ["param"] = {
                  [1] = "grav";
                  ["grav"] = "Bool should the entity respect gravity?";
               };
            };
            ["addCollisionListener"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:addCollisionListener";
               ["summary"] = "\
...
Allows detecting collisions on an entity. You can only do this once for the entity's entire lifespan so use it wisely.";
               ["param"] = {
                  [1] = "func";
                  ["func"] = "The callback function with argument, table collsiondata, http://wiki.garrysmod.com/page/Structures/CollisionData";
               };
            };
            ["setSkin"] = {
               ["class"] = "function";
...
Sets the skin of the entity";
            ...
            ["getAngleVelocity"] = {
               ["ret"] = "The angular velocity vector";
               ["class"] = "function";
               ["summary"] = "\
Returns the angular velocity of the entity ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getAngleVelocity";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Gets the skin number of the entity";
            ...
            ["getAttachmentParent"] = {
               ["ret"] = "number index of the attachment the entity is parented to or 0";
               ["class"] = "function";
               ["summary"] = "\
Gets the attachment index the entity is parented to ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getAttachmentParent";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the local position of the entity's outer bounding box";
            ...
            ["getModel"] = {
               ["ret"] = "Model of the entity";
               ["class"] = "function";
               ["summary"] = "\
Gets the model of an entity ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getModel";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
For more information please refer to GLua function http://wiki.garrysmod.com/page/Entity/SetNotSolid";
            ...
            ["getEyePos"] = {
               ["ret"] = {
                  ...
                  [2] = "In case of a ragdoll, the position of the second eye";
               };
               ["class"] = "function";
               ["summary"] = "\
Gets the entity's eye position ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getEyePos";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Sets a hologram entity's model to a custom Mesh ";
               ["name"] = "ents_methods:setHologramMesh";
               ["classlib"] = "Entity";
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Sets a hologram entity's model to a custom Mesh";
               ["param"] = {
                  [1] = "mesh";
                  ["mesh"] = "The mesh to set it to or nil to set back to normal";
               };
            };
            ["getInertia"] = {
               ["ret"] = "The principle moments of inertia as a vector";
               ["class"] = "function";
               ["summary"] = "\
Returns the principle moments of inertia of the entity ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getInertia";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns the principle moments of inertia of the entity";
            ...
            ["isPlayer"] = {
               ["ret"] = "True if player, false if not";
               ["class"] = "function";
               ["summary"] = "\
Checks if an entity is a player.";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:isPlayer";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Checks if an entity is a player.";
            ...
            ["linkComponent"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:linkComponent";
               ["summary"] = "\
Links starfall components to a starfall processor or vehicle.";
               ["private"] = false;
               ["classlib"] = "Entity";
               ["description"] = "\
Links starfall components to a starfall processor or vehicle. Screen can only connect to processor. HUD can connect to processor and vehicle.";
               ["param"] = {
                  [1] = "e";
                  ["e"] = "Entity to link the component to. nil to clear links.";
               };
            };
            ["obbSize"] = {
...
Sets the renderfx of the entity";
               ["param"] = {
                  [1] = "renderfx";
                  [2] = "ply";
                  ["renderfx"] = "Number, renderfx to use. http://wiki.garrysmod.com/page/Enums/kRenderFx";
                  ["ply"] = "Optional player arguement to set only for that player. Can also be table of players.";
               };
            };
            ["worldToLocal"] = {
               ["ret"] = "data as local space vector";
               ["class"] = "function";
               ["summary"] = "\
Converts a vector in world space to entity local space ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:worldToLocal";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Converts a vector in world space to entity local space";
            ...
            ["localToWorldAngles"] = {
               ["ret"] = "data as world space angle";
               ["class"] = "function";
               ["summary"] = "\
Converts an angle in entity local space to world space ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:localToWorldAngles";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Converts an angle in entity local space to world space";
            ...
            ["getAttachment"] = {
               ["ret"] = "vector position, and angle orientation";
               ["class"] = "function";
               ["summary"] = "\
Gets the position and angle of an attachment ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getAttachment";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Gets the position and angle of an attachment";
            ...
            ["applyForceOffset"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:applyForceOffset";
               ["summary"] = "\
...
Removes an entity";
            ...
            ["isValidPhys"] = {
               ["ret"] = "True if entity has physics";
               ["class"] = "function";
               ["name"] = "ents_methods:isValidPhys";
               ["summary"] = "\
...
Checks whether entity has physics";
            ...
            ["isWeapon"] = {
               ["ret"] = "True if weapon, false if not";
               ["class"] = "function";
               ["summary"] = "\
Checks if an entity is a weapon.";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:isWeapon";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Checks if an entity is a weapon.";
            ...
            ["lookupAttachment"] = {
               ["ret"] = "number of the attachment index, or 0 if it doesn't exist";
               ["class"] = "function";
               ["summary"] = "\
Gets the attachment index via the entity and it's attachment name ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:lookupAttachment";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Adds a trail to the entity with the specified attributes.";
               ["param"] = {
                  ...
                  [6] = "attachmentID";
                  [7] = "additive";
                  ["startSize"] = "The start size of the trail";
                  ["attachmentID"] = "Optional attachmentid the trail should attach to";
                  ["length"] = "The length size of the trail";
                  ["color"] = "The color of the trail";
                  ["material"] = "The material of the trail";
                  ["endSize"] = "The end size of the trail";
                  ["additive"] = "If the trail's rendering is additive";
               };
            };
            ["getMatrix"] = {
               ["ret"] = "The matrix";
...
Returns the matrix of the entity";
               ["param"] = {
                  [1] = "bone";
                  ["bone"] = "Bone of the entity (def 0)";
               };
            };
            ["setVelocity"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:setVelocity";
               ["summary"] = "\
...
Returns the angle of the entity";
            ...
            ["localToWorld"] = {
               ["ret"] = "data as world space vector";
               ["class"] = "function";
               ["summary"] = "\
Converts a vector in entity local space to world space ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:localToWorld";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Sets the whether an entity should be drawn or not";
               ["param"] = {
                  [1] = "draw";
                  [2] = "ply";
                  ["draw"] = "Whether to draw the entity or not.";
                  ["ply"] = "Optional player arguement to set only for that player. Can also be table of players.";
               };
            };
            ["getParent"] = {
               ["ret"] = "Entity's parent or nil";
               ["class"] = "function";
               ["summary"] = "\
Gets the parent of an entity ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getParent";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Allows manipulation of the owner's bones' angles ";
               ["name"] = "ents_methods:manipulateBoneAngles";
               ["classlib"] = "Entity";
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Allows manipulation of the owner's bones' angles";
               ["param"] = {
                  [1] = "bone";
                  [2] = "ang";
                  ["ang"] = "The angle it should be manipulated to";
                  ["bone"] = "The bone ID";
               };
            };
            ["getEyeAngles"] = {
               ["ret"] = "Angles of the entity's eyes";
               ["class"] = "function";
               ["summary"] = "\
Gets the entitiy's eye angles ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getEyeAngles";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Gets an entities' material list ";
               ["classForced"] = true;
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getMaterials";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Gets an entities' material list";
            ...
            ["enableMotion"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:enableMotion";
               ["summary"] = "\
...
Sets the entity movement state";
               ["param"] = {
                  [1] = "move";
                  ["move"] = "Bool should the entity move?";
               };
            };
            ["isFrozen"] = {
               ["ret"] = "True if entity is frozen";
               ["class"] = "function";
               ["name"] = "ents_methods:isFrozen";
               ["summary"] = "\
...
Extinguishes an entity";
            ...
            ["applyAngForce"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:applyAngForce";
               ["summary"] = "\
...
Sets the entity frozen state";
            ...
            ["enableSphere"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:enableSphere";
               ["summary"] = "\
...
Sets the physics of an entity to be a sphere";
               ["param"] = {
                  [1] = "enabled";
                  ["enabled"] = "Bool should the entity be spherical?";
               };
            };
            ["isNPC"] = {
               ["ret"] = "True if npc, false if not";
               ["class"] = "function";
               ["summary"] = "\
Checks if an entity is an npc.";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:isNPC";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Checks if an entity is an npc.";
            ...
            ["worldToLocalAngles"] = {
               ["ret"] = "data as local space angle";
               ["class"] = "function";
               ["summary"] = "\
Converts an angle in world space to entity local space ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:worldToLocalAngles";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Converts an angle in world space to entity local space";
            ...
            ["getHealth"] = {
               ["ret"] = "Health of the entity";
               ["class"] = "function";
               ["summary"] = "\
Gets the health of an entity ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getHealth";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Sets an entities' bodygroup ";
               ["name"] = "ents_methods:setBodygroup";
               ["classlib"] = "Entity";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Allows manipulation of the owner's bones' scale ";
               ["name"] = "ents_methods:manipulateBoneScale";
               ["classlib"] = "Entity";
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Allows manipulation of the owner's bones' scale";
               ["param"] = {
                  [1] = "bone";
                  [2] = "vec";
                  ["vec"] = "The scale it should be manipulated to";
                  ["bone"] = "The bone ID";
               };
            };
            ["setMaterial"] = {
...
Sets an entities' material";
            ...
            ["getMass"] = {
               ["ret"] = "The numerical mass";
               ["class"] = "function";
               ["summary"] = "\
Returns the mass of the entity ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getMass";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns the mass of the entity";
            ...
            ["getMaxHealth"] = {
               ["ret"] = "Max Health of the entity";
               ["class"] = "function";
               ["summary"] = "\
Gets the max health of an entity ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getMaxHealth";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Gets an entities' submaterial ";
               ["classForced"] = true;
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getSubMaterial";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Allows manipulation of the owner's bones' positions ";
               ["name"] = "ents_methods:manipulateBonePosition";
               ["classlib"] = "Entity";
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Allows manipulation of the owner's bones' positions";
               ["param"] = {
                  [1] = "bone";
                  [2] = "vec";
                  ["vec"] = "The position it should be manipulated to";
                  ["bone"] = "The bone ID";
               };
            };
            ["setHologramRenderBounds"] = {
               ["class"] = "function";
               ["summary"] = "\
Sets a hologram entity's renderbounds ";
               ["name"] = "ents_methods:setHologramRenderBounds";
               ["classlib"] = "Entity";
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Sets a hologram entity's renderbounds";
               ["param"] = {
                  [1] = "mins";
                  [2] = "maxs";
                  ["maxs"] = "The upper bounding corner coordinate local to the hologram";
                  ["mins"] = "The lower bounding corner coordinate local to the hologram";
               };
            };
            ["isVehicle"] = {
               ["ret"] = "True if vehicle, false if not";
               ["class"] = "function";
               ["summary"] = "\
Checks if an entity is a vehicle.";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:isVehicle";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Checks if an entity is a vehicle.";
            ...
            ["setPhysMaterial"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:setPhysMaterial";
               ["summary"] = "\
...
Plays a sound on the entity";
               ["param"] = {
                  ...
                  ["snd"] = "string Sound path";
                  ["lvl"] = "number soundLevel=75";
...
Returns the position of the entity";
            ...
            ["removeTrails"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:removeTrails";
               ["summary"] = "\
...
Removes trails from the entity";
            ...
            ["getMassCenter"] = {
               ["ret"] = "The position vector of the mass center";
               ["class"] = "function";
               ["summary"] = "\
Returns the local position of the entity's mass center ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getMassCenter";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Ignites an entity";
               ["param"] = {
                  [1] = "length";
                  [2] = "radius";
                  ["radius"] = "(optional) How large the fire hitbox is (entity obb is the max)";
                  ["length"] = "How long the fire lasts";
               };
            };
            ["setParent"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:setParent";
               ["summary"] = "\
...
Sets the entity drag state";
               ["param"] = {
                  [1] = "drag";
                  ["drag"] = "Bool should the entity have air resistence?";
               };
            };
            ["setAngles"] = {
               ["class"] = "function";
               ["name"] = "ents_methods:setAngles";
               ["summary"] = "\
...
Sets the rende mode of the entity ";
               ["name"] = "ents_methods:setRenderMode";
               ["classlib"] = "Entity";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Sets the rende mode of the entity";
               ["param"] = {
                  ...
                  [2] = "ply";
                  ["ply"] = "Optional player arguement to set only for that player. Can also be table of players.";
                  ["rendermode"] = "Number, rendermode to use. http://wiki.garrysmod.com/page/Enums/RENDERMODE";
               };
            };
            ["getMassCenterW"] = {
               ["ret"] = "The position vector of the mass center";
...
Returns the world position of the entity's mass center ";
               ["classlib"] = "Entity";
               ["name"] = "ents_methods:getMassCenterW";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns if p,y,r are all 0.";
            ...
            ["getNormalized"] = {
               ["ret"] = "Normalized angle table";
               ["class"] = "function";
               ["name"] = "ang_methods:getNormalized";
               ["summary"] = "\
...
Copies p,y,r from angle to another.";
               ["param"] = {
                  [1] = "b";
                  ["b"] = "Angle to copy from.";
               };
            };
            ["rotateAroundAxis"] = {
               ["ret"] = "The modified angle";
               ["class"] = "function";
               ["name"] = "ang_methods:rotateAroundAxis";
               ["summary"] = "\
...
Return Rotated angle around the specified axis.";
               ["param"] = {
                  ...
                  [2] = "deg";
                  [3] = "rad";
                  ["rad"] = "Number of radians or nil if degrees.";
                  ["deg"] = "Number of degrees or nil if radians.";
                  ["v"] = "Vector axis";
               };
            };
         };
...
Sound type";
         ...
         ["methods"] = {
            ...
            ["setSoundLevel"] = {
               ["class"] = "function";
               ["name"] = "sound_methods:setSoundLevel";
               ["summary"] = "\
...
Sets the sound level in dB.";
               ["param"] = {
                  [1] = "level";
                  ["level"] = "dB level, see <a href='https://developer.valvesoftware.com/wiki/Soundscripts#SoundLevel'> Vale Dev Wiki</a>, for information on the value to use.";
               };
            };
            ["stop"] = {
               ["class"] = "function";
               ["name"] = "sound_methods:stop";
               ["summary"] = "\
...
Stops the sound from being played.";
               ["param"] = {
                  [1] = "fade";
                  ["fade"] = "Time in seconds to fade out, if nil or 0 the sound stops instantly.";
               };
            };
            ["isPlaying"] = {
               ["class"] = "function";
               ["name"] = "sound_methods:isPlaying";
               ["summary"] = "\
...
Sets the volume of the sound.";
               ["param"] = {
                  ...
                  ["fade"] = "Time in seconds to transition to this new volume.";
               };
            };
            ["play"] = {
               ["class"] = "function";
               ["name"] = "sound_methods:play";
               ["summary"] = "\
...
Sets the pitch of the sound.";
               ["param"] = {
                  [1] = "pitch";
                  [2] = "fade";
                  ["pitch"] = "Pitch to set to, between 0 and 255.";
                  ["fade"] = "Time in seconds to transition to this new pitch.";
               };
            };
         };
      };
      ["Wirelink"] = {
         ["typtbl"] = "wirelink_methods";
         ["fields"] = {};
         ["name"] = "Wirelink";
         ["summary"] = "\
Wirelink type ";
...
Wirelink type";
         ...
         ["methods"] = {
            ...
            ["isValid"] = {
               ["class"] = "function";
               ["name"] = "wirelink_methods:isValid";
               ["summary"] = "\
Checks if a wirelink is valid.";
               ["private"] = false;
               ["classlib"] = "Wirelink";
               ["description"] = "\
Checks if a wirelink is valid. (ie. doesn't point to an invalid entity)";
            ...
            ["outputType"] = {
               ["class"] = "function";
               ["name"] = "wirelink_methods:outputType";
               ["summary"] = "\
...
Returns the type of output name, or nil if it doesn't exist";
            ...
            ["getWiredTo"] = {
               ["ret"] = "The entity the wirelink is wired to";
               ["class"] = "function";
               ["name"] = "wirelink_methods:getWiredTo";
               ["summary"] = "\
...
Returns what an input of the wirelink is wired to.";
            ...
            ["inputType"] = {
               ["class"] = "function";
               ["name"] = "wirelink_methods:inputType";
               ["summary"] = "\
...
Returns the entity that the wirelink represents";
            ...
            ["getWiredToName"] = {
               ["ret"] = "String name of the output that the input is wired to.";
               ["class"] = "function";
               ["name"] = "wirelink_methods:getWiredToName";
               ["summary"] = "\
...
Returns the name of the output an input of the wirelink is wired to.";
               ["param"] = {
                  [1] = "name";
                  ["name"] = "Name of the input of the wirelink.";
               };
            };
            ["inputs"] = {
               ["class"] = "function";
               ["name"] = "wirelink_methods:inputs";
               ["summary"] = "\
...
Player type";
         ...
         ["methods"] = {
            ...
            [40] = "setViewEntity";
            ["isUserGroup"] = {
               ["ret"] = "True if player belongs to group";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player belongs to a usergroup ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isUserGroup";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns whether the player belongs to a usergroup";
            ...
            ["isBot"] = {
               ["ret"] = "True if player is a bot";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is a bot ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isBot";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns whether the player is a bot";
            ...
            ["setViewEntity"] = {
               ["class"] = "function";
               ["summary"] = "\
Sets the view entity of the player.";
               ["name"] = "player_methods:setViewEntity";
               ["classlib"] = "Player";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Sets the view entity of the player. Only works if they are linked to a hud.";
               ["param"] = {
                  [1] = "e";
                  ["e"] = "Entity to set the player's view entity to";
               };
            };
            ["isNoclipped"] = {
               ["ret"] = "true if the player is noclipped";
               ["class"] = "function";
               ["summary"] = "\
Returns true if the player is noclipped ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isNoclipped";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's jump power ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getJumpPower";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns the player's jump power";
            ...
            ["inVehicle"] = {
               ["ret"] = "True if player in vehicle";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is in a vehicle ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:inVehicle";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's shoot position ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getShootPos";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's current team";
            ...
            ["getViewEntity"] = {
               ["ret"] = "Player's current view entity";
               ["class"] = "function";
               ["summary"] = "\
Returns the player's current view entity ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getViewEntity";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's steam ID ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getSteamID";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns the player's steam ID";
            ...
            ["isConnected"] = {
               ["ret"] = "True if player is connected";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is connected ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isConnected";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's maximum speed ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getMaxSpeed";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's community ID ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getSteamID64";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's running speed ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getRunSpeed";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's aim vector ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getAimVector";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's unique ID ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getUniqueID";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns the player's unique ID";
            ...
            ["getFriendStatus"] = {
               ["ret"] = "One of: \"friend\", \"blocked\", \"none\", \"requested\"";
               ["class"] = "function";
               ["name"] = "player_methods:getFriendStatus";
               ["summary"] = "\
...
Returns the amount of kills of the player";
            ...
            ["isMuted"] = {
               ["ret"] = "True if the player was muted";
               ["class"] = "function";
               ["name"] = "player_methods:isMuted";
               ["summary"] = "\
...
Returns whether the local player has muted the player";
            ...
            ["isFrozen"] = {
               ["ret"] = "True if player is frozen";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is frozen ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isFrozen";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns whether the player is frozen";
            ...
            ["isPlayer"] = {
               ["ret"] = "True if player is player";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is a player ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isPlayer";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the specified weapon or nil if the player doesn't have it";
               ["param"] = {
                  [1] = "wep";
                  ["wep"] = "String weapon class";
               };
            };
            ["getWeapons"] = {
               ["ret"] = "Table of weapons";
               ["class"] = "function";
               ["summary"] = "\
Returns a table of weapons the player is carrying ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getWeapons";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns a table of weapons the player is carrying";
            ...
            ["isAlive"] = {
               ["ret"] = "True if player alive";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is alive ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isAlive";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns whether the player is alive";
            ...
            ["isFlashlightOn"] = {
               ["ret"] = "True if player has flashlight on";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player's flashlight is on ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isFlashlightOn";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the player's name";
            ...
            ["isNPC"] = {
               ["ret"] = "True if player is an NPC";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is an NPC ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isNPC";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns whether the player is an NPC";
            ...
            ["isAdmin"] = {
               ["ret"] = "True if player is admin";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is an admin ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isAdmin";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns whether the player is an admin";
            ...
            ["isSuperAdmin"] = {
               ["ret"] = "True if player is super admin";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is a super admin ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isSuperAdmin";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the name of the player's current team ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getTeamName";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns the name of the player's current team";
            ...
            ["isCrouching"] = {
               ["ret"] = "True if player crouching";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the player is crouching ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:isCrouching";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns a table with information of what the player is looking at ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getEyeTrace";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns a table with information of what the player is looking at";
            ...
            ["getDeaths"] = {
               ["ret"] = "Amount of deaths";
               ["class"] = "function";
               ["summary"] = "\
Returns the amount of deaths of the player ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getDeaths";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns the amount of deaths of the player";
            ...
            ["hasGodMode"] = {
               ["ret"] = "True if the player has godmode";
               ["class"] = "function";
               ["summary"] = "\
Returns whether or not the player has godmode ";
               ["name"] = "player_methods:hasGodMode";
               ["classlib"] = "Player";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Returns the name of the player's active weapon ";
               ["classlib"] = "Player";
               ["name"] = "player_methods:getActiveWeapon";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Sets if the sound should loop or not.";
               ["param"] = {
                  [1] = "loop";
                  ["loop"] = "Boolean if the sound should loop or not.";
               };
            };
            ["isOnline"] = {
               ["ret"] = "Is online or not";
               ["class"] = "function";
               ["name"] = "bass_methods:isOnline";
               ["summary"] = "\
...
Sets the fade distance of the sound";
               ["param"] = {
                  [1] = "min";
                  [2] = "max";
                  ["max"] = "The channel's volume stops decreasing when the listener is beyond this distance.";
                  ["min"] = "The channel's volume is at maximum when the listener is within this distance";
               };
            };
            ["getFFT"] = {
               ["ret"] = "FFT table of the sound";
               ["class"] = "function";
               ["name"] = "bass_methods:getFFT";
               ["summary"] = "\
...
Gets the FFT of a sound";
               ["param"] = {
                  [1] = "n";
                  ["n"] = "Sample size of the hamming window. Must be power of 2";
               };
            };
            ["getTime"] = {
               ["ret"] = "Current time in seconds of the sound";
               ["class"] = "function";
               ["name"] = "bass_methods:getTime";
               ["summary"] = "\
...
Sets the current time of a sound";
               ["param"] = {
                  [1] = "time";
                  ["time"] = "Time to set a sound in seconds";
               };
            };
            ["setPos"] = {
               ["class"] = "function";
               ["name"] = "bass_methods:setPos";
               ["summary"] = "\
...
Sets the position of the sound";
               ["param"] = {
                  [1] = "pos";
                  ["pos"] = "Where to position the sound";
               };
            };
            ["stop"] = {
               ["class"] = "function";
               ["name"] = "bass_methods:stop";
               ["summary"] = "\
...
Stops playing the sound.";
            ...
            ["getLength"] = {
               ["ret"] = "Length in seconds of the sound";
               ["class"] = "function";
               ["name"] = "bass_methods:getLength";
               ["summary"] = "\
...
Sets the pitch of the sound.";
               ["param"] = {
                  [1] = "pitch";
                  ["pitch"] = "Pitch to set to, between 0 and 3.";
               };
            };
            ["setVolume"] = {
               ["class"] = "function";
               ["name"] = "bass_methods:setVolume";
               ["summary"] = "\
Sets the volume of the sound.";
               ["private"] = false;
               ["classlib"] = "Bass";
...
Vehicle type";
         ...
         ["methods"] = {
            ...
            [3] = "getPassenger";
            ["getDriver"] = {
               ["ret"] = "Driver of vehicle";
               ["class"] = "function";
               ["summary"] = "\
Returns the driver of the vehicle ";
               ["name"] = "vehicle_methods:getDriver";
               ["classlib"] = "Vehicle";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Returns a passenger of a vehicle ";
               ["name"] = "vehicle_methods:getPassenger";
               ["classlib"] = "Vehicle";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
Returns a passenger of a vehicle";
               ["param"] = {
                  [1] = "n";
                  ["n"] = "The index of the passenger to get";
               };
            };
            ["ejectDriver"] = {
               ["class"] = "function";
...
Ejects the driver of the vehicle ";
               ["name"] = "vehicle_methods:ejectDriver";
               ["classlib"] = "Vehicle";
               ["private"] = false;
               ["server"] = true;
               ["description"] = "\
...
Returns the file's size in bytes";
            ...
            ["skip"] = {
               ["ret"] = "The resulting position";
               ["class"] = "function";
               ["name"] = "file_methods:skip";
               ["summary"] = "\
...
Moves the file position relative to its current position";
               ["param"] = {
                  [1] = "n";
                  ["n"] = "How much to move the position";
               };
            };
            ["write"] = {
               ["class"] = "function";
               ["name"] = "file_methods:write";
               ["summary"] = "\
...
Reads a certain length of the file's bytes";
               ["param"] = {
                  [1] = "n";
                  ["n"] = "The length to read";
               };
            };
            ["readByte"] = {
               ["ret"] = "The data";
               ["class"] = "function";
               ["name"] = "file_methods:readByte";
               ["summary"] = "\
...
Writes a byte and advances the file position";
            ...
            ["tell"] = {
               ["ret"] = "The current file position";
               ["class"] = "function";
               ["name"] = "file_methods:tell";
               ["summary"] = "\
...
Sets the file position";
               ["param"] = {
                  [1] = "n";
                  ["n"] = "The position to set it to";
               };
            };
            ["writeDouble"] = {
               ["class"] = "function";
               ["name"] = "file_methods:writeDouble";
               ["summary"] = "\
...
Returns scale";
            ...
            ["translate"] = {
               ["class"] = "function";
               ["name"] = "vmatrix_methods:translate";
               ["summary"] = "\
...
Translate the matrix";
            ...
            ["getAngles"] = {
               ["ret"] = "Angles";
               ["class"] = "function";
               ["name"] = "vmatrix_methods:getAngles";
               ["summary"] = "\
Returns angles ";
               ["private"] = false;
               ["classlib"] = "VMatrix";
...
Returns angles";
            ...
            ["setTranslation"] = {
               ["class"] = "function";
               ["name"] = "vmatrix_methods:setTranslation";
               ["summary"] = "\
...
Sets the translation";
            ...
            ["getTranslation"] = {
               ["ret"] = "Translation";
               ["class"] = "function";
               ["name"] = "vmatrix_methods:getTranslation";
               ["summary"] = "\
Returns translation ";
               ["private"] = false;
               ["classlib"] = "VMatrix";
...
Returns translation";
            ...
            ["setAngles"] = {
               ["class"] = "function";
               ["name"] = "vmatrix_methods:setAngles";
               ["summary"] = "\
Sets the angles ";
               ["private"] = false;
               ["classlib"] = "VMatrix";
...
Sets the angles";
            ...
            ["getInverse"] = {
               ["ret"] = "inverted matrix";
               ["class"] = "function";
               ["name"] = "vmatrix_methods:getInverse";
               ["summary"] = "\
Inverts the matrix ";
               ["private"] = false;
               ["classlib"] = "VMatrix";
...
Inverts the matrix";
            ...
            ["getForward"] = {
               ["ret"] = "Translation";
               ["class"] = "function";
               ["name"] = "vmatrix_methods:getForward";
               ["summary"] = "\
...
Rotate the matrix";
            ...
            ["getInverseTR"] = {
               ["ret"] = "inverted matrix";
               ["class"] = "function";
               ["name"] = "vmatrix_methods:getInverseTR";
               ["summary"] = "\
...
Inverts the matrix efficiently for translations and rotations";
            ...
            ["scaleTranslation"] = {
               ["class"] = "function";
               ["name"] = "vmatrix_methods:scaleTranslation";
               ["summary"] = "\
...
Weapon type";
         ...
         ["methods"] = {
            ...
            [3] = "getActivity";
            [4] = "getHoldType";
            [5] = "getNextPrimaryFire";
            [6] = "getNextSecondaryFire";
            [7] = "getPrimaryAmmoType";
            [8] = "getPrintName";
            [9] = "getSecondaryAmmoType";
            [10] = "isCarriedByLocalPlayer";
            [11] = "isWeaponVisible";
            [12] = "lastShootTime";
            ["lastShootTime"] = {
               ["ret"] = "Time the weapon was last shot";
               ["class"] = "function";
               ["summary"] = "\
Returns the time since a weapon was last fired at a float variable ";
               ["classlib"] = "Weapon";
               ["name"] = "weapon_methods:lastShootTime";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns the time since a weapon was last fired at a float variable";
            ...
            ["getNextPrimaryFire"] = {
               ["ret"] = "The time, relative to CurTime";
               ["class"] = "function";
               ["summary"] = "\
Gets the next time the weapon can primary fire.";
               ["classlib"] = "Weapon";
               ["name"] = "weapon_methods:getNextPrimaryFire";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns Ammo in secondary clip";
            ...
            ["isCarriedByLocalPlayer"] = {
               ["ret"] = "whether or not the weapon is carried by the local player";
               ["class"] = "function";
               ["summary"] = "\
Returns if the weapon is carried by the local player.";
               ["name"] = "weapon_methods:isCarriedByLocalPlayer";
               ["classlib"] = "Weapon";
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns if the weapon is carried by the local player.";
            ...
            ["getSecondaryAmmoType"] = {
               ["ret"] = "Ammo number type";
               ["class"] = "function";
               ["summary"] = "\
Gets the secondary ammo type of the given weapon.";
               ["classlib"] = "Weapon";
               ["name"] = "weapon_methods:getSecondaryAmmoType";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the sequence enumeration number that the weapon is playing. Must be used on a view model.";
            ...
            ["getPrintName"] = {
               ["ret"] = "string Display name of weapon";
               ["class"] = "function";
               ["summary"] = "\
Gets Display name of weapon ";
               ["name"] = "weapon_methods:getPrintName";
               ["classlib"] = "Weapon";
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Gets the primary ammo type of the given weapon.";
               ["classlib"] = "Weapon";
               ["name"] = "weapon_methods:getPrimaryAmmoType";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Gets the next time the weapon can secondary fire.";
               ["classlib"] = "Weapon";
               ["name"] = "weapon_methods:getNextSecondaryFire";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Returns the hold type of the weapon.";
               ["classlib"] = "Weapon";
               ["name"] = "weapon_methods:getHoldType";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
Returns the hold type of the weapon.";
            ...
            ["isWeaponVisible"] = {
               ["ret"] = "Whether the weapon is visble or not";
               ["class"] = "function";
               ["summary"] = "\
Returns whether the weapon is visible ";
               ["classlib"] = "Weapon";
               ["name"] = "weapon_methods:isWeaponVisible";
               ["server"] = true;
               ["private"] = false;
               ["client"] = true;
               ["description"] = "\
...
Set the processor to only run on the client. Shared is default";
         ...
         ["name"] = "client";
         ["summary"] = "\
Set the processor to only run on the client.";
         ["usage"] = "\
--@client \
-- CODE";
         ["param"] = {};
...
Set the processor to only run on the server. Shared is default";
         ...
         ["name"] = "server";
         ["summary"] = "\
Set the processor to only run on the server.";
         ["usage"] = "\
--@server \
-- CODE";
         ["param"] = {};
