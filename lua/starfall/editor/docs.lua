...
Check if the given Entity or Vector is within this entity's PVS (Potentially Visible Set).";};["translateBoneToPhysBone"]={["class"]="function";["classlib"]="Entity";["description"]="\
