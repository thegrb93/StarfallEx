...
Returns the class of the entity ";};["getClipping"]={["class"]="function";["classlib"]="Entity";["client"]=true;["description"]="\
...
Gets the entity's eye position ";};["getFlexScale"]={["class"]="function";["classlib"]="Entity";["description"]="\
Gets the scale of the entity flexes";["fname"]="getFlexScale";["name"]="ents_methods:getFlexScale";["param"]={};["private"]=false;["realm"]="sh";["ret"]="The scale of the flexes";["summary"]="\
Gets the scale of the entity flexes ";};["getFlexWeight"]={["class"]="function";["classlib"]="Entity";["description"]="\
Gets the weight (value) of a flex.";["fname"]="getFlexWeight";["name"]="ents_methods:getFlexWeight";["param"]={[1]="flexid";["flexid"]="The id of the flex";};["private"]=false;["realm"]="sh";["ret"]="The weight of the flex";["summary"]="\
Gets the weight (value) of a flex.";};["getFlexes"]={["class"]="function";["classlib"]="Entity";["description"]="\
...
Mesh type";["fields"]={};["methods"]={[1]="destroy";[2]="draw";["destroy"]={["class"]="function";["classlib"]="Mesh";["client"]=true;["description"]="\
Frees the mesh from memory";["fname"]="destroy";["name"]="mesh_methods:destroy";["param"]={};["private"]=false;["realm"]="cl";["summary"]="\
Frees the mesh from memory ";};["draw"]={["class"]="function";["classlib"]="Mesh";["client"]=true;["description"]="\
...
PhysObj Type";["fields"]={};["methods"]={[1]="addAngleVelocity";[10]="getAABB";[11]="getAngleVelocity";[12]="getAngles";[13]="getDamping";[14]="getEntity";[15]="getInertia";[16]="getMass";[17]="getMassCenter";[18]="getMaterial";[19]="getMatrix";[2]="addGameFlags";[20]="getMesh";[21]="getMeshConvexes";[22]="getPos";[23]="getVelocity";[24]="getVelocityAtPoint";[25]="hasGameFlags";[26]="isAsleep";[27]="isDragEnabled";[28]="isValid";[29]="localToWorld";[3]="applyForceCenter";[30]="localToWorldVector";[31]="setAngleDragCoefficient";[32]="setAngleVelocity";[33]="setAngles";[34]="setBuoyancyRatio";[35]="setDamping";[36]="setDragCoefficient";[37]="setInertia";[38]="setMass";[39]="setMaterial";[4]="applyForceOffset";[40]="setPos";[41]="setVelocity";[42]="sleep";[43]="wake";[44]="worldToLocal";[45]="worldToLocalVector";[5]="applyTorque";[6]="clearGameFlags";[7]="enableDrag";[8]="enableGravity";[9]="enableMotion";["addAngleVelocity"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
...
Sets the bone movement state ";};["getAABB"]={["class"]="function";["classlib"]="PhysObj";["client"]=true;["description"]="\
Gets the axis aligned bounding box of the physics object";["fname"]="getAABB";["name"]="physobj_methods:getAABB";["param"]={};["private"]=false;["realm"]="sh";["ret"]={[1]="The mins of the AABB";[2]="The maxs of the AABB";};["server"]=true;["summary"]="\
Gets the axis aligned bounding box of the physics object ";};["getAngleVelocity"]={["class"]="function";["classlib"]="PhysObj";["client"]=true;["description"]="\
...
Gets the angles of the physics object ";};["getDamping"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
Returns Movement damping of the bone.";["fname"]="getDamping";["name"]="physobj_methods:getDamping";["param"]={};["private"]=false;["realm"]="sh";["ret"]={[1]="Linear damping";[2]="Angular damping";};["summary"]="\
Returns Movement damping of the bone.";};["getEntity"]={["class"]="function";["classlib"]="PhysObj";["client"]=true;["description"]="\
...
Returns whether the game flags of the physics object are set.";};["isAsleep"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
Returns whether the physobj is asleep";["fname"]="isAsleep";["name"]="physobj_methods:isAsleep";["param"]={};["private"]=false;["realm"]="sv";["ret"]="boolean if the physobj is asleep";["server"]=true;["summary"]="\
Returns whether the physobj is asleep ";};["isDragEnabled"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
Check if bone is affected by air resistance";["fname"]="isDragEnabled";["name"]="physobj_methods:isDragEnabled";["param"]={};["private"]=false;["realm"]="sh";["ret"]="boolean If bone is affected by drag";["summary"]="\
Check if bone is affected by air resistance ";};["isValid"]={["class"]="function";["classlib"]="PhysObj";["client"]=true;["description"]="\
...
Returns a normal vector in the reference frame of the world from the local frame of the physicsobject ";};["setAngleDragCoefficient"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
Sets coefficient of air resistance affecting the bone when rotating. Air resistance depends on the cross-section of the object.";["fname"]="setAngleDragCoefficient";["name"]="physobj_methods:setAngleDragCoefficient";["param"]={[1]="coeff";["coeff"]="Number how much drag affects the bone when rotating";};["private"]=false;["realm"]="sh";["summary"]="\
Sets coefficient of air resistance affecting the bone when rotating.";};["setAngleVelocity"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
...
Sets the angular velocity of an object ";};["setAngles"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
Sets the angles of the physics object. Will cause interpolation of the entity in clientside, use entity.setAngles to avoid this.";["fname"]="setAngles";["name"]="physobj_methods:setAngles";["param"]={[1]="ang";["ang"]="The angle to set it to";};["private"]=false;["realm"]="sv";["server"]=true;["summary"]="\
Sets the angles of the physics object.";};["setBuoyancyRatio"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
Sets the buoyancy ratio of a physobject";["fname"]="setBuoyancyRatio";["name"]="physobj_methods:setBuoyancyRatio";["param"]={[1]="ratio";["ratio"]="The buoyancy ratio to use";};["private"]=false;["realm"]="sv";["server"]=true;["summary"]="\
Sets the buoyancy ratio of a physobject ";};["setDamping"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
Sets the movement damping of the bone. Unlike air drag, it doesn't take into account the cross-section of the object.";["fname"]="setDamping";["name"]="physobj_methods:setDamping";["param"]={[1]="linear";[2]="angular";["angular"]="Number of the angular damping";["linear"]="Number of the linear damping";};["private"]=false;["realm"]="sh";["summary"]="\
Sets the movement damping of the bone.";};["setDragCoefficient"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
Sets coefficient of air resistance affecting the bone. Air resistance depends on the cross-section of the object.";["fname"]="setDragCoefficient";["name"]="physobj_methods:setDragCoefficient";["param"]={[1]="coeff";["coeff"]="Number how much drag affects the bone";};["private"]=false;["realm"]="sh";["summary"]="\
Sets coefficient of air resistance affecting the bone.";};["setInertia"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
...
Sets the velocity of the physics object ";};["sleep"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
Makes a physobj go to sleep. (like it's frozen but interacting wakes it back up)";["fname"]="sleep";["name"]="physobj_methods:sleep";["param"]={};["private"]=false;["realm"]="sv";["server"]=true;["summary"]="\
Makes a physobj go to sleep.";};["wake"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
...
VMatrix type";["fields"]={};["methods"]={[1]="clone";[10]="getTranslation";[11]="getTransposed";[12]="getUp";[13]="invert";[14]="invertTR";[15]="isIdentity";[16]="isRotationMatrix";[17]="rotate";[18]="scale";[19]="scaleTranslation";[2]="getAngles";[20]="set";[21]="setAngles";[22]="setAxisAngle";[23]="setField";[24]="setForward";[25]="setIdentity";[26]="setRight";[27]="setScale";[28]="setTranslation";[29]="setUp";[3]="getAxisAngle";[30]="toTable";[31]="translate";[32]="transpose";[4]="getField";[5]="getForward";[6]="getInverse";[7]="getInverseTR";[8]="getRight";[9]="getScale";["clone"]={["class"]="function";["classlib"]="VMatrix";["description"]="\
...
Sets the angles ";};["setAxisAngle"]={["class"]="function";["classlib"]="VMatrix";["description"]="\
Sets the rotation or the matrix to the rotation by an axis and angle";["fname"]="setAxisAngle";["name"]="vmatrix_methods:setAxisAngle";["param"]={[1]="axis";[2]="ang";[3]="angle";["angle"]="The angle of rotation in radians";["axis"]="The normalized axis of rotation";};["private"]=false;["realm"]="sh";["summary"]="\
Sets the rotation or the matrix to the rotation by an axis and angle ";};["setField"]={["class"]="function";["classlib"]="VMatrix";["description"]="\
...
Vector type";["fields"]={};["methods"]={[1]="add";[10]="getDistanceSqr";[11]="getLength";[12]="getLength2D";[13]="getLength2DSqr";[14]="getLengthSqr";[15]="getNormalized";[16]="getRotated";[17]="isEqualTol";[18]="isInWorld";[19]="isZero";[2]="clone";[20]="mul";[21]="normalize";[22]="rotate";[23]="rotateAroundAxis";[24]="set";[25]="setX";[26]="setY";[27]="setZ";[28]="setZero";[29]="sub";[3]="cross";[30]="toScreen";[31]="vdiv";[32]="vmul";[33]="withinAABox";[4]="div";[5]="dot";[6]="getAngle";[7]="getAngleEx";[8]="getBasis";[9]="getDistance";["add"]={["class"]="function";["classlib"]="Vector";["description"]="\
...
Returns the vector's euler angle with respect to the other vector as if it were the new vertical axis.";};["getBasis"]={["class"]="function";["classlib"]="Vector";["description"]="\
Returns an arbitrary orthogonal basis from the direction of the vector. Input must be a normalized vector";["fname"]="getBasis";["name"]="vec_methods:getBasis";["param"]={};["private"]=false;["realm"]="sh";["ret"]={[1]="Basis 1";[2]="Basis 2";};["summary"]="\
Returns an arbitrary orthogonal basis from the direction of the vector.";};["getDistance"]={["class"]="function";["classlib"]="Vector";["description"]="\
...
Returns a new vector with the same direction by length of 1.";};["getRotated"]={["class"]="function";["classlib"]="Vector";["description"]="\
Returns Rotated vector by Angle b";["fname"]="getRotated";["name"]="vec_methods:getRotated";["param"]={[1]="b";["b"]="Angle to rotate by.";};["private"]=false;["realm"]="sh";["ret"]="Rotated Vector";["summary"]="\
Returns Rotated vector by Angle b ";};["isEqualTol"]={["class"]="function";["classlib"]="Vector";["description"]="\
...
Called when a trigger on the controller has moved.";};};["libraries"]={[1]="bass";[10]="game";[11]="holograms";[12]="hook";[13]="http";[14]="input";[15]="joystick";[16]="json";[17]="light";[18]="material";[19]="mesh";[2]="bit";[20]="net";[21]="notification";[22]="particle";[23]="physenv";[24]="prop";[25]="quaternion";[26]="render";[27]="socket";[28]="sounds";[29]="sql";[3]="builtin";[30]="team";[31]="timer";[32]="trace";[33]="von";[34]="wire";[35]="xinput";[4]="constraint";[5]="coroutine";[6]="effect";[7]="fastlz";[8]="file";[9]="find";["bass"]={["class"]="library";["client"]=true;["description"]="\
...
Sets a CPU soft quota which will trigger a catchable error if the cpu goes over a certain amount.";};["setTypeMethod"]={["class"]="function";["description"]="\
Set's metamethod on SF type";["fname"]="setTypeMethod";["library"]="builtin";["name"]="SF.DefaultEnvironment.setTypeMethod";["param"]={[1]="sfType";[2]="methodName";[3]="method";["method"]="Method to set";["methodName"]="Name of method";["sfType"]="Name of SF type";};["private"]=false;["realm"]="sh";["summary"]="\
Set's metamethod on SF type ";};["setUserdata"]={["class"]="function";["description"]="\
...
File functions. Allows modification of files.";["fields"]={};["functions"]={[1]="append";[2]="createDir";[3]="delete";[4]="exists";[5]="find";[6]="findInGame";[7]="open";[8]="read";[9]="write";["append"]={["class"]="function";["description"]="\
...
Enumerates a directory ";};["findInGame"]={["class"]="function";["description"]="\
Enumerates a directory relative to gmod";["fname"]="findInGame";["library"]="file";["name"]="file_library.findInGame";["param"]={[1]="path";[2]="sorting";["path"]="The folder to enumerate, relative to garrysmod.";["sorting"]="Optional sorting arguement. Either nameasc, namedesc, dateasc, datedesc";};["private"]=false;["realm"]="cl";["ret"]={[1]="Table of file names";[2]="Table of directory names";};["summary"]="\
Enumerates a directory relative to gmod ";};["open"]={["class"]="function";["description"]="\
...
Find library. Finds entities in various shapes.";["fields"]={};["functions"]={[1]="all";[10]="inRay";[11]="inSphere";[12]="sortByClosest";[2]="allPlayers";[3]="byClass";[4]="byModel";[5]="byName";[6]="closest";[7]="inBox";[8]="inCone";[9]="inPVS";["all"]={["class"]="function";["description"]="\
...
Finds entities by model ";};["byName"]={["class"]="function";["description"]="\
Finds entities by their targetname";["fname"]="byName";["library"]="find";["name"]="find_library.byName";["param"]={[1]="name";[2]="filter";["filter"]="Optional function to filter results";["name"]="The targetname";};["private"]=false;["realm"]="sh";["ret"]="An array of found entities";["summary"]="\
Finds entities by their targetname ";};["closest"]={["class"]="function";["description"]="\
...
Finds entities that are in the PVS (Potentially Visible Set).";};["inRay"]={["class"]="function";["description"]="\
Finds entities in a ray";["fname"]="inRay";["library"]="find";["name"]="find_library.inRay";["param"]={[1]="startpos";[2]="endpos";[3]="mins";[4]="maxs";[5]="filter";["endpos"]="The ray end";["filter"]="Optional function to filter results";["maxs"]="If not null, will define a upper bound of the ray's hull";["mins"]="If not null, will define a lower bound of the ray's hull";["startpos"]="The ray start";};["private"]=false;["realm"]="sh";["ret"]="An array of found entities";["summary"]="\
Finds entities in a ray ";};["inSphere"]={["class"]="function";["description"]="\
...
Runs a new http POST request ";};["urlEncode"]={["class"]="function";["description"]="\
Encodes illegal url characters to be legal";["fname"]="urlEncode";["library"]="http";["name"]="http_library.urlEncode";["param"]={[1]="data";["data"]="The data to convert";};["private"]=false;["realm"]="sh";["ret"]="The converted data";["summary"]="\
Encodes illegal url characters to be legal ";};};["libtbl"]="http_library";["name"]="http";["server"]=true;["summary"]="\
Http library.";["tables"]={};};["input"]={["class"]="library";["client"]=true;["description"]="\
Input library.";["fields"]={};["functions"]={[1]="canLockControls";[10]="lockControls";[11]="lookupBinding";[12]="screenToVector";[13]="selectWeapon";[2]="enableCursor";[3]="getCursorPos";[4]="getCursorVisible";[5]="getKeyName";[6]="isControlDown";[7]="isControlLocked";[8]="isKeyDown";[9]="isShiftDown";["canLockControls"]={["class"]="function";["client"]=true;["description"]="\
Gets whether the player's control can be locked";["fname"]="canLockControls";["library"]="input";["name"]="input_methods.canLockControls";["param"]={};["private"]=false;["realm"]="cl";["ret"]="Whether the player's control can be locked";["summary"]="\
Gets whether the player's control can be locked ";};["enableCursor"]={["class"]="function";["client"]=true;["description"]="\
...
Gets whether the control key is down ";};["isControlLocked"]={["class"]="function";["client"]=true;["description"]="\
Gets whether the player's control is currenty locked";["fname"]="isControlLocked";["library"]="input";["name"]="input_methods.isControlLocked";["param"]={};["private"]=false;["realm"]="cl";["ret"]="Whether the player's control is locked";["summary"]="\
Gets whether the player's control is currenty locked ";};["isKeyDown"]={["class"]="function";["client"]=true;["description"]="\
...
Gets whether the shift key is down ";};["lockControls"]={["class"]="function";["client"]=true;["description"]="\
Locks game controls for typing purposes. Alt will unlock the controls. Has a 10 second cooldown.";["fname"]="lockControls";["library"]="input";["name"]="input_methods.lockControls";["param"]={[1]="enabled";["enabled"]="Whether to lock or unlock the controls";};["private"]=false;["realm"]="cl";["summary"]="\
Locks game controls for typing purposes.";};["lookupBinding"]={["class"]="function";["client"]=true;["description"]="\
...
Translates position on player's screen to aim vector ";};["selectWeapon"]={["class"]="function";["client"]=true;["description"]="\
Makes the local player select a weapon";["fname"]="selectWeapon";["library"]="input";["name"]="input_methods.selectWeapon";["param"]={[1]="weapon";["weapon"]="The weapon entity to select";};["private"]=false;["realm"]="cl";["summary"]="\
Makes the local player select a weapon ";};};["libtbl"]="input_methods";["name"]="input";["summary"]="\
...
Creates a dynamic light (make sure to draw it)";["fname"]="create";["library"]="light";["name"]="light_library.create";["param"]={[1]="pos";[2]="size";[3]="brightness";[4]="color";["brightness"]="The brightness of the light";["color"]="The color of the light";["pos"]="The position of the light";["size"]="The size of the light. Must be lower than sf_light_maxsize";};["private"]=false;["realm"]="cl";["ret"]="Dynamic light";["summary"]="\
Creates a dynamic light (make sure to draw it) ";};};["libtbl"]="light_library";["name"]="light";["summary"]="\
...
Mesh library.";["fields"]={};["functions"]={[1]="createFromObj";[2]="createFromTable";[3]="getModelMeshes";[4]="parseObj";[5]="trianglesLeft";[6]="trianglesLeftRender";["createFromObj"]={["class"]="function";["client"]=true;["description"]="\
Creates a mesh from an obj file. Only supports triangular meshes with normals and texture coordinates.";["fname"]="createFromObj";["library"]="mesh";["name"]="mesh_library.createFromObj";["param"]={[1]="obj";[2]="threaded";[3]="triangulate";["obj"]="The obj file data";["threaded"]="Optional bool, use threading object that can be used to load the mesh over time to prevent hitting quota limit";["triangulate"]="Whether to triangulate faces. (Consumes more CPU)";};["private"]=false;["realm"]="cl";["ret"]="Mesh object";["summary"]="\
Creates a mesh from an obj file.";};["createFromTable"]={["class"]="function";["client"]=true;["description"]="\
Creates a mesh from vertex data.";["fname"]="createFromTable";["library"]="mesh";["name"]="mesh_library.createFromTable";["param"]={[1]="verteces";[2]="threaded";["threaded"]="Optional bool, use threading object that can be used to load the mesh over time to prevent hitting quota limit";["verteces"]="Table containing vertex data. http://wiki.garrysmod.com/page/Structures/MeshVertex";};["private"]=false;["realm"]="cl";["ret"]="Mesh object";["summary"]="\
Creates a mesh from vertex data.";};["getModelMeshes"]={["class"]="function";["client"]=true;["description"]="\
Returns a table of visual meshes of given model or nil if the model is invalid";["fname"]="getModelMeshes";["library"]="mesh";["name"]="mesh_library.getModelMeshes";["param"]={[1]="model";[2]="lod";[3]="bodygroupMask";["bodygroupMask"]="The bodygroupMask of the model to use.";["lod"]="The lod of the model to use.";["model"]="The full path to a model to get the visual meshes of.";};["private"]=false;["realm"]="cl";["ret"]="A table of tables with the following format:<br><br>string material - The material of the specific mesh<br>table triangles - A table of MeshVertex structures ready to be fed into IMesh:BuildFromTriangles<br>table verticies - A table of MeshVertex structures representing all the vertexes of the mesh. This table is used internally to generate the \"triangles\" table.<br>Each MeshVertex structure returned also has an extra table of tables field called \"weights\" with the following data:<br><br>number boneID - The bone this vertex is attached to<br>number weight - How \"strong\" this vertex is attached to the bone. A vertex can be attached to multiple bones at once.";["summary"]="\
Returns a table of visual meshes of given model or nil if the model is invalid ";};["parseObj"]={["class"]="function";["description"]="\
Parses obj data into a table of vertices, normals, texture coordinates, colors, and tangents";["fname"]="parseObj";["library"]="mesh";["name"]="mesh_library.parseObj";["param"]={[1]="obj";[2]="threaded";[3]="triangulate";["obj"]="The obj data";["threaded"]="Optional bool, use threading object that can be used to load the mesh over time to prevent hitting quota limit";["triangulate"]="Whether to triangulate the faces";};["private"]=false;["realm"]="sh";["ret"]={[1]="The table of vertices that can be passed to mesh.buildFromTriangles";[2]="The table of obj data. table.positions can be given to prop.createCustom";};["summary"]="\
Parses obj data into a table of vertices, normals, texture coordinates, colors, and tangents ";};["trianglesLeft"]={["class"]="function";["client"]=true;["description"]="\
...
Returns how many triangles can be created ";};["trianglesLeftRender"]={["class"]="function";["client"]=true;["description"]="\
Returns how many triangles can be rendered";["fname"]="trianglesLeftRender";["library"]="mesh";["name"]="mesh_library.trianglesLeftRender";["param"]={};["private"]=false;["realm"]="cl";["ret"]="Number of triangles that can be rendered";["summary"]="\
...
Net message library. Used for sending data from the server to the client and back";["fields"]={};["functions"]={[1]="cancelStream";[10]="readData";[11]="readDouble";[12]="readEntity";[13]="readFloat";[14]="readInt";[15]="readMatrix";[16]="readStream";[17]="readString";[18]="readTable";[19]="readType";[2]="getBitsLeft";[20]="readUInt";[21]="readVector";[22]="receive";[23]="send";[24]="start";[25]="writeAngle";[26]="writeBit";[27]="writeBool";[28]="writeColor";[29]="writeData";[3]="getBytesLeft";[30]="writeDouble";[31]="writeEntity";[32]="writeFloat";[33]="writeInt";[34]="writeMatrix";[35]="writeStream";[36]="writeString";[37]="writeTable";[38]="writeType";[39]="writeUInt";[4]="getStreamProgress";[40]="writeVector";[5]="isStreaming";[6]="readAngle";[7]="readBit";[8]="readBool";[9]="readColor";["cancelStream"]={["class"]="function";["client"]=true;["description"]="\
...
Reads a bit from the net message ";};["readBool"]={["class"]="function";["client"]=true;["description"]="\
Reads a boolean from the net message";["fname"]="readBool";["library"]="net";["name"]="net_library.readBool";["param"]={};["private"]=false;["realm"]="sh";["ret"]="The boolean that was read.";["server"]=true;["summary"]="\
Reads a boolean from the net message ";};["readColor"]={["class"]="function";["client"]=true;["description"]="\
...
Writes a bit to the net message";["fname"]="writeBit";["library"]="net";["name"]="net_library.writeBit";["param"]={[1]="t";["t"]="The bit to be written. (0 for false, 1 (or anything) for true)";};["private"]=false;["realm"]="sh";["server"]=true;["summary"]="\
Writes a bit to the net message ";};["writeBool"]={["class"]="function";["client"]=true;["description"]="\
Writes a bool to the net message";["fname"]="writeBool";["library"]="net";["name"]="net_library.writeBool";["param"]={[1]="t";["t"]="The bit to be written. (boolean)";};["private"]=false;["realm"]="sh";["server"]=true;["summary"]="\
Writes a bool to the net message ";};["writeColor"]={["class"]="function";["client"]=true;["description"]="\
...
Net message library.";["tables"]={};};["notification"]={["class"]="library";["client"]=true;["description"]="\
Notification library. Allows the user to display hints on the bottom right of their screen";["fields"]={};["functions"]={[1]="addLegacy";[2]="addProgress";[3]="kill";["addLegacy"]={["class"]="function";["description"]="\
Displays a standard notification.";["fname"]="addLegacy";["library"]="notification";["name"]="notification_library.addLegacy";["param"]={[1]="text";[2]="type";[3]="length";["length"]="Time in seconds to display the notification (Max length of 30)";["text"]="The text to display";["type"]="Determines the notification method. \
NOTIFY.GENERIC \
NOTIFY.ERROR \
NOTIFY.UNDO \
NOTIFY.HINT \
NOTIFY.CLEANUP";};["private"]=false;["realm"]="cl";["summary"]="\
Displays a standard notification.";};["addProgress"]={["class"]="function";["description"]="\
Displays a notification with an animated progress bar, will persist unless killed or chip is removed.";["fname"]="addProgress";["library"]="notification";["name"]="notification_library.addProgress";["param"]={[1]="id";[2]="text";["id"]="String index of the notification";["text"]="The text to display";};["private"]=false;["realm"]="cl";["summary"]="\
Displays a notification with an animated progress bar, will persist unless killed or chip is removed.";};["kill"]={["class"]="function";["description"]="\
Removes the notification with the given index after 0.8 seconds";["fname"]="kill";["library"]="notification";["name"]="notification_library.kill";["param"]={[1]="id";["id"]="String index of the notification to kill";};["private"]=false;["realm"]="cl";["summary"]="\
Removes the notification with the given index after 0.8 seconds ";};};["libtbl"]="notification_library";["name"]="notification";["summary"]="\
Notification library.";["tables"]={};};["particle"]={["class"]="library";["client"]=true;["description"]="\
...
thrown. +x is right, +y is down";["entity"]="starfall_screen";["field"]={[1]="TEXT_ALIGN_LEFT";[2]="TEXT_ALIGN_CENTER";[3]="TEXT_ALIGN_RIGHT";[4]="TEXT_ALIGN_TOP";[5]="TEXT_ALIGN_BOTTOM";["TEXT_ALIGN_BOTTOM"]="";["TEXT_ALIGN_CENTER"]="";["TEXT_ALIGN_LEFT"]="";["TEXT_ALIGN_RIGHT"]="";["TEXT_ALIGN_TOP"]="";};["fields"]={};["functions"]={[1]="capturePixels";[10]="cursorPos";[11]="destroyRenderTarget";[12]="destroyTexture";[13]="disableScissorRect";[14]="draw3DBeam";[15]="draw3DBox";[16]="draw3DLine";[17]="draw3DQuad";[18]="draw3DQuadUV";[19]="draw3DSphere";[2]="clear";[20]="draw3DSprite";[21]="draw3DWireframeBox";[22]="draw3DWireframeSphere";[23]="drawBlurEffect";[24]="drawCircle";[25]="drawLine";[26]="drawPoly";[27]="drawRect";[28]="drawRectFast";[29]="drawRectOutline";[3]="clearBuffersObeyStencil";[30]="drawRoundedBox";[31]="drawRoundedBoxEx";[32]="drawSimpleText";[33]="drawText";[34]="drawTexturedRect";[35]="drawTexturedRectFast";[36]="drawTexturedRectRotated";[37]="drawTexturedRectRotatedFast";[38]="drawTexturedRectUV";[39]="drawTexturedRectUVFast";[4]="clearDepth";[40]="enableClipping";[41]="enableDepth";[42]="enableScissorRect";[43]="getDefaultFont";[44]="getGameResolution";[45]="getResolution";[46]="getScreenEntity";[47]="getScreenInfo";[48]="getTextSize";[49]="isHUDActive";[5]="clearStencil";[50]="isInRenderView";[51]="overrideBlend";[52]="parseMarkup";[53]="popCustomClipPlane";[54]="popMatrix";[55]="popViewMatrix";[56]="pushCustomClipPlane";[57]="pushMatrix";[58]="pushViewMatrix";[59]="readPixel";[6]="clearStencilBufferRectangle";[60]="renderTargetExists";[61]="renderView";[62]="renderViewsLeft";[63]="selectRenderTarget";[64]="setBackgroundColor";[65]="setColor";[66]="setCullMode";[67]="setFilterMag";[68]="setFilterMin";[69]="setFont";[7]="createFont";[70]="setHUDActive";[71]="setLightingMode";[72]="setMaterial";[73]="setMaterialEffectAdd";[74]="setMaterialEffectBloom";[75]="setMaterialEffectColorModify";[76]="setMaterialEffectDownsample";[77]="setMaterialEffectSub";[78]="setRGBA";[79]="setRenderTargetTexture";[8]="createMaterial";[80]="setStencilCompareFunction";[81]="setStencilEnable";[82]="setStencilFailOperation";[83]="setStencilPassOperation";[84]="setStencilReferenceValue";[85]="setStencilTestMask";[86]="setStencilWriteMask";[87]="setStencilZFailOperation";[88]="setTextureFromScreen";[89]="traceSurfaceColor";[9]="createRenderTarget";["capturePixels"]={["class"]="function";["description"]="\
...
- DejaVu Sans Mono \
- Lucida Console \
- Times New Roman";};["createMaterial"]={["class"]="function";["description"]="\
...
NOTE: This no longer supports material names. Use texture names instead (Textures are .vtf, material are .vmt)";["fname"]="createMaterial";["library"]="render";["name"]="render_library.createMaterial";["param"]={[1]="tx";[2]="cb";[3]="done";["cb"]="An optional callback called when loading is done. Passes nil if it fails or Passes the material, url, width, height, and layout function which can be called with x, y, w, h to reposition the image in the texture.";["done"]="An optional callback called when the image is done loading. Passes the material, url";["tx"]="Texture file path, a http url, or image data: https://en.wikipedia.org/wiki/Data_URI_scheme";};["private"]=false;["realm"]="cl";["ret"]="The material. Use with render.setMaterial to draw with it.";["summary"]="\
Looks up a texture by file name and creates an UnlitGeneric material with it.";};["createRenderTarget"]={["class"]="function";["description"]="\
...
Draws a wireframe sphere ";};["drawBlurEffect"]={["class"]="function";["description"]="\
Applies a blur effect to the active rendertarget. This must be used with a rendertarget created beforehand.";["fname"]="drawBlurEffect";["library"]="render";["name"]="render_library.drawBlurEffect";["param"]={[1]="blurx";[2]="blury";[3]="passes";["blurx"]="The amount of horizontal blur to apply.";["blury"]="The amount of vertical blur to apply.";["passes"]="The number of times the blur effect is applied.";};["private"]=false;["realm"]="cl";["summary"]="\
Applies a blur effect to the active rendertarget.";};["drawCircle"]={["class"]="function";["description"]="\
...
Gets the size of the specified text.";};["isHUDActive"]={["class"]="function";["description"]="\
...
Reads the color of the specified pixel.";};["renderTargetExists"]={["class"]="function";["description"]="\
Check if the specified render target exists.";["fname"]="renderTargetExists";["library"]="render";["name"]="render_library.renderTargetExists";["param"]={[1]="name";["name"]="The name of the render target";};["private"]=false;["realm"]="cl";["summary"]="\
Check if the specified render target exists.";};["renderView"]={["class"]="function";["description"]="\
...
- DermaDefault \
- DermaDefaultBold \
- DermaLarge";};["setHUDActive"]={["class"]="function";["description"]="\
Sets the current instance to allow HUD drawing. Only works for owner of the chip";["fname"]="setHUDActive";["library"]="render";["name"]="render_library.setHUDActive";["param"]={[1]="active";["active"]="Whether hud hooks should be active. true to force on, false to force off, nil to restore default.";};["private"]=false;["realm"]="cl";["summary"]="\
Sets the current instance to allow HUD drawing.";};["setLightingMode"]={["class"]="function";["description"]="\
Sets the lighting mode";["fname"]="setLightingMode";["library"]="render";["name"]="render_library.setLightingMode";["param"]={[1]="mode";["mode"]="The lighting mode. 0 - Default, 1 - Fullbright, 2 - Increased Fullbright";};["private"]=false;["realm"]="cl";["summary"]="\
Sets the lighting mode ";};["setMaterial"]={["class"]="function";["description"]="\
...
Sets the current render material ";};["setMaterialEffectAdd"]={["class"]="function";["description"]="\
Sets the current render material to the given material or the rendertarget, applying an additive shader when drawn.";["fname"]="setMaterialEffectAdd";["library"]="render";["name"]="render_library.setMaterialEffectAdd";["param"]={[1]="mat";["mat"]="The material object to use the texture of, or the name of a rendertarget to use instead.";};["private"]=false;["realm"]="cl";["summary"]="\
Sets the current render material to the given material or the rendertarget, applying an additive shader when drawn.";};["setMaterialEffectBloom"]={["class"]="function";["description"]="\
Sets the current render material to the given material or the rendertarget, applying a bloom shader to the texture.";["fname"]="setMaterialEffectBloom";["library"]="render";["name"]="render_library.setMaterialEffectBloom";["param"]={[1]="mat";[2]="levelr";[3]="levelg";[4]="levelb";[5]="colormul";["colormul"]="Multiplier for all three colors. 1 = unchanged";["levelb"]="Multiplier for all blue pixels. 1 = unchanged";["levelg"]="Multiplier for all green pixels. 1 = unchanged";["levelr"]="Multiplier for all red pixels. 1 = unchanged";["mat"]="The material object to use the texture of, or the name of a rendertarget to use instead.";};["private"]=false;["realm"]="cl";["summary"]="\
Sets the current render material to the given material or the rendertarget, applying a bloom shader to the texture.";};["setMaterialEffectColorModify"]={["class"]="function";["description"]="\
Sets the current render material to the given material or the rendertarget, applying a color modification shader to the texture. Alias: render.setMaterialEffectColourModify";["fname"]="setMaterialEffectColorModify";["library"]="render";["name"]="render_library.setMaterialEffectColorModify";["param"]={[1]="mat";[2]="cmStructure";["cmStructure"]="A table where each key must be of \"addr\", \"addg\", \"addb\", \"brightness\", \"color\" or \"colour\", \"contrast\", \"mulr\", \"mulg\", and \"mulb\". All keys are optional.";["mat"]="The material object to use the texture of, or the name of a rendertarget to use instead.";};["private"]=false;["realm"]="cl";["summary"]="\
Sets the current render material to the given material or the rendertarget, applying a color modification shader to the texture.";};["setMaterialEffectDownsample"]={["class"]="function";["description"]="\
Sets the current render material to the given material or the rendertarget, darkening the texture, and scaling up color values.";["fname"]="setMaterialEffectDownsample";["library"]="render";["name"]="render_library.setMaterialEffectDownsample";["param"]={[1]="mat";[2]="darken";[3]="multiply";["darken"]="The amount to darken the texture by. -1 to 1 inclusive.";["mat"]="The material object to use the texture of, or the name of a rendertarget to use instead.";["multiply"]="The amount to multiply the pixel colors by.";};["private"]=false;["realm"]="cl";["summary"]="\
Sets the current render material to the given material or the rendertarget, darkening the texture, and scaling up color values.";};["setMaterialEffectSub"]={["class"]="function";["description"]="\
Sets the current render material to the given material or the rendertarget, applying a subtractive shader when drawn.";["fname"]="setMaterialEffectSub";["library"]="render";["name"]="render_library.setMaterialEffectSub";["param"]={[1]="mat";["mat"]="The material object to use the texture of, or the name of a rendertarget to use instead.";};["private"]=false;["realm"]="cl";["summary"]="\
Sets the current render material to the given material or the rendertarget, applying a subtractive shader when drawn.";};["setRGBA"]={["class"]="function";["description"]="\
...
Sets the operation to be performed on the stencil buffer values if the stencil test is passed but the depth buffer test fails.";};["setTextureFromScreen"]={["class"]="function";["description"]="\
...
Render library.";["tables"]={};};["socket"]={["class"]="library";["client"]=true;["description"]="\
...
Each line in the whitelist will allow luasocket to access the specified domain and port. They are formatted as 'domain:port' e.g. 'garrysmod.com:80', '*.com:80' '95.123.12.22:27015'";["fields"]={};["functions"]={};["libtbl"]="socket_library";["name"]="socket";["summary"]="\
Socket library.";["tables"]={};};["sounds"]={["class"]="library";["client"]=true;["description"]="\
...
Returns amount of repetitions/executions left before the timer destroys itself.";["fname"]="repsleft";["library"]="timer";["name"]="timer_library.repsleft";["param"]={[1]="name";["name"]="The timer name";};["private"]=false;["realm"]="sh";["ret"]="The amount of executions left. Nil if timer doesnt exist";["summary"]="\
