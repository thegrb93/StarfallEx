...
Same as Lua's ipairs ";["library"] = "builtin";["param"] = {[1] = "tbl";["tbl"] = "Table to iterate over";};};["player"] = {["ret"] = "Returns player with given UserID or if none specified then returns either the owner (server) or the local player (client)";["description"] = "\
...
Copies the values from the second vector to the first vector. Self-Modifies.";["param"] = {[1] = "v";["v"] = "Second Vector";};};["toScreen"] = {["ret"] = "A table {x=screenx,y=screeny,visible=visible}";["class"] = "function";["realm"] = "sh";["name"] = "vec_methods:toScreen";["summary"] = "\
Translates the vectors position into 2D user screen coordinates.";["private"] = false;["classlib"] = "Vector";["description"] = "\
Translates the vectors position into 2D user screen coordinates.";["param"] = {};};["setY"] = {["ret"] = "The modified vector";["class"] = "function";["realm"] = "sh";["name"] = "vec_methods:setY";["summary"] = "\
...
Checks if an entity is a player.";["param"] = {};};["setInertia"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:setInertia";["summary"] = "\
Sets the entity's inertia ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Sets the entity's inertia";["param"] = {[1] = "vec";["vec"] = "Inertia tensor";};};["linkComponent"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:linkComponent";["summary"] = "\
