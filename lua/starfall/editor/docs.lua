...
Throws an exception ";["private"] = false;["library"] = "builtin";["param"] = {[1] = "msg";[2] = "level";[3] = "uncatchable";["level"] = "Which level in the stacktrace to blame. Defaults to 1";["uncatchable"] = "Makes this exception uncatchable";["msg"] = "Message string";};};["crc"] = {["ret"] = "The unsigned 32 bit checksum as a string";["description"] = "\
...
Generates the CRC checksum of the specified string.";["library"] = "builtin";["param"] = {[1] = "stringToHash";["stringToHash"] = "The string to calculate the checksum of";};};["quotaMax"] = {["ret"] = "Max SysTime allowed to take for execution of the chip in a Think.";["class"] = "function";["description"] = "\
...
Sets, changes or removes a table's metatable.";["library"] = "builtin";["param"] = {[1] = "tbl";[2] = "meta";["tbl"] = "The table to set the metatable of";["meta"] = "The metatable to use";};};["getUserdata"] = {["ret"] = "String data";["description"] = "\
Gets the chip's userdata that the duplicator tool loads";["class"] = "function";["realm"] = "sh";["fname"] = "getUserdata";["summary"] = "\
Gets the chip's userdata that the duplicator tool loads ";["name"] = "SF.DefaultEnvironment.getUserdata";["library"] = "builtin";["private"] = false;["server"] = true;["param"] = {};};["rawset"] = {["class"] = "function";["description"] = "\
...
Attempts to convert the value to a number.";["library"] = "builtin";["param"] = {[1] = "obj";["obj"] = "";};};["entity"] = {["ret"] = "entity";["description"] = "\
...
Lua's pcall with SF throw implementation \
Calls a function and catches an error that can be thrown while the execution of the call.";["private"] = false;["library"] = "builtin";["param"] = {[1] = "func";[2] = "...";[3] = "arguments";["arguments"] = "Arguments to call the function with.";["func"] = "Function to be executed and of which the errors should be caught of";};};["eyeVector"] = {["ret"] = "The local player's camera forward vector";["class"] = "function";["description"] = "\
Returns the local player's camera forward vector";["fname"] = "eyeVector";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.eyeVector";["summary"] = "\
Returns the local player's camera forward vector ";["private"] = false;["library"] = "builtin";["param"] = {};};["eyeAngles"] = {["ret"] = "The local player's camera angles";["class"] = "function";["description"] = "\
Returns the local player's camera angles";["fname"] = "eyeAngles";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.eyeAngles";["summary"] = "\
Returns the local player's camera angles ";["private"] = false;["library"] = "builtin";["param"] = {};};["type"] = {["ret"] = "The name of the object's type.";["description"] = "\
...
Try to execute a function and catch possible exceptions \
Similar to xpcall, but a bit more in-depth ";["private"] = false;["library"] = "builtin";["param"] = {[1] = "func";[2] = "catch";["catch"] = "Optional function to execute in case func fails";["func"] = "Function to execute";};};["rawget"] = {["ret"] = "The value of the index";["class"] = "function";["description"] = "\
...
Gets the value of a table index without invoking a metamethod ";["private"] = false;["library"] = "builtin";["param"] = {[1] = "table";[2] = "key";[3] = "value";["key"] = "The index of the table";["table"] = "The table to get the value from";};};["select"] = {["ret"] = "Returns a number or vararg, depending on the select method.";["description"] = "\
...
Setups permission override request";["class"] = "function";["realm"] = "sh";["fname"] = "setupPermissionRequest";["summary"] = "\
Setups permission override request ";["name"] = "SF.DefaultEnvironment.setupPermissionRequest";["library"] = "builtin";["private"] = false;["client"] = true;["param"] = {[1] = "perms";[2] = "desc";[3] = "showOnUse";["perms"] = "Table of permission names to override";["showOnUse"] = "If true request will popup when user uses chip";["desc"] = "Description attached to request";};};["quotaAverage"] = {["ret"] = "Average CPU Time of the buffer.";["class"] = "function";["description"] = "\
...
GLua's loadstring \
Works like loadstring, except that it executes by default in the main environment ";["private"] = false;["library"] = "builtin";["param"] = {[1] = "str";[2] = "name";["str"] = "String to execute";};};["setUserdata"] = {["description"] = "\
Sets the chip's userdata that the duplicator tool saves. max 1MiB";["class"] = "function";["realm"] = "sh";["fname"] = "setUserdata";["summary"] = "\
Sets the chip's userdata that the duplicator tool saves.";["name"] = "SF.DefaultEnvironment.setUserdata";["library"] = "builtin";["private"] = false;["server"] = true;["param"] = {[1] = "str";["str"] = "String data";};};["setName"] = {["description"] = "\
