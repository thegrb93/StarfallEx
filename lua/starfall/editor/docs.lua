...
Called when a player gets hurt ";["server"] = true;["client"] = true;["param"] = {[1] = "ply";[2] = "attacker";[3] = "newHealth";[4] = "damageTaken";["newHealth"] = "New health of the player";["damageTaken"] = "Amount of damage the player has taken";["ply"] = "Player being hurt";["attacker"] = "Entity causing damage to the player";};};["writecell"] = {["description"] = "\
Called when a high speed device writes to a wired SF chip";["class"] = "hook";["classForced"] = true;["name"] = "writecell";["realm"] = "sv";["summary"] = "\
Called when a high speed device writes to a wired SF chip ";["param"] = {[1] = "address";[2] = "data";["data"] = "The data being written";["address"] = "The address written to";};};["readcell"] = {["ret"] = "The value read";["description"] = "\
Called when a high speed device reads from a wired SF chip";["class"] = "hook";["classForced"] = true;["name"] = "readcell";["realm"] = "sv";["summary"] = "\
Called when a high speed device reads from a wired SF chip ";["server"] = true;["param"] = {[1] = "address";["address"] = "The address requested";};};["PlayerLeaveVehicle"] = {["description"] = "\
Called when a players leaves a vehicle";["class"] = "hook";["classForced"] = true;["name"] = "PlayerLeaveVehicle";["realm"] = "sh";["summary"] = "\
Called when a players leaves a vehicle ";["server"] = true;["param"] = {[1] = "ply";[2] = "vehicle";["vehicle"] = "Vehicle that was left";["ply"] = "Player who left a vehicle";};};["net"] = {["description"] = "\
Called when a net message arrives";["class"] = "hook";["classForced"] = true;["name"] = "net";["realm"] = "sh";["summary"] = "\
Called when a net message arrives ";["param"] = {[1] = "name";[2] = "len";[3] = "ply";["len"] = "Length of the arriving net message in bytes";["name"] = "Name of the arriving net message";["ply"] = "On server, the player that sent the message. Nil on client.";};};["inputReleased"] = {["description"] = "\
Called when a button is released";["class"] = "hook";["classForced"] = true;["name"] = "inputReleased";["realm"] = "sh";["summary"] = "\
Called when a button is released ";["param"] = {[1] = "button";["button"] = "Number of the button";};};["inputPressed"] = {["description"] = "\
Called when a button is pressed";["class"] = "hook";["classForced"] = true;["name"] = "inputPressed";["realm"] = "sh";["summary"] = "\
Called when a button is pressed ";["param"] = {[1] = "button";["button"] = "Number of the button";};};["PropBreak"] = {["description"] = "\
...
Called when a player toggles noclip ";["server"] = true;["client"] = true;["param"] = {[1] = "ply";[2] = "newState";["newState"] = "New noclip state. True if on.";["ply"] = "Player toggling noclip";};};["Initialize"] = {["description"] = "\
...
Called after the starfall chip is placed/reloaded with the toolgun or duplicated and the duplication is finished.";["server"] = true;["param"] = {};};["predrawopaquerenderables"] = {["description"] = "\
...
Called before opaque entities are drawn.";["client"] = true;["param"] = {[1] = "boolean";["boolean"] = "isDrawSkybox  Whether the current draw is drawing the skybox.";};};["Removed"] = {["description"] = "\
Called when the starfall chip is removed";["class"] = "hook";["classForced"] = true;["name"] = "Removed";["realm"] = "sh";["summary"] = "\
Called when the starfall chip is removed ";["server"] = true;["param"] = {};};["hudconnect"] = {["description"] = "\
...
Called when the player connects to a HUD component linked to the Starfall Chip ";["client"] = true;["param"] = {};};["tick"] = {["description"] = "\
...
Called when a player sends a chat message ";["server"] = true;["param"] = {[1] = "ply";[2] = "text";[3] = "teamChat";["text"] = "Content of the message";["ply"] = "Player that sent the message";["teamChat"] = "True if team chat";};};["postdrawopaquerenderables"] = {["description"] = "\
...
Called after opaque entities are drawn.";["client"] = true;["param"] = {[1] = "boolean";["boolean"] = "isDrawSkybox  Whether the current draw is drawing the skybox.";};};["PlayerEnteredVehicle"] = {["description"] = "\
Called when a players enters a vehicle";["class"] = "hook";["classForced"] = true;["name"] = "PlayerEnteredVehicle";["realm"] = "sh";["summary"] = "\
Called when a players enters a vehicle ";["server"] = true;["param"] = {[1] = "ply";[2] = "vehicle";[3] = "num";["vehicle"] = "Vehicle that was entered";["ply"] = "Player who entered a vehicle";["num"] = "Role";};};["PhysgunDrop"] = {["description"] = "\
Called when an entity being held by a physgun gets dropped";["class"] = "hook";["classForced"] = true;["realm"] = "sh";["name"] = "PhysgunDrop";["summary"] = "\
Called when an entity being held by a physgun gets dropped ";["server"] = true;["client"] = true;["param"] = {[1] = "ply";[2] = "ent";["ply"] = "Player droppig the entity";["ent"] = "Entity being dropped";};};["input"] = {["description"] = "\
Called when an input on a wired SF chip is written to";["class"] = "hook";["classForced"] = true;["name"] = "input";["realm"] = "sv";["summary"] = "\
Called when an input on a wired SF chip is written to ";["param"] = {[1] = "input";[2] = "value";["value"] = "The value of the input";["input"] = "The input name";};};["starfallUsed"] = {["description"] = "\
Called when a player uses the screen";["class"] = "hook";["classForced"] = true;["name"] = "starfallUsed";["realm"] = "cl";["summary"] = "\
...
Called when a player dies ";["server"] = true;["param"] = {[1] = "ply";[2] = "inflictor";[3] = "attacker";["inflictor"] = "Entity used to kill the player";["ply"] = "Player who died";["attacker"] = "Entity that killed the player";};};["PlayerUse"] = {["description"] = "\
...
The dimensions will always be 1024x1024";["param"] = {[1] = "name";["name"] = "The name of the render target";};};["disableScissorRect"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.disableScissorRect";["summary"] = "\
Disables a scissoring rect which limits the drawing area.";["private"] = false;["library"] = "render";["description"] = "\
Disables a scissoring rect which limits the drawing area.";["param"] = {};};["cursorPos"] = {["ret"] = {[1] = "x position";[2] = "y position";};["class"] = "function";["realm"] = "cl";["name"] = "render_library.cursorPos";["summary"] = "\
Gets a 2D cursor position where ply is aiming.";["private"] = false;["library"] = "render";["description"] = "\
Gets a 2D cursor position where ply is aiming.";["param"] = {[1] = "ply";["ply"] = "player to get cursor position from";};};["setTexture"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.setTexture";["summary"] = "\
Sets the texture ";["private"] = false;["library"] = "render";["description"] = "\
Sets the texture";["param"] = {[1] = "id";["id"] = "Texture table. Aquired with render.getTextureID";};};["isHUDActive"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.isHUDActive";["summary"] = "\
Checks if a hud component is connected to the Starfall Chip ";["private"] = false;["library"] = "render";["description"] = "\
Checks if a hud component is connected to the Starfall Chip";["param"] = {};};["traceSurfaceColor"] = {["ret"] = "The color vector. use vector:toColor to convert it to a color.";["class"] = "function";["realm"] = "cl";["name"] = "render_library.traceSurfaceColor";["summary"] = "\
...
Returns the render context's width and height";["param"] = {};};["drawTexturedRectRotated"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.drawTexturedRectRotated";["summary"] = "\
...
Constructs a markup object for quick styled text drawing.";["param"] = {[1] = "str";[2] = "maxsize";["str"] = "The markup string to parse";["maxsize"] = "The max width of the markup";};};["readPixel"] = {["ret"] = "Color object with ( r, g, b, 255 ) from the specified pixel.";["class"] = "function";["realm"] = "cl";["name"] = "render_library.readPixel";["summary"] = "\
Reads the color of the specified pixel.";["private"] = false;["library"] = "render";["description"] = "\
Reads the color of the specified pixel.";["param"] = {[1] = "x";[2] = "y";["y"] = "Pixel y-coordinate.";["x"] = "Pixel x-coordinate.";};};["getTextSize"] = {["ret"] = {[1] = "width of the text";[2] = "height of the text";};["class"] = "function";["realm"] = "cl";["name"] = "render_library.getTextSize";["summary"] = "\
Gets the size of the specified text.";["private"] = false;["library"] = "render";["description"] = "\
Gets the size of the specified text. Don't forget to use setFont before calling this function";["param"] = {[1] = "text";["text"] = "Text to get the size of";};};["drawRectOutline"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.drawRectOutline";["summary"] = "\
Draws a rectangle outline using the current color.";["private"] = false;["library"] = "render";["description"] = "\
Draws a rectangle outline using the current color.";["param"] = {[1] = "x";[2] = "y";[3] = "w";[4] = "h";["y"] = "Top left corner y coordinate";["h"] = "Height";["w"] = "Width";["x"] = "Top left corner x coordinate";};};["setRGBA"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.setRGBA";["summary"] = "\
Sets the draw color by RGBA values ";["private"] = false;["library"] = "render";["description"] = "\
Sets the draw color by RGBA values";["param"] = {[1] = "r";[2] = "g";[3] = "b";[4] = "a";};};["enableDepth"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.enableDepth";["summary"] = "\
Enables or disables Depth Buffer ";["private"] = false;["library"] = "render";["description"] = "\
Enables or disables Depth Buffer";["param"] = {[1] = "enable";["enable"] = "true to enable";};};["drawText"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.drawText";["summary"] = "\
...
Gets the default font";["param"] = {};};["drawTexturedRect"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.drawTexturedRect";["summary"] = "\
Draws a textured rectangle.";["private"] = false;["library"] = "render";["description"] = "\
Draws a textured rectangle.";["param"] = {[1] = "x";[2] = "y";[3] = "w";[4] = "h";["y"] = "Top left corner y coordinate";["h"] = "Height";["w"] = "Width";["x"] = "Top left corner x coordinate";};};["drawSimpleText"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.drawSimpleText";["summary"] = "\
...
Draws a wireframe box in 3D space";["param"] = {[1] = "origin";[2] = "angle";[3] = "mins";[4] = "maxs";["origin"] = "Origin of the box.";["maxs"] = "End position of the box, relative to origin.";["angle"] = "Orientation  of the box";["mins"] = "Start position of the box, relative to origin.";};};["drawRect"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.drawRect";["summary"] = "\
Draws a rectangle using the current color.";["private"] = false;["library"] = "render";["description"] = "\
Draws a rectangle using the current color.";["param"] = {[1] = "x";[2] = "y";[3] = "w";[4] = "h";["y"] = "Top left corner y coordinate";["h"] = "Height";["w"] = "Width";["x"] = "Top left corner x coordinate";};};["draw3DBeam"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.draw3DBeam";["summary"] = "\
...
Draws a 3D Line";["param"] = {[1] = "startPos";[2] = "endPos";["endPos"] = "Ending position";["startPos"] = "Starting position";};};["selectRenderTarget"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.selectRenderTarget";["summary"] = "\
...
Returns the model material name that uses the render target.";["param"] = {[1] = "name";["name"] = "Render target name";};};["draw3DSphere"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.draw3DSphere";["summary"] = "\
Draws a sphere ";["private"] = false;["library"] = "render";["description"] = "\
Draws a sphere";["param"] = {[1] = "pos";[2] = "radius";[3] = "longitudeSteps";[4] = "latitudeSteps";["radius"] = "Radius of the sphere";["latitudeSteps"] = "The amount of latitude steps. The larger this number is, the smoother the sphere is";["longitudeSteps"] = "The amount of longitude steps. The larger this number is, the smoother the sphere is";["pos"] = "Position of the sphere";};};["clear"] = {["class"] = "function";["realm"] = "cl";["name"] = "render_library.clear";["summary"] = "\
...
Library for retreiving information about teams";["libtbl"] = "team_library";["tables"] = {};["server"] = true;};["trace"] = {["functions"] = {[1] = "trace";[2] = "traceHull";["traceHull"] = {["ret"] = "Result of the trace https://wiki.garrysmod.com/page/Structures/TraceResult";["class"] = "function";["realm"] = "sh";["name"] = "trace_library.traceHull";["summary"] = "\
...
Provides functions for doing line/AABB traces";["libtbl"] = "trace_library";["tables"] = {};["server"] = true;};["mesh"] = {["functions"] = {[1] = "createFromObj";[2] = "createFromTable";[3] = "trianglesLeft";["trianglesLeft"] = {["ret"] = "Number of triangles that can be created";["class"] = "function";["realm"] = "cl";["name"] = "mesh_library.trianglesLeft";["summary"] = "\
...
Mesh library.";["libtbl"] = "mesh_library";["tables"] = {};};["holograms"] = {["functions"] = {[1] = "canSpawn";[2] = "create";[3] = "hologramsLeft";["canSpawn"] = {["ret"] = "True if user can spawn holograms, False if not.";["class"] = "function";["realm"] = "sv";["summary"] = "\
...
Joystick library.";["libtbl"] = "joystick_library";["tables"] = {};};["fastlz"] = {["functions"] = {[1] = "compress";[2] = "decompress";["decompress"] = {["ret"] = "Decompressed string";["class"] = "function";["realm"] = "sh";["name"] = "fastlz_library.decompress";["summary"] = "\
...
FastLZ library";["libtbl"] = "fastlz_library";["tables"] = {};["server"] = true;};["game"] = {["functions"] = {[1] = "getGamemode";[2] = "getHostname";[3] = "getMap";[4] = "getMaxPlayers";[5] = "isDedicated";[6] = "isLan";[7] = "isSinglePlayer";["getMaxPlayers"] = {["class"] = "function";["realm"] = "sh";["name"] = "game_lib.getMaxPlayers";["summary"] = "\
...
Net message library. Used for sending data from the server to the client and back";["libtbl"] = "net_library";["tables"] = {};};["timer"] = {["functions"] = {[1] = "adjust";[2] = "create";[3] = "curtime";[4] = "exists";[5] = "frametime";[6] = "getTimersLeft";[7] = "pause";[8] = "realtime";[9] = "remove";[10] = "simple";[11] = "start";[12] = "stop";[13] = "systime";[14] = "unpause";["simple"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.simple";["summary"] = "\
Creates a simple timer, has no name, can't be stopped, paused, or destroyed.";["private"] = false;["library"] = "timer";["description"] = "\
Creates a simple timer, has no name, can't be stopped, paused, or destroyed.";["param"] = {[1] = "delay";[2] = "func";["delay"] = "the time, in second, to set the timer to";["func"] = "the function to call when the timer is fired";};};["frametime"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.frametime";["summary"] = "\
...
Same as GLua's SysTime()";["param"] = {};};["adjust"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.adjust";["summary"] = "\
Adjusts a timer ";["private"] = false;["library"] = "timer";["description"] = "\
Adjusts a timer";["param"] = {[1] = "name";[2] = "delay";[3] = "reps";[4] = "func";["name"] = "The timer name";["func"] = "The function to call when the tiemr is fired";["delay"] = "The time, in seconds, to set the timer to.";["reps"] = "The repititions of the tiemr. 0 = infinte, nil = 1";};};["create"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.create";["summary"] = "\
Creates (and starts) a timer ";["private"] = false;["library"] = "timer";["description"] = "\
Creates (and starts) a timer";["param"] = {[1] = "name";[2] = "delay";[3] = "reps";[4] = "func";[5] = "simple";["name"] = "The timer name";["func"] = "The function to call when the tiemr is fired";["delay"] = "The time, in seconds, to set the timer to.";["reps"] = "The repititions of the tiemr. 0 = infinte, nil = 1";};};["getTimersLeft"] = {["ret"] = "Number of available timers";["class"] = "function";["realm"] = "sh";["name"] = "timer_library.getTimersLeft";["summary"] = "\
Returns number of available timers ";["private"] = false;["library"] = "timer";["description"] = "\
Returns number of available timers";["param"] = {};};["stop"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.stop";["summary"] = "\
Stops a timer ";["private"] = false;["library"] = "timer";["description"] = "\
Stops a timer";["param"] = {[1] = "name";["name"] = "The timer name";};};["remove"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.remove";["summary"] = "\
Removes a timer ";["private"] = false;["library"] = "timer";["description"] = "\
Removes a timer";["param"] = {[1] = "name";["name"] = "The timer name";};};["exists"] = {["ret"] = "bool if the timer exists";["class"] = "function";["realm"] = "sh";["name"] = "timer_library.exists";["summary"] = "\
Checks if a timer exists ";["private"] = false;["library"] = "timer";["description"] = "\
Checks if a timer exists";["param"] = {[1] = "name";["name"] = "The timer name";};};["unpause"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.unpause";["summary"] = "\
Unpauses a timer ";["private"] = false;["library"] = "timer";["description"] = "\
Unpauses a timer";["param"] = {[1] = "name";["name"] = "The timer name";};};["realtime"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.realtime";["summary"] = "\
Same as GLua's RealTime() ";["private"] = false;["library"] = "timer";["description"] = "\
Same as GLua's RealTime()";["param"] = {};};["start"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.start";["summary"] = "\
Starts a timer ";["private"] = false;["library"] = "timer";["description"] = "\
Starts a timer";["param"] = {[1] = "name";["name"] = "The timer name";};};["pause"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.pause";["summary"] = "\
Pauses a timer ";["private"] = false;["library"] = "timer";["description"] = "\
Pauses a timer";["param"] = {[1] = "name";["name"] = "The timer name";};};["curtime"] = {["class"] = "function";["realm"] = "sh";["name"] = "timer_library.curtime";["summary"] = "\
...
Throws an exception";["param"] = {[1] = "msg";[2] = "level";[3] = "uncatchable";["msg"] = "Message";["uncatchable"] = "Makes this exception uncatchable";["level"] = "Which level in the stacktrace to blame. Defaults to one of invalid";};};["quotaMax"] = {["ret"] = "Max SysTime allowed to take for execution of the chip in a Think.";["class"] = "function";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.quotaMax";["summary"] = "\
...
Returns the entity with index 'num' ";["library"] = "builtin";["param"] = {[1] = "num";["num"] = "Entity index";};};["printTable"] = {["class"] = "function";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.printTable";["summary"] = "\
...
Lua's pcall with SF throw implementation \
Calls a function and catches an error that can be thrown while the execution of the call.";["param"] = {[1] = "func";[2] = "...";[3] = "arguments";["arguments"] = "Arguments to call the function with.";["func"] = "Function to be executed and of which the errors should be caught of";};};["getfenv"] = {["ret"] = "Current environment";["class"] = "function";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.getfenv";["summary"] = "\
Simple version of Lua's getfenv \
Returns the current environment ";["private"] = false;["library"] = "builtin";["description"] = "\
Simple version of Lua's getfenv \
Returns the current environment";["param"] = {};};["setfenv"] = {["ret"] = "func with environment set to tbl";["class"] = "function";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.setfenv";["summary"] = "\
Lua's setfenv \
Works like setfenv, but is restricted on functions ";["private"] = false;["library"] = "builtin";["description"] = "\
Lua's setfenv \
Works like setfenv, but is restricted on functions";["param"] = {[1] = "func";[2] = "tbl";["tbl"] = "New environment";["func"] = "Function to change environment of";};};["type"] = {["ret"] = "The name of the object's type.";["class"] = "function";["classForced"] = true;["realm"] = "sh";["name"] = "SF.DefaultEnvironment.type";["summary"] = "\
...
Generates the CRC checksum of the specified string.";["library"] = "builtin";["param"] = {[1] = "stringToHash";["stringToHash"] = "The string to calculate the checksum of";};};["requiredir"] = {["ret"] = "Table of return values of the scripts";["class"] = "function";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.requiredir";["summary"] = "\
...
Returns whoever created the chip ";["library"] = "builtin";["param"] = {};};["require"] = {["ret"] = "Return value of the script";["class"] = "function";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.require";["summary"] = "\
Runs an included script and caches the result.";["private"] = false;["library"] = "builtin";["description"] = "\
Runs an included script and caches the result. \
Works pretty much like standard Lua require()";["param"] = {[1] = "file";["file"] = "The file to include. Make sure to --@include it";};};["quotaAverage"] = {["ret"] = "Average CPU Time of the buffer.";["class"] = "function";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.quotaAverage";["summary"] = "\
...
GLua's loadstring \
Works like loadstring, except that it executes by default in the main environment";["param"] = {[1] = "str";["str"] = "String to execute";};};["rawget"] = {["ret"] = "The value of the index";["class"] = "function";["realm"] = "sh";["name"] = "SF.DefaultEnvironment.rawget";["summary"] = "\
Gets the value of a table index without invoking a metamethod ";["private"] = false;["library"] = "builtin";["description"] = "\
Gets the value of a table index without invoking a metamethod";["param"] = {[1] = "table";[2] = "key";[3] = "value";["key"] = "The index of the table";["table"] = "The table to get the value from";};};["setName"] = {["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Deals with hooks";["libtbl"] = "hook_library";["tables"] = {};["server"] = true;};["find"] = {["functions"] = {[1] = "all";[2] = "allPlayers";[3] = "byClass";[4] = "byModel";[5] = "inBox";[6] = "inCone";[7] = "inSphere";["inBox"] = {["ret"] = "An array of found entities";["class"] = "function";["realm"] = "sh";["name"] = "find_library.inBox";["summary"] = "\
...
Find library. Finds entities in various shapes.";["libtbl"] = "find_library";["tables"] = {};["server"] = true;};["globaltables"] = {["functions"] = {};["class"] = "library";["summary"] = "\
...
Global table shared by all instances on the same side.";};};["server"] = true;};["coroutine"] = {["functions"] = {[1] = "create";[2] = "resume";[3] = "running";[4] = "status";[5] = "wait";[6] = "wrap";[7] = "yield";["resume"] = {["ret"] = "Any values the coroutine is returning to the main thread";["class"] = "function";["realm"] = "sh";["name"] = "coroutine_library.resume";["summary"] = "\
...
Input library.";["libtbl"] = "input_methods";["tables"] = {};};["file"] = {["functions"] = {[1] = "append";[2] = "createDir";[3] = "delete";[4] = "exists";[5] = "find";[6] = "open";[7] = "read";[8] = "write";["delete"] = {["ret"] = "True if successful, nil if error";["class"] = "function";["realm"] = "cl";["name"] = "file_library.delete";["summary"] = "\
...
File functions. Allows modification of files.";["libtbl"] = "file_library";["tables"] = {};};["constraint"] = {["functions"] = {[1] = "axis";[2] = "ballsocket";[3] = "ballsocketadv";[4] = "breakAll";[5] = "breakType";[6] = "elastic";[7] = "getTable";[8] = "nocollide";[9] = "rope";[10] = "setElasticLength";[11] = "setRopeLength";[12] = "slider";[13] = "weld";["ballsocketadv"] = {["class"] = "function";["realm"] = "sv";["summary"] = "\
...
Entity type";["client"] = true;["class"] = "class";["methods"] = {[1] = "addCollisionListener";[2] = "applyAngForce";[3] = "applyDamage";[4] = "applyForceCenter";[5] = "applyForceOffset";[6] = "applyTorque";[7] = "breakEnt";[8] = "emitSound";[9] = "enableDrag";[10] = "enableGravity";[11] = "enableMotion";[12] = "enableSphere";[13] = "entIndex";[14] = "extinguish";[15] = "getAngleVelocity";[16] = "getAngleVelocityAngle";[17] = "getAngles";[18] = "getAttachment";[19] = "getAttachmentParent";[20] = "getClass";[21] = "getColor";[22] = "getEyeAngles";[23] = "getEyePos";[24] = "getForward";[25] = "getHealth";[26] = "getInertia";[27] = "getMass";[28] = "getMassCenter";[29] = "getMassCenterW";[30] = "getMaterial";[31] = "getMaterials";[32] = "getMatrix";[33] = "getMaxHealth";[34] = "getModel";[35] = "getOwner";[36] = "getParent";[37] = "getPos";[38] = "getRight";[39] = "getSkin";[40] = "getSubMaterial";[41] = "getUp";[42] = "getVelocity";[43] = "ignite";[44] = "isFrozen";[45] = "isNPC";[46] = "isPlayer";[47] = "isValid";[48] = "isValidPhys";[49] = "isVehicle";[50] = "isWeapon";[51] = "isWeldedTo";[52] = "linkComponent";[53] = "localToWorld";[54] = "localToWorldAngles";[55] = "lookupAttachment";[56] = "manipulateBoneAngles";[57] = "manipulateBonePosition";[58] = "manipulateBoneScale";[59] = "obbCenter";[60] = "obbCenterW";[61] = "obbSize";[62] = "remove";[63] = "removeTrails";[64] = "setAngles";[65] = "setBodygroup";[66] = "setColor";[67] = "setFrozen";[68] = "setHologramMesh";[69] = "setHologramRenderBounds";[70] = "setMass";[71] = "setMaterial";[72] = "setNoDraw";[73] = "setNocollideAll";[74] = "setParent";[75] = "setPhysMaterial";[76] = "setPos";[77] = "setRenderFX";[78] = "setRenderMode";[79] = "setSkin";[80] = "setSolid";[81] = "setSubMaterial";[82] = "setTrails";[83] = "setVelocity";[84] = "unparent";[85] = "worldToLocal";[86] = "worldToLocalAngles";["getRight"] = {["ret"] = "Vector right";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Checks if an entity is valid.";["param"] = {};};["manipulateBonePosition"] = {["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Allows manipulation of the owner's bones' positions";["param"] = {[1] = "bone";[2] = "vec";["vec"] = "The position it should be manipulated to";["bone"] = "The bone ID";};};["setSkin"] = {["class"] = "function";["realm"] = "sv";["classForced"] = true;["summary"] = "\
Sets the skin of the entity ";["name"] = "ents_methods:setSkin";["classlib"] = "Entity";["private"] = false;["server"] = true;["description"] = "\
Sets the skin of the entity";["param"] = {[1] = "skinIndex";[2] = "ply";["skinIndex"] = "Number, Index of the skin to use.";["ply"] = "Optional player arguement to set only for that player. Can also be table of players.";};};["getAngleVelocity"] = {["ret"] = "The angular velocity as a vector";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Returns the class of the entity";["param"] = {};};["obbCenter"] = {["ret"] = "The position vector of the outer bounding box center";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the owner of the entity";["param"] = {};};["setSolid"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:setSolid";["summary"] = "\
...
Returns the angular velocity of the entity";["param"] = {};};["localToWorld"] = {["ret"] = "data as world space vector";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Removes an entity";["param"] = {};};["worldToLocal"] = {["ret"] = "data as local space vector";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Converts a vector in world space to entity local space";["param"] = {[1] = "data";["data"] = "World space vector";};};["breakEnt"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:breakEnt";["summary"] = "\
Invokes the entity's breaking animation and removes it.";["private"] = false;["classlib"] = "Entity";["description"] = "\
Invokes the entity's breaking animation and removes it.";["param"] = {};};["ignite"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:ignite";["summary"] = "\
Ignites an entity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Ignites an entity";["param"] = {[1] = "length";[2] = "radius";["radius"] = "(optional) How large the fire hitbox is (entity obb is the max)";["length"] = "How long the fire lasts";};};["lookupAttachment"] = {["ret"] = "number of the attachment index, or 0 if it doesn't exist";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the attachment index via the entity and it's attachment name";["param"] = {[1] = "name";["name"] = "";};};["getMaxHealth"] = {["ret"] = "Max Health of the entity";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Returns the matrix of the entity";["param"] = {[1] = "bone";["bone"] = "Bone of the entity (def 0)";};};["setVelocity"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:setVelocity";["summary"] = "\
Sets the entity's linear velocity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Sets the entity's linear velocity";["param"] = {[1] = "vel";["vel"] = "New velocity";};};["applyDamage"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:applyDamage";["summary"] = "\
Applies damage to an entity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Applies damage to an entity";["param"] = {[1] = "amt";[2] = "attacker";[3] = "inflictor";["inflictor"] = "damage inflictor";["attacker"] = "damage attacker";["amt"] = "damage amount";};};["obbCenterW"] = {["ret"] = "The position vector of the outer bounding box center";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Returns the world position of the entity's outer bounding box";["param"] = {};};["setNoDraw"] = {["class"] = "function";["realm"] = "sv";["summary"] = "\
...
Sets the whether an entity should be drawn or not";["param"] = {[1] = "draw";[2] = "ply";["draw"] = "Whether to draw the entity or not.";["ply"] = "Optional player arguement to set only for that player. Can also be table of players.";};};["isFrozen"] = {["ret"] = "True if entity is frozen";["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:isFrozen";["summary"] = "\
Checks the entities frozen state ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Checks the entities frozen state";["param"] = {};};["setAngles"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:setAngles";["summary"] = "\
Sets the entity's angles ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Sets the entity's angles";["param"] = {[1] = "ang";["ang"] = "New angles";};};["getEyeAngles"] = {["ret"] = "Angles of the entity's eyes";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the entitiy's eye angles";["param"] = {};};["emitSound"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:emitSound";["summary"] = "\
Plays a sound on the entity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Plays a sound on the entity";["param"] = {[1] = "snd";[2] = "lvl";[3] = "pitch";[4] = "volume";[5] = "channel";["pitch"] = "pitchPercent=100";["snd"] = "string Sound path";["lvl"] = "number soundLevel=75";["channel"] = "channel=CHAN_AUTO";["volume"] = "volume=1";};};["getMaterials"] = {["ret"] = "Material";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets an entities' material list";["param"] = {};};["extinguish"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:extinguish";["summary"] = "\
...
Returns the velocity of the entity";["param"] = {};};["manipulateBoneAngles"] = {["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Allows manipulation of the owner's bones' angles";["param"] = {[1] = "bone";[2] = "ang";["ang"] = "The angle it should be manipulated to";["bone"] = "The bone ID";};};["setColor"] = {["class"] = "function";["realm"] = "sv";["summary"] = "\
...
Checks if an entity is an npc.";["param"] = {};};["getSubMaterial"] = {["ret"] = "String material";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Sets entity gravity";["param"] = {[1] = "grav";["grav"] = "Bool should the entity respect gravity?";};};["isVehicle"] = {["ret"] = "True if vehicle, false if not";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Allows manipulation of the owner's bones' scale";["param"] = {[1] = "bone";[2] = "vec";["vec"] = "The scale it should be manipulated to";["bone"] = "The bone ID";};};["setMaterial"] = {["class"] = "function";["realm"] = "sv";["classForced"] = true;["summary"] = "\
...
Returns the mass of the entity";["param"] = {};};["getHealth"] = {["ret"] = "Health of the entity";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the health of an entity";["param"] = {};};["enableDrag"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:enableDrag";["summary"] = "\
...
Sets the physics of an entity to be a sphere";["param"] = {[1] = "enabled";["enabled"] = "Bool should the entity be spherical?";};};["setBodygroup"] = {["class"] = "function";["realm"] = "sv";["classForced"] = true;["summary"] = "\
...
Sets the entity frozen state";["param"] = {[1] = "freeze";["freeze"] = "Should the entity be frozen?";};};["localToWorldAngles"] = {["ret"] = "data as world space angle";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Returns the angle of the entity";["param"] = {};};["setPhysMaterial"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:setPhysMaterial";["summary"] = "\
...
Gets an entities' material";["param"] = {};};["applyAngForce"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:applyAngForce";["summary"] = "\
Applies angular force to the entity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Applies angular force to the entity";["param"] = {[1] = "ang";["ang"] = "The force angle";};};["isValidPhys"] = {["ret"] = "True if entity has physics";["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:isValidPhys";["summary"] = "\
...
Parents the entity to another entity";["param"] = {[1] = "ent";[2] = "attachment";["attachment"] = "Optional string attachment name to parent to";["ent"] = "Entity to parent to";};};["getUp"] = {["ret"] = "Vector up";["class"] = "function";["realm"] = "sh";["summary"] = "\
Gets the entity's up vector ";["classlib"] = "Entity";["name"] = "ents_methods:getUp";["server"] = true;["private"] = false;["client"] = true;["description"] = "\
Gets the entity's up vector";["param"] = {};};["setMass"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:setMass";["summary"] = "\
...
Gets the parent of an entity";["param"] = {};};["isWeapon"] = {["ret"] = "True if weapon, false if not";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Checks if an entity is a weapon.";["param"] = {};};["setRenderMode"] = {["class"] = "function";["realm"] = "sv";["classForced"] = true;["summary"] = "\
...
VMatrix type";["class"] = "class";["methods"] = {[1] = "getAngles";[2] = "getForward";[3] = "getInverse";[4] = "getInverseTR";[5] = "getRight";[6] = "getScale";[7] = "getTranslation";[8] = "getUp";[9] = "rotate";[10] = "scale";[11] = "scaleTranslation";[12] = "setAngles";[13] = "setTranslation";[14] = "translate";["getRight"] = {["ret"] = "Translation";["class"] = "function";["realm"] = "sh";["name"] = "vmatrix_methods:getRight";["summary"] = "\
Returns right vector of matrix ";["private"] = false;["classlib"] = "VMatrix";["description"] = "\
Returns right vector of matrix";["param"] = {};};["getUp"] = {["ret"] = "Translation";["class"] = "function";["realm"] = "sh";["name"] = "vmatrix_methods:getUp";["summary"] = "\
