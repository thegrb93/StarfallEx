...
Sets a component's ability to lock a player's controls ";};["setDrawShadow"]={["class"]="function";["classlib"]="Entity";["description"]="\
...
Sets the angular velocity of an object ";};["setDamping"]={["class"]="function";["classlib"]="PhysObj";["description"]="\
