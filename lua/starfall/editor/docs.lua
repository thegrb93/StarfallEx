...
Checks if an entity is a weapon.";["param"] = {};};["setRenderFX"] = {["class"] = "function";["realm"] = "sv";["classForced"] = true;["summary"] = "\
...
Returns the parent index of an entity's bone";["param"] = {[1] = "bone";["bone"] = "Bone index. (def 0)";};};["obbSize"] = {["ret"] = "The outer bounding box size";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Returns the x, y, z size of the entity's outer bounding box (local to the entity)";["param"] = {};};["localToWorld"] = {["ret"] = "data as world space vector";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Removes an entity";["param"] = {};};["breakEnt"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:breakEnt";["summary"] = "\
...
Ignites an entity";["param"] = {[1] = "length";[2] = "radius";["radius"] = "(optional) How large the fire hitbox is (entity obb is the max)";["length"] = "How long the fire lasts";};};["getHealth"] = {["ret"] = "Health of the entity";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the health of an entity";["param"] = {};};["lookupAttachment"] = {["ret"] = "number of the attachment index, or 0 if it doesn't exist";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Sets the whether an entity should be drawn or not";["param"] = {[1] = "draw";[2] = "ply";["draw"] = "Whether to draw the entity or not.";["ply"] = "Optional player arguement to set only for that player. Can also be table of players.";};};["setSkin"] = {["class"] = "function";["realm"] = "sv";["classForced"] = true;["summary"] = "\
...
Plays a sound on the entity";["param"] = {[1] = "snd";[2] = "lvl";[3] = "pitch";[4] = "volume";[5] = "channel";["pitch"] = "pitchPercent=100";["snd"] = "string Sound path";["lvl"] = "number soundLevel=75";["channel"] = "channel=CHAN_AUTO";["volume"] = "volume=1";};};["getEyeAngles"] = {["ret"] = "Angles of the entity's eyes";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the entitiy's eye angles";["param"] = {};};["getSubMaterial"] = {["ret"] = "String material";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets an entities' submaterial";["param"] = {[1] = "index";};};["getMaterials"] = {["ret"] = "Material";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Returns the world position of the entity's outer bounding box";["param"] = {};};["enableGravity"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:enableGravity";["summary"] = "\
Sets entity gravity ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Sets entity gravity";["param"] = {[1] = "grav";["grav"] = "Bool should the entity respect gravity?";};};["enableDrag"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:enableDrag";["summary"] = "\
Sets the entity drag state ";["private"] = false;["classlib"] = "Entity";["description"] = "\
Sets the entity drag state";["param"] = {[1] = "drag";["drag"] = "Bool should the entity have air resistence?";};};["getUp"] = {["ret"] = "Vector up";["class"] = "function";["realm"] = "sh";["summary"] = "\
...
Gets the max health of an entity";["param"] = {};};["enableMotion"] = {["class"] = "function";["realm"] = "sv";["name"] = "ents_methods:enableMotion";["summary"] = "\
